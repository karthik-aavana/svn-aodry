...
class Module_settings extends MY_Controller
{
    ...
    function index()
    {
        $privilege_module_id         = $this->config->item('module_setting');
        ...
        } if (!empty($this->input->post()))
        {
            ...
            if (!empty($posts))
            {
                foreach ($posts as $post)
                {
                    ...
                    if (in_array($data['privilege_module_id'], $data['active_edit'])) {		   
                    ...
                    if (in_array($data['privilege_module_id'], $data['active_delete'])) {
                    ...
                    $cols .= '</div></div>'; 
                    $disabled = '';
                    if(!in_array($data['privilege_module_id'], $data['active_delete']) && !in_array($data['privilege_module_id'], $data['active_edit'])){
                        $disabled = 'disabled';
                    }                  
