...
class Sales_credit_ledgers extends MY_Controller
{
    ...
    function index(){
        ...
        $this->load->view('sales_voucher/sales_credit_ledger', $data);
    }
    ...
    function GetAllVoucher(){
        ...
        if($voucher_id != 0 && $voucher_id != ''){
            ...
            $sql .= " WHERE branch_id='{$branch_id}' AND voucher_date BETWEEN '{$from_date}' AND '{$to_date}' AND reference_type='sales_credit_note' ";
        }
            ...
            foreach ($response as $key => $value) {
                ...
                //    $tr .= "<td><input data-id='{$vid}' type='text' value='' class='disable_in form-control' name='invoice_narration'></td>";
                    ...
                    /*if($this->access['m_update']){*/
                        ...
                        if($value['delete_status'] == '0'){
                            /*$tr .= "<td><a href='". base_url('sales_credit_note/edit/') .$reference_id."' class='edit_led' data-id='".$vid."'><i class='glyphicon glyphicon-edit'></i></a> ";*///| <a href='javascript:void(0);' data-id='".$vid."' class='sub_led'><i class='glyphicon glyphicon-check'></i></a></td>
                        }else{
                            /*$tr .= "<td></td>";*/
                        }
                    /*}else{
