...
<script src="<?php echo base_url('assets/js/product/') ?>hsn_code.js"></script>

<script type="text/javascript">
    var tds_tbl = '';
    $(document).ready(function () {

        tds_tbl = tds_data_table();
...

        {
           ...
           var section=$('#section').val();
...

             {
                 ...
                 $('#product_tds_code_e').val(tds_value);
...

             {
                 ...
                 $('#product_tds_code').val(tds_value);

                 $('#product_tds_code1').val(tds_value);
