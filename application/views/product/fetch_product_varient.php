        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="box-body" id="varinets_table">
                        ...
                        <form method="post" action="<?= base_url('product/update_product_varients') ?>">
                         ...
                         <button type="submit" class="btn btn-sm btn-info" id="product_modal_cancel" style="display: none">Cancel</button>
                            ...
                            <thead>
                                ...
                                <tr>
                                 ...
                                 <!-- <th>Date</th> -->
                                    ...
                                    <th style="min-width: 100px;text-align: center;">Product Name</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="well get_num">
                    ...
                    <input type="button" class="btn btn-info" id="getRows" name="combination" data-dismiss="modal" value="manual" onclick="get_dynamic_table()" />&nbsp<label  fclass="form-group"></label>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="productForm">
                ...
                <form role="form" method="post" action = "<?= base_url('product/update_quantity') ?>">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="productForm">
                ...
                <form role="form" method="post" action = "<?= base_url('product/move_to_damage') ?>">
...
$this->load->view('product/quantity_history');
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#list_datatable').DataTable({
            ...
            "ajax": {
                ...
                "url": base_url + "product/fetch_product_varient/<?= $id ?>",
    ...
    function getVarients(id) {
        ...
        $.ajax({
            ...
            url: base_url + "product/get_varient_values/" + productId,
    ...
    $("#post_varients").click(function (e) {
        ...
        $.ajax({
            ...
            url: base_url + "product/edit_product_vaarient/",
   ...
   $("#getRows").click(function (event)

    {
...

       {
         ...
         var sel_val=$("#varient_value_"+t).val();
    ...
    function get_dynamic_table() {
       ...
       var numberOfColoumns = ($('.get_num select').length) / 2;      
        ...
        $('#genarate_table:last').append("<td class=''>Varient Code</td>");

        $('#genarate_table:last').append("<td class=''>Varient Name</td>");

        $('#genarate_table:last').append("<td class=''>Purchase price</td>");

        $('#genarate_table:last').append("<td class=''>Selling Price</td>");

        $('#genarate_table:last').append("<td class=''>Unit</td>");

        $('#genarate_table:last').append("<td class='>Quantity</td>");

        $('#genarate_table:last').append("<td class=''>Action</td>");
...
?></select></td>");
    ...
    $("#product_modal_submit").click(function () {
     ...
     $("#product_modal_cancel").click(function () {
    ...
    function get_quantity(id) {
        ...
        $.ajax({
            ...
            url: base_url + 'product/get_quantity_values/' + id,
...

            {
                ...
                var quantity = JSON.parse(result)



                $("#quantity_history").val(quantity.quantity)
    ...
    function stock(id) {
        ...
        $.ajax({
            ...
            url: base_url + 'product/get_stock/' + id,
    ...
    function get_damaged_quantity(id) {
        ...
        $.ajax({
            ...
            url: base_url + 'product/get_damaged_products/' + id,
