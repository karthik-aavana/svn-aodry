    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active"><!-- Edit Discount --> Edit Discount</li>
            </ol>
        </h5>
    </section>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><!-- Edit Discount --> Edit Discount</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('discount/edit_discount'); ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id" id="discount_id" value="<?php echo $row -> discount_id; ?>">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control text-right" id="discount_percentage" name="discount_percentage" value="<?php echo $row -> discount_value; ?>">
                                    ...
                                    <div class="col-sm-4 mt-15">
                                        <div class="box-footer">
                                            <button type="submit" id="discount_submit" class="btn btn-info"><!-- Update --> Update</button>
