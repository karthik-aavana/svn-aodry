...
<span data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#edit_state"><a data-id="' . $state_id . '" data-toggle="tooltip" data-placement="bottom" title="Edit" class="edit_state btn btn-app"><i class="fa fa-pencil"></i></a></span>



<a data-toggle="modal" data-target="#edit_state" data-id="' . $state_id . '" title="Edit" class="edit_state btn btn-xs btn-info"><span class="glyphicon glyphicon-edit"></span></a> | 
...
<span data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#delete_modal" data-delete_message="If you delete this record then its assiociated records also will be delete!! Do you want to continue?"> <a class="btn btn-app delete_button" data-id="' . $supplier_id . '" data-path="customer/delete" data-toggle="tooltip" data-placement="bottom" title="Delete"> <i class="fa fa-trash-o"></i> </a></span>





<a data-toggle="modal" data-target="#delete_modal" data-id="' . $supplier_id . '" data-path="customer/delete" title="Delete" class="delete_button btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span></a>