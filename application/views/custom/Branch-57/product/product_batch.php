            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Product Batch</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="product_selling_price" name="product_selling_price" value="" readonly>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control select2" id="markdown_discount" name="product_discount" style="width: 100%;" tabindex="4">
                                            ...
                                            foreach ($discount as $value) {
                                                echo "<option value='$value->discount_id' ".($value->discount_value == 40 ? 'selected' : '')." dic='".(float)$value->discount_value."'>".(float)$value->discount_value."%</option>";
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control select2" id="margin_discount" name="margin_discount" style="width: 100%;" tabindex="4">
                                            ...
                                            <?php
                                            foreach ($discount as $value) {
                                                echo "<option value='$value->discount_id' ".($value->discount_value == 28 ? 'selected' : '')." dic='".(float)$value->discount_value."'>".(float)$value->discount_value."%</option>";
                                            }
                                            ?>
                                        </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" tabindex="1" id="product_code" name="product_code" value="" >
