                ...
                <div class="box">
                    ...
                    <div id="plus_btn">
                        <div class="box-header with-border">
                            ...
                            <?php }
                            ?>
                           <span><a href="<?php echo base_url("assets/excel/ProductDemo_varients.csv") ?>"  class="btn btn-sm btn-info pull-right" data-toggle="tooltip" data-placement="bottom" data-custom-class="tooltip-primary" data-original-title="Download Product CSV Demo File" download><i class="fa fa-download"></i></a></span>
