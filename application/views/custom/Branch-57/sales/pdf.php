...
<html>
    ...
    <body>
        ...
        <table class="item-table_leather table mt-20">
            <thead>
                <tr>
                    <th height="30px">#</th>
                    ...
                    <tr>
                        ...
                        if ($value->item_type == 'product' || $value->item_type == 'product_inventory') {
                            ...
                            if($value->product_image != '' ){
                                ?>
                                <img class="img" src="<?php echo FCPATH . '/assets/product_image/' . $branch[0]->branch_id . '/' . $value->product_image; ?>" height="30" />
                                
                                <?php
                            }else{
                                echo '-';
                            } ?></td>
                            <td style="text-align: left;"><?php echo $value->product_code; ?>
