                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <label for="date">PO Date<span class="validation-color">*</span></label>                                          
                                        <?php
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="invoice_number">PO Number<span class="validation-color">*</span>
                                        </label>
                                        ...
                                        <table class="table table-striped table-bordered table-condensed table-hover purchase_table table-responsive" id="purchase_data">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="span2" width="12%">Items</th>
