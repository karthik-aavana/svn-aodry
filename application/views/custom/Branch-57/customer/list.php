                    ...
                    <div id="plus_btn">
                        ...
                        <?php } ?> -->
                         <h3 class="box-title">Customer</h3>
                            ...
                            <span><a href="<?php echo base_url("assets/excel/CustomerDemo_Leather_Craft.csv") ?>"  class="btn btn-sm btn-info pull-right" data-toggle="tooltip" data-placement="bottom" data-custom-class="tooltip-primary" data-original-title="Download Customer CSV Demo File" download><i class="fa fa-download"></i></a></span>
                        ...
                        <form method="post" action="<?php echo base_url() ?>Customer/exportCustomerReportExcelLeatherCraft" id="export_form">
