                        ...
                        <div class="box-body">                      
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="store_location" name="store_location" value="">
                            ...
                            <div class="box-footer">
                                <button type="button" id="customer_submit" class="btn btn-info">
                                    Add</button>
...
<script>
    ...
    $("#customer_submit").click(function (event) {
       ...
       /* if (email == null || email == "") {
        ...
        $.ajax({
            url: base_url + 'customer/get_check_customer_code_add',
            dataType: 'JSON',
            method: 'POST',
            data: {
