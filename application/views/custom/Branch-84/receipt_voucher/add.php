                ...
                <div class="box">
                    ...
                    <form role="form" id="form" method="post" action="<?php echo base_url('receipt_voucher/add_receipt'); ?>">
                        <div class="box-body">   
                            ...
                            <div class="row row_count main_row_customer" row="1" id="ToClone">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="customer">Customer <span class="validation-color">*</span></label>
                                        <a type="buttion" href="#" class="add_customer_row_button pull-right">(+)</a>
...
<?php $this->load->view('receipt_voucher/receipt_popup_view'); ?>
