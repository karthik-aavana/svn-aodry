                                                ...
                                                foreach ($items as $key) {
                                                    ...
                                                    <tr id="<?= $i ?>">
                                                            ...
                                                            <select class="form-control form-fixer select2" name="item_uom" disabled="disabled">
                                                                ...
                                                                if(!empty($uqc_product)){
                                                                    foreach ($uqc_product as $k => $uom) { ?>
                                                                        <option value="<?=$uom->id;?>" <?=($key->quotation_item_uom_id == $uom->id ? 'selected' : '')?>><?=$uom->uom;?></option>
                                                                    <?php } 
                                                                }?>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            ...
                                                            echo $key->quotation_item_mrp_price ? precise_amount($key->quotation_item_mrp_price) : 0;
                                                            ?>">
                                                        </td>
                                                        <td><input type='text' class='form-control form-fixer text-right float_number' name='item_price' value='<?= ($key->quotation_item_unit_price ? precise_amount($key->quotation_item_unit_price) : 0); ?>'><span id='item_sub_total_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= ($key->quotation_item_sub_total ? precise_amount($key->quotation_item_sub_total) : 0); ?></span>
                                                            <input type='hidden' class='form-control form-fixer text-right' style='' value='<?= ($key->quotation_item_sub_total ? precise_amount($key->quotation_item_sub_total) : 0); ?>' name='item_sub_total'>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            echo $key->quotation_item_scheme_discount_id ? $key->quotation_item_scheme_discount_id : 0;
                                                            ?>'>
                                                            <input type='hidden' name='item_scheme_discount_percentage' value='<?php
                                                            echo $key->quotation_item_scheme_discount_percentage ? precise_amount($key->quotation_item_scheme_discount_percentage) : 0;
                                                            ?>'>
                                                            <input type='hidden' name='item_scheme_discount_amount' value='<?= ($key->quotation_item_scheme_discount_amount ? precise_amount($key->quotation_item_scheme_discount_amount) : 0); ?>'>
                                                            <div class="form-group" style="margin-bottom:0px !important;">
                                                                <select class="form-control open_discount form-fixer select2" name="item_scheme_discount">
                                                                    <option value="">Select</option>
                                                                    <?php
                                                                    foreach ($discount as $key3 => $value3) {
                                                                        if ($value3->discount_id == $key->quotation_item_scheme_discount_id) {
                                                                            echo "
                                                            ...
                                                            <span id='item_scheme_discount_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?php
                                                                echo $key->quotation_item_scheme_discount_amount ? precise_amount($key->quotation_item_scheme_discount_amount) : 0;
                                                                ?></span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        if ($access_settings[0]->discount_visible == 'yes') { ?>
                                                        <td>
                                                            <input type="text" class="form-control form-fixer text-right float_number" name="item_cash_discount" value="<?=precise_amount($key->quotation_item_cash_discount_amount);?>">
                                                        </td>
                                                        <?php } ?>
                                                        ...
                                                        <?php
                                                        $quotation_temp = array("item_key_value" => $i, "item_id" => $key->item_id, "item_type" => $key->item_type, "item_quantity" => $key->quotation_item_quantity, 
                                                            "free_item_quantity" => $key->quotation_item_free_quantity,
                                                            "item_uom" => $key->quotation_item_uom_id,
                                                            "item_price" => $key->quotation_item_unit_price ? precise_amount($key->quotation_item_unit_price) : 0,
                                                            "item_mrp_price" => $key->quotation_item_mrp_price ? precise_amount($key->quotation_item_mrp_price) : 0,
                                                             "item_description" => $key->quotation_item_description, "item_sub_total" => $key->quotation_item_sub_total ? precise_amount($key->quotation_item_sub_total) : 0,
                                                             "item_cash_discount" => (@$key->quotation_item_cash_discount_amount ? precise_amount($key->quotation_item_cash_discount_amount) : 0),
                                                            "item_discount_amount" => $key->quotation_item_discount_amount ? precise_amount($key->quotation_item_discount_amount) : 0, "item_discount_id" => $key->quotation_item_discount_id ? $key->quotation_item_discount_id : 0, "item_discount_percentage" => $key->item_discount_percentage ? precise_amount($key->item_discount_percentage) : 0,
                                                            "item_scheme_discount_amount" => (@$key->quotation_item_scheme_discount_amount ? precise_amount($key->quotation_item_scheme_discount_amount) : 0), 
                                                            "item_scheme_discount_id" => (@$key->quotation_item_scheme_discount_id ? $key->quotation_item_scheme_discount_id : 0), 
                                                            "item_scheme_discount_percentage" => (@$key->quotation_item_scheme_discount_percentage ? precise_amount($key->quotation_item_scheme_discount_percentage) : 0), 
