        ...
        <table class="item-table table mt-20">
            ...
            <tbody>
                ...
                foreach ($items as $value) { ?>
                    <tr>
                        ...
                        <td><?php
                            ...
                            ?></td>
                        <td><?php 
                        echo $value->sales_item_free_quantity;
                        ...
                        ?></td>
                         ...
                         echo precise_amount(($value->sales_item_mrp_price* $convert_rate)); ?></td>
                        ...
                        <td style="text-align: right;"><?php echo precise_amount(($value->sales_item_scheme_discount_amount * $convert_rate)); ?></td>
                        <?php
                        }
                        if ($discount_exist > 0 && $schemediscountExist > 0 && ($tax_exist > 0 || $igst_exist > 0 || $cgst_exist > 0 || $sgst_exist > 0 )) {
                            ?>
                            ...
                            <td style="text-align: right;">
                                <?php if ($value->item_type == 'product' || $value->item_type == 'product_inventory') { ?>
                                    ...
                                    if ($value->sales_item_tds_amount < 1) {
                                        ...
                                        ?><?= precise_amount($value->sales_item_tds_amount * $convert_rate); ?><br>(<?= round($value->sales_item_tds_percentage, 2); ?>%)<?php } ?>
                                    <?php
                                } else {
                                    echo '-';
                                }
                        ...
                        if ($tax_exist > 0) {
                            ...
                            <td style="text-align: right;">
                                ...
                                if ($value->sales_item_tax_amount < 1) {
                                    ...
                                    ?>
                                    <?php echo precise_amount(($value->sales_item_tax_amount * $convert_rate)); ?><br>(<?= ($value->sales_item_tax_percentage > 0 ? round(abs($value->sales_item_tax_percentage), 2) . '%' : '-'); ?>)<?php } ?></td>
                        <?php } elseif ($igst_exist > 0) { ?>
                            <td style="text-align: right;">
                                <?php
                        ...
                        <?php } elseif ($cgst_exist > 0 || $sgst_exist > 0) { ?>
                            <td style="text-align: right;">
                                ...
                                if ($value->sales_item_cgst_amount < 1) {
                                    ...
                                    ?>
                                    <?php echo precise_amount(($value->sales_item_cgst_amount * $convert_rate)); ?><br>(<?php echo round($value->sales_item_cgst_percentage, 2); ?>%)<?php } ?></td>
                            <td style="text-align: right;">
                                <?php
                                if ($value->sales_item_sgst_amount < 1) {
                                    echo '-';
                                } else {
                                    ?><?php echo precise_amount(($value->sales_item_sgst_amount * $convert_rate)); ?><br>(<?php echo round($value->sales_item_sgst_percentage, 2); ?>%)<?php } ?></td>
                        <?php } ?>
                        <?php if ($cess_exist > 0) { ?>
                            <td style="text-align: right;">
                                <?php
                                if ($value->sales_item_tax_cess_amount < 1) {
                                    ...
                                    ?><?= precise_amount(($value->sales_item_tax_cess_amount * $convert_rate)); ?><br>(<?= round($value->sales_item_tax_cess_percentage, 2); ?>%)<?php } ?></td>
                        <?php } ?>
                ...
                <tr>
                    ...
                    <th  style="text-align: right;"><?= precise_amount(($data[0]->sales_sub_total * $convert_rate)) ?></th>
                    <?php
                    if ($discount_exist > 0) {
                        ?>
                        <th  style="text-align: right;"><?= precise_amount(($discount_trade * $convert_rate)) ?></th>
                    <?php } ?>
                    <?php
                    if ($schemediscountExist > 0) {
                        ?>
                        <th  style="text-align: right;"><?= precise_amount(($discount_schme * $convert_rate)) ?></th>
                    <?php } ?>
                    <?php
                    if ($discount_exist > 0 && $schemediscountExist > 0 && ($tax_exist > 0 || $igst_exist > 0 || $cgst_exist > 0 || $sgst_exist > 0 )) {
                        ?>
                    ...
                    if ($tds_exist > 0) {
                        ...
                        <th style="text-align: right;"><?= precise_amount((($data[0]->sales_tcs_amount) * $convert_rate)) ?></th>
                    <?php } ?>
                    <?php
                    if ($tax_exist > 0) {
                        ?>
                        <th style="text-align: right;"><?= precise_amount(($data[0]->sales_tax_amount * $convert_rate)) ?></th>
                    <?php } elseif ($igst_exist > 0) { ?>
                    ...
                    <?php } ?>
                    <?php if ($cess_exist > 0) { ?>
                        <th style="text-align: right;"><?= precise_amount(($data[0]->sales_tax_cess_amount * $convert_rate)) ?></th>
                    <?php } ?>
                ...
                <td style="width:30%">
                    <table class="total_sum">
                        ...
                        <tr>
                            ...
                            <td align="right"><?php echo $this->numbertowords->formatInr(precise_amount($data[0]->sales_cash_discount));?></td>
                        </tr><!-- <tr>
                            <td align="right">Cash Discount</td>
                            <td align="right"><?php echo $this->numbertowords->formatInr((abs(precise_amount($data[0]->sales_cash_discount))));  ?></td>
                        <tr>  -->       
                        <tr>
