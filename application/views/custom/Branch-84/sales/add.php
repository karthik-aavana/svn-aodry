                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="brand_invoice_number" name="brand_invoice_number" value="<?= $invoice_number ?>">
                                            ...
                                            <?php if ($access_common_settings[0]->round_off_access == 'yes') { ?>                                          
                                                <tr id="round_off_option">
                                                    ...
                                                    <td align="right" width="50%">
                                                        <label>
                                                            <input class="" type="radio" name="round_off_key" value="yes">yes
                                                        </label>

                                                        <label>
                                                            <input class="" type="radio" name="round_off_key" value="no" checked>No
                                                        </label>
                                                    </td>
                                                </tr>
