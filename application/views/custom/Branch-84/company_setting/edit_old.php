        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('company_setting/update'); ?>" encType="multipart/form-data">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        ?>">
                                        <label for="name">Company Name<span class="validation-color"> *</span></label>
                                        <input type="text" class="form-control" id="name" name="name" value="<?php
                                        if (isset($data[0]->firm_name)) {
                                            echo $data[0]->firm_name;
                                        }
                                        ?>">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="registered_type" name="registered_type">
                                            ...
                                            if ($data[0]->firm_registered_type == 'Private Limited Company') {
                                                echo "selected";
                                            }
                                            ?>>Private Limited Company</option>
                                            <option value="Proprietorship" <?php
                                            if ($data[0]->firm_registered_type == 'Proprietorship') {
                                                echo "selected";
                                            }
                                            ?>>Proprietorship</option>
                                            <option value="Partnership" <?php
                                            if ($data[0]->firm_registered_type == 'Partnership') {
                                                echo "selected";
                                            }
                                            ?>>Partnership</option>
                                            <option value="One Person Company" <?php
                                            if ($data[0]->firm_registered_type == 'One Person Company') {
                                                echo "selected";
                                            }
                                            ?>>One Person Company</option>
                                            <option value="Limited Liability Partnership" <?php
                                            if ($data[0]->firm_registered_type == 'Limited Liability Partnership') {
                                                echo "selected";
                                            }
                                            ?>>Limited Liability Partnership</option>
                                            <!-- <option value="Foreign Company in India" <?php
                                            if ($data[0]->firm_registered_type == 'Foreign Company in India') {
                                                echo "selected";
                                            }
                                            ?>>Foreign Company in India</option> -->
                                        </select>
                                ...
                                foreach ($financial_year as $key => $value) {
                                    if ($value->financial_year_id == $data[0]->financial_year_id) {
                                        ...
                                        $financial_year_title = $value->financial_year_title;
                                    } else {
                                ...
                                ?>
                                        ...
                                        <input type="hidden" name="financial_year_title" id="financial_year_title" value="<?= $financial_year_title ?>">
                                    </div>
                                </div> -->
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if (!isset($data[0]->firm_logo) || $data[0]->firm_logo == "") {
                                            ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="branch_address" name="branch_address" value="<?php
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="land_number" name="land_number" value="<?php echo $data[0]->branch_land_number; ?>">
                            ...
                            <div class="row">
                                ...
                                <div id="hide_cin" <?php
                                if ($data[0]->firm_registered_type == "Proprietorship" || $data[0]->firm_registered_type == "Partnership" || $data[0]->firm_registered_type == "Foreign Company in India") {
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="import_export_code_number" name="import_export_code_number" value="<?php
                                        if (isset($data[0]->branch_import_export_code_number)) {
                                            echo $data[0]->branch_import_export_code_number;
                                        }
                                        ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="lut_number" name="lut_number" value="<?php
                                        if (isset($data[0]->branch_lut_number)) {
                                            echo $data[0]->branch_lut_number;
                                        }
                                        ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="drug_no_1">Drug Licence Number
                                            <span class="validation-color"></span>
                                        </label>
                                        <input type="text" class="form-control" id="drug_no_1" name="drug_no_1" value="<?php
                                        if (isset($data[0]->drug_licence_no_1)) {
                                            echo $data[0]->drug_licence_no_1;
                                        }
                                        ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="drug_no_2">Food Licence Number
                                            <span class="validation-color"></span>
                                        </label>
                                        <input type="text" class="form-control" id="drug_no_2" name="drug_no_2" value="<?php
                                        if (isset($data[0]->drug_licence_no_2)) {
                                            echo $data[0]->drug_licence_no_2;
                                        }
                                        ?>">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="iec"><span>Import & Export File</span></label>
                                        <?php
                                        if (!isset($data[0]->branch_import_export_code) || $data[0]->branch_import_export_code == "") {
                                            ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <?php
                                        if (!isset($data[0]->branch_shop_establishment) || $data[0]->branch_shop_establishment == "") {
                                            ?>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="branch_code" name="branch_code" value="<?php echo $data[0]->branch_code; ?>" readonly>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="round_off_access" name="round_off_access" style="width: 100%;">
                                            ...
                                            if ($data[0]->round_off_access == 'yes') {
                                                echo "selected";
                                            }
                                            ?>>Yes</option>
                                            <option value="no" <?php
                                            if ($data[0]->round_off_access == 'no') {
                                                echo "selected";
                                            }
                                            ?>>No</option>
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="tax_split_equaly" name="tax_split_equaly" style="width: 100%;">
                                            <option value="yes" <?php
                                            if ($data[0]->tax_split_equaly == 'yes') {
                                                echo "selected";
                                            }
                                            ?>>Yes</option>
                                            <option value="no" <?php
                                            if ($data[0]->tax_split_equaly == 'no') {
                                                echo "selected";
                                            }
                                            ?>>No</option>
                                        </select>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group <?= ($data[0]->tax_split_equaly == 'yes' ? 'disable_in' : ''); ?> tax_per">
                                        <label for="tax_split_percentage">Tax Split Percentage <span class="validation-color"> *</span></label>
                                        <input type="number" class="form-control" id="tax_split_percentage" name="tax_split_percentage" value="<?= (float) $data[0]->tax_split_percentage; ?>" placeholder="CGST %" <?= ($data[0]->tax_split_equaly == 'yes' ? 'readonly' : ''); ?> max="100">
                                        <span class="validation-color" id="err_tax_split_percentage"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="tax_split_equaly">Frequency Update<span class="validation-color"> *</span></label>
                                        <select class="form-control select2" id="default_notification_date" name="default_notification_date" style="width: 100%;">
                                            <option <?= ($data[0]->default_notification_date == 5 ? "selected" : "") ?>>5</option>
                                            <option <?= ($data[0]->default_notification_date == 10 ? "selected" : "") ?>>10</option>
                                            <option <?= ($data[0]->default_notification_date == 20 ? "selected" : "") ?>>20</option>
                                            <option <?= ($data[0]->default_notification_date == 30 ? "selected" : "") ?>>30</option>
                                        </select>
                                        <span class="validation-color" id="err_tax_split_equaly"><?php echo form_error('tax_split_equaly'); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="branch_roc">Affiliate Images
                                            <span class="validation-color"></span>
                                        </label>
                                        <input type="file" multiple class="form-control" id="affliete_images" name="affliete_images[]">
                                        <span class="validation-color" id="err_branch_roc"><?php echo form_error('affliete_images'); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" id="invoice_footer" name="invoice_footer"><?php echo $data[0]->invoice_footer; ?></textarea>
                                ...
                                <div>
                                    <?php
                                    if ($data[0]->affliation_images != NULL) {
                                        $json_str = str_replace("\\", "", $data[0]->affliation_images);
                                        $arr = json_decode($json_str);
                                        foreach ($arr as $key) {
                                            echo "<img class='m-25' height='150' width = '150' src = '" . base_url() . '/assets/affiliate/' . $this->session->userdata('SESS_BRANCH_ID') . '/' . $key . "'>";
                                        }
                                    }
                                    ?>
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        $("#gstn_selected").hide();
        $(document).on('change', '#tax_split_equaly', function () {
            if ($(this).val() == 'no') {
                $('.tax_per').removeClass('disable_in').find('input').attr('readonly', false);
            } else {
                $('.tax_per').addClass('disable_in').find('input').val('50').attr('readonly', true);
            }
        })
        ...
        $("#financial_year_id").change(function () {
            $('#financial_year_title').val($('#financial_year_id option:selected').text());
        });
        ...
        $("#company_submit").click(function () {
            ...
            if (import_export_code) {
                ...
                } else if (extension1 != "PNG" && extension1 != "JPG" && extension1 != "JPEG" && extension1 != "PDF" && extension1 != "DOC" && extension1 != "DOCX" && extension1 != "XLS" && extension1 != "XLSX") {
                    import_export_code_ok = 0;
            ...
            if (shop_establishment) {
                ...
                } else if (extension2 != "PNG" && extension2 != "JPG" && extension2 != "JPEG" && extension2 != "PDF" && extension2 != "DOC" && extension2 != "DOCX" && extension2 != "XLS" && extension2 != "XLSX") {
                    shop_establishment_ok = 0;
            ...
            var tax_split_percentage = $('#tax_split_percentage').val();
            if (tax_split_percentage > 100 || tax_split_percentage < 0) {
                $("#err_tax_split_percentage").text("Add valid Percentage");
            } else {
                $("#err_tax_split_percentage").text("");
            }
