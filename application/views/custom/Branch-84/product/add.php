                            ...
                            <div class="row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control select2" id="product_unit" name="product_unit" style="width: 100%;" tabindex="4">
                                                ...
                                                foreach ($uqc as $value) {
                                                    echo "<option value='$value->id'" . set_select('brand', $value->id) . " unit='".$value->uom."'>$value->uom - $value->description</option>";
                                                }
                                                ?>
                                            </select>
                                        </div>
                                ...
                                <div class="col-sm-6 " style="margin-top: 20px;">
                                    <div class="form-group change_uom disabled" >
                                        <span class="col-sm-3 fright">1 <span id="uom_text"></span> = </span>
                                        <div class="col-sm-3 p_0"><input type="text" name="equal_uom" class="form-control"></div>
                            ...
                            <div class="row"> 
                                ...
                                <!-- <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="product_basic_price" name="product_basic_price" value="" readonly>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('change','[name=product_unit]',function(){
            var unit = $(this).find('option:selected').attr('unit');
            console.log(unit);
            if(unit){
                $('#uom_text').text(unit);
                $('#product_equal_unit').val(28).change();
                $('.change_uom').removeClass('disabled');
            }else{
                $('#uom_text').text('');
                $('.change_uom').addClass('disabled');
            }
        })
