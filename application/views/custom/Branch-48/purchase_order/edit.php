        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('purchase_order/edit_purchase_order');?>">
                            <div class="row">
                                <input type="hidden" name="purchase_order_id" value="<?php echo $data[0]->purchase_order_id;
                                            ?>">
                                <div class="col-sm-3">
                         ...
                         <!--    <div class="row">                                
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="grn_date" name="grn_date" autocomplete="off" value="<?= $data[0]->purchase_order_grn_date; ?>">
                                        <span class="validation-color" id="err_date"></span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        if ($purchase_order_supplier_date == '1970-01-01')
                                            $purchase_order_supplier_date = "";
                                        ?>
                                        <input type="date" class="form-control datepicker" id="supplier_date" name="supplier_date" value="<?= $purchase_order_supplier_date ?>">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="nature_of_supply">Purchase_order Order Number</label>
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="nature_of_supply">Purchase_order Order Date</label>
                                        <input type="date" class="form-control" id="purchase_order_order_date" name="purchase_order_order_date" value="<?= ($data[0]->purchase_order_order_date == '1970-01-01' ? '' : $data[0]->purchase_order_order_date); ?>">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="date" class="form-control datepicker" id="delivery_date" name="delivery_date" value="<?= $delivery_date; ?>">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="box-header transporter">
                                                    ...
                                                    <tr id="<?= $i ?>">
                                                        ...
                                                        if ($access_settings[0]->discount_visible == 'yes') {
                                                            ...
                                                            <td style="display: none;">
                                                                ...
                                                                ?>'>
                                                                <input type='hidden' name='item_discount_percentage' value='<?= ($key->purchase_order_item_discount_percentage ? (float)($key->purchase_order_item_discount_percentage) : 0); ?>'>
                                                        ...
                                                        <?php if ($access_settings[0]->tds_visible == 'yes') { ?>
                                                            <td style='text-align:center'>
                                                                ...
                                                                <input type="text" class="form-control open_tds_modal pointer" name="item_tds_percentage" value="<?=(float)$tds_per ?>%" readonly>
                                                        ...
                                                        <?php if ($access_settings[0]->tax_type == 'gst' || $access_settings[0]->tax_type == 'single_tax') { ?>
                                                            ...
                                                            <!-- <td><input type='hidden' name='item_tax_cess_id' value='<?= ($key->purchase_order_item_tax_cess_id ? $key->purchase_order_item_tax_cess_id : 0); ?>'>
                                                                ...
                                                                <div class="form-group" style="margin-bottom:0px !important;">
                                                                    <select class="form-control open_tax form-fixer select2" name="item_tax_cess" <?= $key->purchase_order_item_tax_cess_id; ?>>
                                                                        <option value="">Select</option>
                                                                        <?php
                                                                        foreach ($tax as $key3 => $value3) {
                                                                            if ($value3->tax_name == 'CESS') {
                                                                                echo "<option value='" . $value3->tax_id . "-" . ($value3->tax_value) . "' " . ($value3->tax_id == $key->purchase_order_item_tax_cess_id ? 'selected' : '' ) . ">" . (float)($value3->tax_value) . "%</option>";
                                                                            }
                                                                        }
                                                                        ?>
                                                                    </select>
                                        ...
                                        <input type="hidden" class="form-control" id="section_area" name="section_area" value="edit_purchase_order" >
                                        ...
                                        <input type="hidden" name="table_data" id="table_data" value="<?= $purchase_order; ?>">
                                        ...
                                        <table id="table-total" class="table table-striped table-bordered table-condensed table-hover table-responsive mt-15">
                                            ...
                                            <tr>
                                                ...
                                                <td align='right'><span id="totalGrandTotal"><?= precise_amount($data[0]->purchase_order_grand_total + $data[0]->round_off_amount); ?></span></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                ...
                                <span class="btn btn-default" id="sale_cancel" onclick="cancel('purchase_order')">Cancel</span>
                            </div>
...
var purchase_data = <?php echo json_encode($purchase_order_data); ?>;
