        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('quotation/add_quotation'); ?>">
                                <div class="row">
                                    <div class="col-sm-3">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <?php if (in_array($customer_module_id, $active_add)) { ?>
                                                        <a data-backdrop="static" data-keyboard="false" href="#" data-toggle="modal" data-target="#customer_modal" data-reference_type="quotation" class="open_customer_modal pull-right">+</a>
                                                    <?php } ?>
                                                </div>
                            ...
                            <div class="row default_hide">
                                <div class="col-sm-12">
                                    <div class="box-header">
                                        ...
                                        <input type="hidden" class="form-control" id="section_area" name="section_area" value="quotation" >
                                        ...
                                        <table id="table-total" class="table table-striped table-bordered table-condensed table-hover table-responsive mt-15">
                                            ...
                                            <!-- <tr <?= ($access_settings[0]->tax_type == 'no_tax' ? 'style="display: none;"' : ''); ?>>
...
<script type="text/javascript">
    $('#err_sales_code').text('Please select the customer to do quotation.');
