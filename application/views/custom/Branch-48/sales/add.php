                                        ...
                                        <table class="table table-striped table-bordered table-condensed table-hover sales_table table-responsive" id="sales_data">
                                            ...
                                            <tbody id="sales_table_body">
                                               <!--  <tr id="0">
                                                    ...
                                                    <td><input id="input_sales_code" class="form-control" type="text" name="input_sales_code" placeholder="Enter Product/Service Code/Name" ></td>
                                                    <?php
                                                    if ($access_settings[0]->description_visible == 'yes') {
                                                        ?>
                                                    <td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-group" style="margin-bottom:0px !important;">
                                                            <select class="form-control select2" name="item_discount" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                            <option value="">Select</option>
                                                            <?php
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-group" style="margin-bottom:0px !important;">
                                                            <select class="form-control open_tax select2" name="item_tax" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                                <option value="">Select</option>
                                                                <?php
                                                                foreach ($tax_gst as $row) {
                                                                    echo "<option value='$row->tax_id'" . set_select('gst_tax', $row->tax_id . "-" . $row->tax_value) . ">" . (float)($row->tax_value) . "%</option>";
                                                                }
                                                                ?>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="form-group" style="margin-bottom:0px !important;">
                                                            <select class="form-control open_tax select2" name="item_tax_cess" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                                <option value="">Select</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="input-group" style="margin-bottom:0px !important;">
                                                            ...
                                                            <input type="text" class="form-control form-fixer text-right float_number" id="product_hsn_sac_code" name="product_hsn_sac_code" value="<?php echo set_value('service_hsn_sac_code'); ?>" tabindex="11">
                                                        </div>
                                                    </td>
                                                    <td style="text-align:center">
...
$this->load->view('sales/hsn_modal');
