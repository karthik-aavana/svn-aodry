                                            ...
                                            <tbody id="sales_table_body">
                                                ...
                                                foreach ($items as $key) {
                                                    ...
                                                    <tr id="<?= $i ?>">
                                                        ...
                                                        <?php
                                                        $sales_temp = array("item_key_value" => $i, "item_id" => $key->item_id, "item_type" => $key->item_type, "item_quantity" => $key->sales_item_quantity, "item_price" => $key->sales_item_unit_price ? precise_amount($key->sales_item_unit_price) : 0, "item_description" => $key->sales_item_description, "item_sub_total" => $key->sales_item_sub_total ? precise_amount($key->sales_item_sub_total) : 0, "item_discount_amount" => $key->sales_item_discount_amount ? precise_amount($key->sales_item_discount_amount) : 0, "item_discount_id" => $key->sales_item_discount_id ? $key->sales_item_discount_id : 0, "item_discount_percentage" => $key->item_discount_percentage ? precise_amount($key->item_discount_percentage) : 0, "item_tax_amount" => $key->sales_item_tax_amount ? precise_amount($key->sales_item_tax_amount) : 0, "item_tax_id" => $key->sales_item_tax_id ? $key->sales_item_tax_id : 0, "item_tax_cess_amount" => $key->sales_item_tax_cess_amount ? precise_amount($key->sales_item_tax_cess_amount) : 0, "item_tax_cess_id" => $key->sales_item_tax_cess_id ? $key->sales_item_tax_cess_id : 0, "item_tax_cess_percentage" => $key->sales_item_tax_cess_percentage ? precise_amount($key->sales_item_tax_cess_percentage) : 0, "item_tax_percentage" => $key->sales_item_tax_percentage ? precise_amount($key->sales_item_tax_percentage) : 0, "item_tds_amount" => $key->sales_item_tds_amount ? precise_amount($key->sales_item_tds_amount) : 0, "item_tds_id" => $key->sales_item_tds_id ? $key->sales_item_tds_id : 0, "item_tds_percentage" => $key->sales_item_tds_percentage ? precise_amount($key->sales_item_tds_percentage) : 0, "item_taxable_value" => $key->sales_item_taxable_value ? precise_amount($key->sales_item_taxable_value) : 0, "item_grand_total" => $key->sales_item_grand_total ? precise_amount($key->sales_item_grand_total) : 0);
