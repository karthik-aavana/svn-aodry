    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url('pos_voucher'); ?>">Pos Voucher</li></a>
                <li class="active">Pos Voucher Details</li>
            </ol>
        </h5>
    </section>
                                        ...
                                        foreach ($data as $row) {
                                            ...
                                            <tr>
                                                ...
                                                if ($row->dr_amount != 0) {
                                                    ...
                                                    ?>
                                                    <td>
                                                        <?php echo precise_amount($row->voucher_amount); ?></td>
                                                    <td>
                                                        <?php echo "0.00"; ?>
                                                    </td>
                                                    <?php
