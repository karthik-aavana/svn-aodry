                        ...
                        <table id="list_datatable" class="table table-bordered table-striped table-hover table-responsive">
                            <thead>
                                <tr>
                                    <th width="9px">#</th>
                                    <th>Particular</th>
                                    <th>Name of Assets Purchase</th>
                                    <th>Date of Use</th>
                                    <th>Date of Purchase</th>
                                    <th>Rate Depreciation Income Tax</th>
                                    <th>Rate Depreciation Company Acts</th>
                                </tr>
                            </thead>
                            <tbody></tbody>
                        </table>
    ...
    $(document).ready(function () {
        $('#list_datatable').DataTable({
            ...
            "columns": [
                {"data": "action"},
                {"data": "particulars"},
                {"data": "name_of_assets_purchase"},
                {"data": "date_of_use"},
                {"data": "date_purchase"},
                {"data": "rate_depreciation_income_tax"},
                {"data": "rate_depreciation_company_act"}
            ],
             'language': {
                'loadingRecords': '&nbsp;',
