            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sales Credit Note Ledger</h3>
                    </div>
...
function GetAllVoucher(page = 1,reference_id = ''){
    ...
    $.ajax({
        url:'<?=base_url();?>Sales_credit_ledgers/GetAllVoucher',
        type:'post',
        dataType:'json',
        data:{page:page,invoice_to : invoice_to,invoice_from : invoice_from,invoice_ledger : invoice_ledger,invoice_cr : invoice_cr,invoice_status : invoice_status,voucher_type:voucher_type,voucher_id:voucher_id,reference_id:reference_id},
                beforeSend: function(){
