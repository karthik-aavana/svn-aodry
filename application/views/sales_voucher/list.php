...
<div class="content-wrapper">
    ...
    <div class="fixed-breadcrumb">
        <ol class="breadcrumb abs-ol">
            ...
            <li class="active"><?= ucfirst(str_replace('_', ' ', $voucher_type)); ?>Voucher</li>
        </ol>
    </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', 'input[name="check_sales"]', function () {
            if ($(this).is(":checked")) {

                $(document).find('[name=check_sales]').prop('checked', false);
