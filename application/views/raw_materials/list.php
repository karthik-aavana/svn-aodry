                    ...
                    <div class="box-body">
                        <table id="list_datatable" class="custom_datatable table table-bordered table-striped table-hover table-responsive" >
                            <thead>
                                <tr>
                                    <!-- <th>Date</th> -->
                                    <th style="min-width: 100px;text-align: center;">Product Code</th>
                                    ...
                                    <th style="min-width: 100px;text-align: center;">Type</th>
...
<div class="modal-dialog">
    ...
    <div class="modal-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <div class="input-group-addon">
                                    <a data-toggle="modal" data-target="#hsn_modal" class="pull-right"><span class="fa fa-eye"></span></a>
                                </div>
        ...
        <div class="modal-footer">
            <button class="btn btn-sm btn-info" id='post_products' href="#">Update</button>
...
$.ajax({
type: "GET",
url: base_url + "Raw_materials" + productId,
