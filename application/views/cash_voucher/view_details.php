    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url('cash_voucher'); ?>">Cash Voucher</li></a>
                <li class="active">Cash Voucher Details</li>
            </ol>
        </h5>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">View Cash Voucher Details</h3>
                        <a class="btn btn-sm btn-default pull-right back_button" id="cancel" onclick1="cancel('cash_voucher')">Back</a>
                    </div>
                    <div class="box-body">
                        <div class="row">
