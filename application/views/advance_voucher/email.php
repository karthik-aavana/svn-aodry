...
<div class="content-wrapper">
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Advance Voucher Email</li>
            </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            <?php
            $advance_id = $this->encryption_url->encode($data[0]->advance_voucher_id);
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $advance_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Advance Voucher Email</h3>
