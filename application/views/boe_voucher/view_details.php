    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url('boe_voucher'); ?>">boe Voucher</li></a>
                <li class="active">BOE Voucher Details</li>
            </ol>
        </h5>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <a href="javascript:void(0);" class="btn btn-sm btn-info pull-right back_button" id="cancel" onclick1='cancel("<?= $data[0]->reference_type; ?>_voucher")'>Back</a>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-sm-3">
