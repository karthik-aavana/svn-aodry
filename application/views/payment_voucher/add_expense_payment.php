...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('expense_bill'); ?>">expense_bill</a></li>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header with-border">
            ...
            <a class="btn btn-default pull-right back_button" id="sale_cancel" onclick1="cancel('expense_bill')">Back</a>
          </div>
          <select id="common_select" style="display: none;">
            ...
            <?php if(!empty($data)){
              $data_items = array();
              $data_items = array();
              foreach ($data as $key => $expense_bill) { 
                  $expense_bill->purchase_grand_total = $expense_bill->supplier_receivable_amount;
                  $data_items['purchase_'.$expense_bill->expense_bill_id] = $expense_bill; ?>
              <?php } 
           
              foreach ($data as $key => $expense_bill) { 
                  $expense_bill->expense_bill_grand_total = $expense_bill->supplier_receivable_amount;
                  $data_items['expense_bill_'.$expense_bill->expense_bill_id] = $expense_bill; ?>
                  <option value="<?=$expense_bill->expense_bill_id;?>"><?=$expense_bill->expense_bill_invoice_number;?></option>
              <?php } 
            } ?>
          </select>
          <!-- /.box-header -->
          <form role="form" id="form" method="post" action="<?php echo base_url('payment_voucher/add_payment'); ?>">
            <div class="box-body">
              <div class="row">
                <div class="col-md-12">
                  <div class="well">
                    <div class="row">
                      ...
                      <div class="col-sm-3">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="total_payment_amount" name="total_payment_amount" value="">
                          <span class="validation-color" id="err_total_payment_amount"></span>
                        </div>
                      </div>    
                    </div>
                    <?php
                    $reference_id_arr     = explode("," , $data[0]->expense_bill_id);
                    $reference_number_arr = explode("," , $data[0]->expense_bill_invoice_number);
                    $payment_amount_arr   = explode("," , "0");
                    $paid_amount_arr      = explode("," , precise_amount($data[0]->expense_bill_paid_amount));
                   
                    $balance_amount_arr   = explode("," , precise_amount(($data[0]->expense_bill_grand_total - $data[0]->expense_bill_paid_amount)));
                    $invoice_total_arr    = explode("," , precise_amount(($data[0]->expense_bill_grand_total)));
                    ...
                    <div class="row row_count main_row" row="1" id="ToClone">
                      <div class="col-sm-2 reference_number_div" style="width: 20%">
                        <div class="form-group">
                          ...
                          <span>Invoice Amount: <strong class="total_invoice_amount"><?= precise_amount($data[0]->expense_bill_grand_total) ?></strong>/-</span>
                      ...
                      <div class="col-sm-2 payment_amount_div">
                        <div class="form-group">
                          <label for="payment Amount">payment<br/>Amount <span class="validation-color">*</span></label>
                          <input type="text" class="form-control" id="payment_amount_1" name="payment_amount" value="<?=$payment_amount_arr[0];?>">
                      ...
                      <div class="col-sm-2 gain_loss_amount_div">
                        <div class="form-group">
                          ...
                          <span id='gain_visible' class="toggle_lbl">Loss(+)</span>         
                      ...
                      <input type="hidden" class="form-control" id="old_payment_amount_1" name="old_payment_amount" value="<?= precise_amount($payment_amount_arr[0]) ?>" >
                      <input type="hidden" class="form-control" id="last_payment_amount_1" name="last_payment_amount" value="<?= precise_amount($payment_amount_arr[0]) ?>">
                    ...
                    <div class="row">
                      ...
                      <div id="other_payment" style="display: none;">
                        <div class="col-sm-3">
                          <div class="form-group">
                            <label for="payment_via">Payment Via</label>
              ...
              <input type="hidden" class="form-control" id="reference_type" name="reference_type" value="expense" >
              <input type="hidden" class="form-control" id="redirect" name="redirect" value="expense_bill" >
              <input type="hidden" name="invoice_data" id="invoice_data">
              <input type="hidden" name="excess_expense_bill_id" id="excess_expense_bill_id">
              <!-- Hidden Field -->
              <div class="box-footer">
                <button type="submit" id="payment_submit" class="btn btn-info">Pay</button>
                <span class="btn btn-default" id="payment_cancel" onclick="cancel('expense_bill')">Cancel</span>
              </div>
              <?php
              $notes_sub_module = 0;
...
<script src="<?php echo base_url('assets/js/vouchers/') ?>payment.js"></script>
<script src="<?php echo base_url('assets/js/vouchers/') ?>payment_basic.js"></script>