    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url('payment_voucher'); ?>">Payment Voucher</li></a>
                <li class="active">Payment Voucher Details</li>
            </ol>
        </h5>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <span class="btn btn-sm btn-default pull-right back_button" id="cancel" style="margin: 1%" onclick1="cancel('payment_voucher')">Back</span>
                    </div>
                    <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="amount" name="amount" value="<?= precise_amount($data[0]->voucher_amount); ?>" readonly>
                                    </div>
                                </div>
                            </div>                                   
                            <div class="row">
                                <div class="col-sm-12">
                                    <table id="log_datatableV" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data as $row) {
                                                $id = $row->accounts_payment_id;
                                                ?>
                                                <tr>
                                                    <td><?php echo $row->ledger_name; ?></td>
                                                    <?php
                                                    if ($row->dr_amount != 0) {
                                                        $debit = bcadd($debit, $row->voucher_amount, 2);
                                                        ?>
                                                        <td><?php echo precise_amount($row->voucher_amount); ?></td>
                                                        <td><?php echo "0.00"; ?></td>
                                                        <?php
                                                    } else if ($row->cr_amount != 0) {
                                                        $credit = bcadd($credit, $row->voucher_amount, 2);
                                                        ?>
                                                        <td><?php echo "0.00"; ?></td>
                                                        <td><?php echo precise_amount($row->voucher_amount); ?></td>
                                                    <?php } else {
