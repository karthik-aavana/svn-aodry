...
function GetAllVoucher(page = 1){
    ...
    $.ajax({
        url:'<?=base_url();?>Payment_ledger/GetAllVoucher',
        type:'post',
        dataType:'json',
        data:{reference_type:reference_type,page:page,invoice_to : invoice_to,invoice_from : invoice_from,invoice_ledger : invoice_ledger,invoice_cr : invoice_cr,invoice_status : invoice_status,voucher_type:voucher_type,voucher_id:voucher_id},
         beforeSend: function(){
