                        ...
                        <div class="box-body">             
                            <div class="well">
                                ...
                                <div class="row row_count main_row" row="1" id="ToClone">
                                    ...
                                    <input type="hidden" class="form-control" id="old_payment_amount_1" name="old_payment_amount" value="" >
                                    <input type="hidden" class="form-control" id="last_payment_amount_1" name="last_payment_amount" value="">
                                    <!-- hidden -->
                                </div>                    
