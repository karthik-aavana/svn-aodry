            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"> TCS Receivable  Reports (Purchase)</h3>    
                        ...
                        <table id="list_datatable" class="table table-bordered table-striped table-hover table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th>
                                        <a data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#tcs_receivable_modal">TCS receivable u/s<span class="fa fa-toggle-down"></span></a>
                                    </th>
                                    <th>
...
<div class="modal fade" id="tcs_receivable_modal" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Please Select TCS Receivable u/s</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <select class="select2" multiple="multiple"  id="filter_tcs_section"  name="filter_tcs_section">
                                <option value="">Please Select TCS Receivable u/s</option>
                                <?php
                                foreach ($tds_section as $key => $value) {
                                    if ($value->section_name != '') {
                                        $section = 'TCS receivable u/s' . $value->section_name;
                                        ?>
                        ...
                        <div class="form-group">
                            <select class="select2" multiple="multiple"  id="filter_tcs_percentage"  name="filter_tcs_percentage">
                                ...
                                foreach ($tcs_percentage as $key => $value) {
                                    if ($value->purchase_item_tds_percentage != '') {
                                        $percentage = (float)($value->purchase_item_tds_percentage);
                                        ?>
                                        <option value="<?= $value->purchase_item_tds_percentage ?>"><?= $percentage.'%' ?></option>
                                        <?php
                                    }
                                }
                                ?>  
...
<div class="modal fade" id="tcs_purchase_report_select_columns" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-3" aria-hidden="true" data-backdrop="static">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <label for="tds_receivable">TCS receivable u/s</label><br>
                            ...
                            <div class="col-md-6">
                                ...
                                <label for="tds_amount">TCS Amount</label><br>
    ...
    $(document).ready(function () {
        ...
        function generateOrderTable() {
            list_datatable = $("#list_datatable").DataTable({
                ...
                "ajax": {
                    "url": base_url + "report/tcs_report_purchase",
                    "dataType": "json",
                    "type": "POST",
               ...
               dom: 'Bfrltip',
                 buttons: [
                    ...
                    {extend: 'pdfHtml5',
                        text: 'PDF',
                        filename: 'TCS Receivable Reports (Purchase)',
                                ...
                                return {
                                    columns: [
                                        ...
                                        },
                                        {
                                            alignment: 'right',
                                            fontSize: 14,
                                            text: 'TCS Receivable Reports (Purchase)'
                                        }
                                    ],
                                    margin: 20
                                }
                    ...
                    },
                    {
                        text: 'Select columns',
                        action: function (e, dt, node, config) {
                            $('#tcs_purchase_report_select_columns').modal('show');
                    }
        ...
        function appendFilter() { //button filter event click
            ...
            if (filter_tcs_section != '') {
                label += "<label id='lbl_tcs_section' class='label-style'><b> TCS Receivable U/S : </b> " + filter_tcs_section.slice(0, -2) + '<i class="fa fa-times"></i></label>'+" ";
            }
            ...
            if (from_tcs_amount != "" || to_tcs_amount != "") {
                filter_tcs_amount = "<label id='lbl_tcs_amount' class='label-style'><b> TCS Amount : </b> FROM " + from_tcs_amount + " TO " + to_tcs_amount + '<i class="fa fa-times"></i></label>';
            }
...
$(document).ready(function(){
    $('#tcs_purchase_report_select_columns #select_column').click(function(){
        var checked_arr = [];
        var unchecked_arr = [];

        $.each($('#tcs_purchase_report_select_columns input[type="checkbox"]:checked'),function(key,value){
            checked_arr.push(this.value);
        });

        $.each($('#tcs_purchase_report_select_columns input[type="checkbox"]:not(:checked)'),function(key,value){
        ...
        $('#tcs_purchase_report_select_columns ').modal('hide');
    });
});
</script>