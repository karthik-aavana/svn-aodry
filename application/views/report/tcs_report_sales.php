...
<div class="modal fade" id="tcs_report_select_columns" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-3" aria-hidden="true" data-backdrop="static">
               ...
               dom: 'Bfrltip',
                buttons: [
                    ...
                    },
                    {
                        text: 'Select columns',
                        action: function (e, dt, node, config) {
                            $('#tcs_report_select_columns').modal('show');
                    }
...
$(document).ready(function(){
        $('#tcs_report_select_columns #select_column').click(function(){
            var checked_arr = [];
            var unchecked_arr = [];

            $.each($('#tcs_report_select_columns input[type="checkbox"]:checked'),function(key,value){
                checked_arr.push(this.value);
            });

            $.each($('#tcs_report_select_columns input[type="checkbox"]:not(:checked)'),function(key,value){
            ...
            $('#tcs_report_select_columns ').modal('hide');
        });
    });
</script>