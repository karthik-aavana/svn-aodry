...
?>
<style type="text/css">    
    table tr th a, #report_table tr td{
        white-space: nowrap;
    }   
    .form-group {
        margin: 10px 5px;
                ...
                <div class="box">
                    <div class="box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sales Debit Note GST Report</h3>
                            ...
                            <option value="">Please Select Voucher Number</option>
                                <?php
                                    foreach ($voucher_number as $key => $value) {
                                        if($value->sales_debit_note_invoice_number != ''){
                                    ?>
                                    <option value="<?= $value->sales_debit_note_invoice_number ?>"><?= $value->sales_debit_note_invoice_number ?></option>
                                    <?php
                                    }
                                    }
                                ?>                                
                            ...
                            <select class="select2" multiple="multiple"  id="filter_quantity"  name="filter_quantity">
                                ...
                                <?php
                                    foreach ($quantity as $key => $value) {
                                        if($value->sales_debit_note_item_quantity != ''){
                                    ?>
                                    <option value="<?= $value->sales_debit_note_item_quantity ?>"><?= round($value->sales_debit_note_item_quantity,2) ?></option>
                                    <?php
                                    }
                                    }
                                ?>
                            ...
                            <select class="select2" multiple="multiple"  id="filter_price"  name="filter_price">
                                ...
                                <?php
                                    foreach ($unit_price as $key => $value) {
                                        if($value->sales_debit_note_item_unit_price != ''){
                                           $price =  round($value->sales_debit_note_item_unit_price,2);
                                    ?>
                                    <option value="<?= $value->sales_debit_note_item_unit_price ?>"><?= $price ?></option>
                                    <?php
                                    }
                                    }
                                ?>
                            ...
                            <select class="select2" multiple="multiple"  id="filter_place_of_supply"  name="filter_place_of_supply">
                                ...
                                <?php
                                    foreach ($place_of_supply as $key => $value) {
                                        if($value->sales_debit_note_billing_state_id != ''){
                                    ?>
                            ...
                            <option value="">Please Select Rate</option>
                                <?php
                                    foreach ($tax_percentage_gst as $key => $value) {
                                        if($value->sales_debit_note_item_tax_percentage != ''){
                                           $tax_percentage =  (float)($value->sales_debit_note_item_tax_percentage);
                                    ?>
                                    <option value="<?= $value->sales_debit_note_item_tax_percentage ?>"><?= $tax_percentage.'%' ?></option>
                                    <?php
                                    }
                                    }
                                ?>
                                ...
                                <option value="">Please Select CESS Rate</option>
                                 <?php
                                    foreach ($tax_percentage_cess as $key => $value) {
                                        if($value->sales_debit_note_item_tax_cess_percentage != ''){
                                           $tax_percentage =  (float)($value->sales_debit_note_item_tax_cess_percentage);
                                    ?>
                                    <option value="<?= $value->sales_debit_note_item_tax_cess_percentage ?>"><?= $tax_percentage.'%' ?></option>
                                    <?php
                                    }
                                    }
                                ?>
...
<div class="modal fade" id="gst_debit_report_select_columns" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel-3" aria-hidden="true" data-backdrop="static">
   ...
   var list_datatable; 
    $(document).ready(function () {
        ...
        list_datatable = $("#report_table").DataTable({
            ...
            "ajax": {
                "url": base_url + "report/gst_debit_note_report",
                "dataType": "json",
                "type": "POST",
            ...
            "columnDefs": [{
               ...
               buttons: [
                   {extend: 'csv',
                    ...
                    {extend: 'pdfHtml5',
                        text: 'PDF',
                        filename: 'Sales Debit Note GST Report',
                                ...
                                return {
                                    columns: [
                                        ...
                                        },
                                        {
                                            alignment: 'right',
                                            fontSize: 14,
                                            text: 'Sales Debit Note GST Report'
                                        }
                                    ],
                                    margin: 20
                                }
                    ...
                    },
                    {
                        text: 'Select columns',
                        action: function (e, dt, node, config) {
                            $('#gst_debit_report_select_columns').modal('show');
                    }
...
$(document).ready(function(){
    $('#gst_debit_report_select_columns #select_column').click(function(){
        var checked_arr = [];
        var unchecked_arr = [];

        $.each($('#gst_debit_report_select_columns input[type="checkbox"]:checked'),function(key,value){
            checked_arr.push(this.value);
        });

        $.each($('#gst_debit_report_select_columns input[type="checkbox"]:not(:checked)'),function(key,value){
        ...
        $('#gst_debit_report_select_columns').modal('hide');
    });
});
</script>