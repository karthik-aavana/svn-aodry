                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sales Debit Note  View</h3>
                            <a class="btn btn-sm btn-default pull-right back_button" id="cancel" onclick1="cancel('sales_debit_note')">Back</a>
                        </div>
                    <?php } ?>
                    <div class="box-body">
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 pr-0">                                   
                                <div class="bg-light-table">
                                    ...
                                    Invoice Number: <?= $data[0]->sales_debit_note_invoice_number; ?><br>
                                    <?php
                                    $date = $data[0]->sales_debit_note_date;
                                    $c_date = date('d-m-Y', strtotime($date));
                                    ...
                                    <tbody>
                                                ...
                                                <td ><?php echo $i; ?></td>
                                                  ...
                                                  <td style="text-align: center;"><?php
                                                    ...
                                                    if($unit[0] != '') echo " <br>(" . $unit[0].')';
                                                      ...
                                                      ?></td>
                                                            <td style="text-align: right;"><?php echo number_format($value->sales_debit_note_item_unit_price, 2); ?></td>
                                                            <td style="text-align: right;"><?php echo number_format($value->sales_debit_note_item_sub_total, 2); ?></td>
                                                  <?php
                                                            if ($discount_exist > 0) {
                                                      ?>
                                                                <td style="text-align: right;"><?php echo number_format($value->sales_debit_note_item_discount_amount, 2); ?></td>
                                                  <?php } ?>
                                                  <?php
                                                            if ($discount_exist > 0 && ($tax_exist > 0 || $igst_exist > 0 || $cgst_exist > 0 || $sgst_exist > 0 )) {
                                                      ?>
                                                                <td style="text-align: right;"><?php echo number_format($value->sales_debit_note_item_taxable_value, 2); ?></td>
                                                    <?php } ?>
                                                    <?php if ($tds_exist > 0) { ?>
                                                    <td style="text-align: right;">
                                                      ...
                                                      <?php echo number_format($value->sales_debit_note_item_tds_amount, 2); ?><br>(<?php echo round($value->sales_debit_note_item_tds_percentage,2); ?>%)
                                                      <?php } ?>
                                                      <?php }else{ 
                                                          echo '-';
                                                      } ?>
                                                    ...
                                                    <td style="text-align: right;">
                                                      ...
                                                      <?php echo number_format($value->sales_debit_note_item_tax_amount, 2); ?><br>(<?php echo round($value->sales_debit_note_item_tax_percentage,2); ?>%)
                                                      <?php } ?>
                                                    </td>
                                                    <?php
                                                    } elseif ($igst_exist > 0) {
                                                    ...
                                                    <td style="text-align: right;">
                                                      ...
                                                      <?php echo number_format($value->sales_debit_note_item_igst_amount, 2); ?><br>(<?php echo round($value->sales_debit_note_item_igst_percentage,2); ?>%)
                                                      <?php } ?>
                                                    </td>
                                                    <?php
                                                    } elseif ($cgst_exist > 0 || $sgst_exist > 0) {
                                                    ...
                                                    <td style="text-align: right;">
                                                      ...
                                                      <?php echo number_format($value->sales_debit_note_item_cgst_amount, 2); ?><br>(<?php echo round($value->sales_debit_note_item_cgst_percentage,2); ?>%)
                                                      <?php } ?>
                                                    </td>                  
                                                    <td style="text-align: right;">
                                                      <?php if($value->sales_debit_note_item_sgst_amount < 1){ echo '-'; }else{ ?>
                                                      <?php echo number_format($value->sales_debit_note_item_sgst_amount, 2); ?><br>(<?php echo round($value->sales_debit_note_item_sgst_percentage); ?>%)
                                                      <?php } ?>
                                                    </td>
                                                <?php } ?>
                                                <?php if ($cess_exist > 0) { ?>
                                                    <td style="text-align: right;">
                                                      ...
                                                      <?= precise_amount(($value->sales_debit_note_item_tax_cess_amount )); ?><br>(<?= round($value->sales_debit_note_item_tax_cess_percentage,2); ?>%)
                                                      <?php } ?>
                                                    </td>
                                                <?php } ?>
                                                <td style="text-align: right;"><?php echo number_format($value->sales_debit_note_item_grand_total, 2); ?></td>
                                            </tr>
                                            <?php
                                            $i++;
                                        ...
                                        <tr>
                                          ...
                                          <th  style="text-align: right;"><?= number_format($price, 2) ?></th>
                                           <th  style="text-align: right;"><?= number_format($data[0]->sales_debit_note_sub_total, 2) ?></th>
                                            <?php
                                                if ($discount_exist > 0) {
                                              ?>
                                                <th style="text-align: right;"><?= number_format($data[0]->sales_debit_note_discount_amount, 2) ?></th>
                                          <?php } ?>
                                          <?php
                                                    if ($discount_exist > 0 && ($tax_exist > 0 || $igst_exist > 0 || $cgst_exist > 0 || $sgst_exist > 0 )) {
                                              ?>
                                                        <th style="text-align: right;"><?= number_format($data[0]->sales_debit_note_taxable_value, 2) ?></th>
                                          <?php } ?>
                                          <?php
                                                    if ($tds_exist > 0) {
                                              ?>
                                                        <th style="text-align: right;"><?= number_format(($data[0]->sales_debit_note_tcs_amount), 2); ?></th>
                                          <?php }
                                          ?>
                                          <?php
                                                    if ($tax_exist > 0) {
                                              ?>
                                                        <th style="text-align: right;"><?= number_format($data[0]->sales_debit_note_tax_amount, 2) ?></th>
                                              <?php
                                                    } elseif ($igst_exist > 0) {
                                              ?>
                                                        <th style="text-align: right;"><?= number_format($data[0]->sales_debit_note_igst_amount, 2) ?></th>
                                              <?php
                                                    } elseif ($cgst_exist > 0 || $sgst_exist > 0) {
                                              ?>
                                                        <th style="text-align: right;"><?= number_format($data[0]->sales_debit_note_cgst_amount, 2) ?></th>
                                                        <th style="text-align: right;"><?= number_format($data[0]->sales_debit_note_sgst_amount, 2) ?></th>
                                          <?php }
                                          ?>
                                          <?php if ($cess_exist > 0) { ?>
                                                        <th style="text-align: right;"><?= precise_amount(($data[0]->sales_debit_note_tax_cess_amount )) ?></th>
                                                    <?php } ?>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if ($cess_exist > 0) { ?>
                                            <tr>
                                                ...
                                                <td style="color: red;">( + ) <?= precise_amount($data[0]->sales_debit_note_tax_cess_amount); ?></td>
                                            </tr>
                                        <?php } ?>
                                        <?php
                                    ...
                                    <div class="buttons">
                                        <div class="btn-group btn-group-justified">
                                            ...
                                            if (in_array($sales_debit_note_module_id, $active_view)) {
                                                ?>
                                                <div class="btn-group">
                                                    <a class="tip btn btn-success pdf_button" data-backdrop="static" data-keyboard="false" href1="<?= base_url('sales_debit_note/pdf/') . $sales_debit_note_id; ?>" data-toggle="modal"  class="btn btn-app pdf_button" b_curr="<?= $currency_id; ?>"  b_code="<?= $currency_code; ?>" c_code="<?= $cust_currency_code ?>" c_curr="<?= $data[0]->currency_id; ?>" data-id="<?php echo $sales_debit_note_id; ?>" data-name="regular" data-target="#pdf_type_modal" href="#" title="Download PDF" title="Download as PDF" >
                                            ...
                                            if (in_array($sales_debit_note_module_id, $active_edit)) {
                                            ?>
                                            <div class="btn-group">
                                                <a class="tip btn btn-success" href="<?php echo base_url('sales_debit_note/edit/'); ?><?php echo $sales_debit_note_id; ?>" title="Edit" >
