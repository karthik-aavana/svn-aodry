    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Edit Purchase Debit Note</li>
            </ol>
        </h5>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Purchase Debit Note</h3>
                        <a class="btn btn-sm btn-default pull-right back_button" href1="<?php echo base_url('purchase_debit_note'); ?>">Back </a>
                    </div>
                    <form role="form" id="form" method="post" action="<?php echo base_url('purchase_debit_note/edit_purchase_debit_note'); ?>">
                        <div class="box-body">
                            <input type="hidden" name="purchase_debit_note_id" value="<?= $data[0]->purchase_debit_note_id ?>">
                            <div class="row">
                                <input type="hidden" name="purchase_debit_note_id" value="<?= $data[0]->purchase_debit_note_id ?>">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">              
                                            <input type="text" style="background: #fff;" class="form-control datepicker" id="invoice_date" name="invoice_date" value="<?php echo date('d-m-Y',strtotime($data[0]->purchase_debit_note_date)); ?>">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="invoice_number" name="invoice_number" value="<?= $data[0]->purchase_debit_note_invoice_number ?>" <?= ($access_settings[0]->invoice_readonly == 'yes' ? "readonly" : ''); ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" autofocus="on" id="supplier" name="supplier">
                                            ...
                                            foreach ($supplier as $row) {
                                                ...
                                                if ($data[0]->purchase_debit_note_party_type == 'supplier' && $data[0]->purchase_debit_note_party_id == $row->supplier_id) {
                                ...
                                <div class="col-sm-3 disable_div">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2"  id="nature_of_supply" name="nature_of_supply">
                                            <option value="product" <?= ($data[0]->purchase_debit_note_nature_of_supply == "product" ? 'selected' : '') ?>>Product</option>
                                            <option value="service" <?= ($data[0]->purchase_debit_note_nature_of_supply == "service" ? 'selected' : '') ?>>Service</option>
                                            <option value="both" <?= ($data[0]->purchase_debit_note_nature_of_supply != "product" && $data[0]->purchase_debit_note_nature_of_supply != "service" ? 'selected' : '') ?>>Both</option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="billing_country" name="billing_country" >
                                            ...
                                            <?php foreach ($country as $key) { ?>
                                                ...
                                                if ($key->country_id == $data[0]->purchase_debit_note_billing_country_id) {
                                                    echo "selected";
                                                }
                                                ?>>
                                ...
                                <div class="col-sm-3 disable_div">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="billing_state" name="billing_state">
                                            <?php
                                            if ($data[0]->purchase_debit_note_billing_country_id == $branch[0]->branch_country_id) {

                                                foreach ($state as $key) {
                                                    ?>
                                                    <option value='<?= $key->state_id ?>' <?= ($key->state_id == $data[0]->purchase_debit_note_billing_state_id ? "selected" : ''); ?> utgst='<?= $key->is_utgst; ?>'><?= $key->state_name; ?>
                                                    </option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                            <option value="0" <?= ($data[0]->purchase_debit_note_billing_state_id == '0' ? 'selected' : '') ?>>Out of Country</option>
                                        </select>
                                ...
                                <div class="col-sm-3 disable_div">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" id="type_of_supply" name="type_of_supply">
                                            <?php if ($data[0]->purchase_debit_note_type_of_supply == 'inter_state' || $data[0]->purchase_debit_note_type_of_supply == 'intra_state') { ?>
                                                <option value="inter_state" <?= ($data[0]->purchase_debit_note_type_of_supply == 'inter_state' ? "selected" : ''); ?>>Regular(Inter State)</option>
                                                <option value="intra_state" <?= ($data[0]->purchase_debit_note_type_of_supply == 'intra_state' ? "selected" : ''); ?>>Regular(Intra State)</option>
                                            <?php } else {
                                                ?>
                            ...
                            <div class="row">
                                <div class="col-sm-3 gst_payable_div" style="<?= ($data[0]->purchase_debit_note_type_of_supply == 'import' ? "display:none;" : ''); ?>">
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline p_l_20">
                                            <input class="" type="radio" name="gst_payable" value="yes" <?= ($data[0]->purchase_debit_note_gst_payable == "yes" ? 'checked="checked"' : ''); ?> /> Yes
                                        </label>
                                        <label class="radio-inline p_l_20">
                                            <input class="" type="radio" name="gst_payable" value="no" <?= ($data[0]->purchase_debit_note_gst_payable == "no" ? 'checked="checked"' : ''); ?> /> No
                                        </label>
                                        <br/>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="supplier_debit_note_no" name="supplier_debit_note_no" value="<?= $data[0]->purchase_supplier_debit_note_number; ?>">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" class="form-control datepicker" id="invoice_date" name="purchase_supplier_debit_note_date" value="<?= $data[0]->purchase_supplier_debit_note_date; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 mt-15">                                                       
                                    <div class="box-header with-border">
                                        ...
                                        <table class="table table-striped table-bordered table-condensed table-hover purchase_table table-responsive" name="purchase_data" id="purchase_debit_note_data">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody id="purchase_debit_note_table_body">
                                                ...
                                                foreach ($items as $key) {
                                                    ...
                                                    <tr id="<?= $i ?>">
                                                        ...
                                                        if ($access_settings[0]->description_visible == 'yes') {
                                                            ?>
                                                            <td><input type='text' name='item_description' class='form-control form-fixer' value="<?php echo $key->purchase_debit_note_item_description ?>"></td>
                                                        <?php } ?>
                                                        <td><input type="text" class="float_number form-control form-fixer text-center" value="<?php echo $key->purchase_debit_note_item_quantity ?>" data-rule="quantity" name='item_quantity' limit='<?= $key->purchase_debit_note_item_quantity; ?>'>
                                                        </td>
                                                        <!-- <td>
                                                            <input type='text' class='float_number form-control form-fixer text-right' name='item_price' value='<?php echo precise_amount($key->purchase_debit_note_item_unit_price); ?>' limit='<?php echo precise_amount($key->purchase_debit_note_item_unit_price); ?>'>
                                                            <span id='item_sub_total_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?php echo precise_amount($key->purchase_debit_note_item_sub_total); ?></span>
                                                            <input type='hidden' class='form-control' style='' value='<?php echo $key->purchase_debit_note_item_sub_total ?>' name='item_sub_total' readonly>
                                                        </td>
                                                        <?php
                                                        if ($access_settings[0]->discount_visible == 'yes') {
                                                            ?>
                                                            ...
                                                            foreach ($discount as $key3 => $value3) {
                                                                $dis_amount = ($key->purchase_debit_note_item_sub_total * $value3->discount_value / 100);
                                                                $selected = '';
                                                                if ($dis_amount >= $key->purchase_debit_note_item_discount_amount) {
                                                                    if ($value3->discount_id == $key->purchase_debit_note_item_discount_id)
                                                                        $selected = 'selected';
                                                            ...
                                                            ?>
                                                                                            ...
                                                                                            <span id='item_discount_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= ($key->purchase_debit_note_item_discount_amount ? precise_amount($key->purchase_debit_note_item_discount_amount) : 0); ?></span>
                                                                                        </div>
                                                                                        
                                                                                        <input type='hidden' name='item_discount_id' value='<?php
                                                            echo $key->purchase_debit_note_item_discount_id ? $key->purchase_debit_note_item_discount_id : 0;
                                                            ?>'>
                                                                                        <input type='hidden' name='item_discount_percentage' value='0'>
                                                                                        <input type='hidden' name='item_discount_amount' value='<?php
                                                            echo $key->purchase_debit_note_item_discount_amount ? $key->purchase_debit_note_item_discount_amount : 0;
                                                            ?>'>
                                                                                                                               
                                                                                    </td>
                                                        <?php } ?> -->
                                                        <td align='right'>
                                                            <input type='hidden' class='float_number form-control form-fixer text-right' name='item_price' value='<?php echo precise_amount($key->purchase_debit_note_item_unit_price); ?>' limit='<?php echo precise_amount($key->purchase_debit_note_item_unit_price); ?>'>
                                                            <input type='hidden' class='form-control' style='' value='<?php echo $key->purchase_debit_note_item_sub_total ?>' name='item_sub_total' readonly>
                                                            <input type='hidden' name='item_discount_id' value='<?php
                                                            echo $key->purchase_debit_note_item_discount_id ? $key->purchase_debit_note_item_discount_id : 0;
                                                            ?>'>
                                                            ...
                                                            echo $key->purchase_debit_note_item_discount_amount ? $key->purchase_debit_note_item_discount_amount : 0;
                                                            ?>'>
                                                            <input type='text' class='float_number form-control form-fixer text-right' name='item_taxable_value' value='<?= precise_amount($key->purchase_debit_note_item_taxable_value ? $key->purchase_debit_note_item_taxable_value : 0); ?>' limit='<?= precise_amount($key->purchase_debit_note_item_taxable_value ? $key->purchase_debit_note_item_taxable_value : 0); ?>'>
                                                            <!-- <span id='item_taxable_value_lbl_<?= $i ?>'><?= $key->purchase_debit_note_item_taxable_value ? precise_amount($key->purchase_debit_note_item_taxable_value) : 0; ?></span> -->
                                                        </td>
                                                        ...
                                                        <?php if ($access_settings[0]->tds_visible == 'yes') { ?>
                                                            <td style='text-align:center'>
                                                                ...
                                                                if ($key->tds_module_type == "" || $key->tds_module_type == null) {
                                                                    $input_type = "hidden";
                                                                    ?>
                                                                                            <!-- <span id='item_tds_percentage_hide_lbl_<?= $i ?>' class='text-center' ><?= $key->purchase_debit_note_item_tds_percentage ? precise_amount($key->purchase_debit_note_item_tds_percentage) : 0 ?></span> -->
                                                                    <?php
                                                                    /* echo "<br/>"; */
                                                                } else {
                                                                    $input_type = "text";
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            foreach ($tax as $key3 => $value3) {
                                                                                if (($key->item_type == 'service' && $value3->tax_name == 'TDS') || ($value3->tax_name == 'TCS' && $key->item_type == 'product')) {
                                                                                    if ($value3->tax_value <= $key->purchase_debit_note_item_tds_percentage) {

                                                                                        if ($value3->tax_id == $key->purchase_debit_note_item_tds_id) {
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td><div class="radio">
                                                                                                    <label><input type="radio" name="tds_tax" value="<?= (float)($value3->tax_value); ?> "<?= ($value3->tax_id == $key->purchase_debit_note_item_tds_id ? 'selected' : '' ) ?> tds_id='<?= $value3->tax_id ?>' typ='<?= $value3->tax_name ?>'></label>
                                                                                                </div>
                                                                                            </td>
                                                                                        </tr>
                                                                                        <?php
                                                                ...
                                                                <input type='hidden' name='item_tds_id' value='<?= $key->purchase_debit_note_item_tds_id ? $key->purchase_debit_note_item_tds_id : 0 ?>'><input type='hidden' name='item_tds_type' value='<?= $key->tds_module_type ? $key->tds_module_type : '' ?>'>
                                                                <input type='hidden' name='item_tds_amount' value='<?= $key->purchase_debit_note_item_tds_amount ? precise_amount($key->purchase_debit_note_item_tds_amount) : 0 ?>'><span id='item_tds_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= $key->purchase_debit_note_item_tds_amount ? precise_amount($key->purchase_debit_note_item_tds_amount) : 0 ?></span>
                                                            </td>
                                                        <?php } ?>
                                                        <?php if ($access_settings[0]->tax_type == 'gst' || $access_settings[0]->tax_type == 'single_tax') { ?>
                                                            <td><input type='hidden' name='item_tax_id' value='<?= $key->purchase_debit_note_item_tax_id ? $key->purchase_debit_note_item_tax_id : 0 ?>'>
                                                                <input type='hidden' name='item_tax_percentage' value='<?= $key->purchase_debit_note_item_tax_percentage ? precise_amount($key->purchase_debit_note_item_tax_percentage) : 0 ?>'>
                                                                ...
                                                                <input type='hidden' name='item_tax_amount' value='<?= $key->purchase_debit_note_item_tax_amount ? precise_amount($key->purchase_debit_note_item_tax_amount) : 0 ?>'>
                                                                    ...
                                                                    <select class="form-control open_tax form-fixer select2" name="item_tax">
                                                                        ...
                                                                        foreach ($tax as $key3 => $value3) {
                                                                            if ($value3->tax_name == 'GST') {
                                                                                if ($value3->tax_value <= $key->purchase_debit_note_item_tax_percentage) {
                                                                                    echo "<option value='" . $value3->tax_id . "-" . ($value3->tax_value) . "' " . ($value3->tax_id == $key->purchase_debit_note_item_tax_id ? 'selected' : '' ) . " " . $key->purchase_debit_note_item_tax_id . ">" . (float) ($value3->tax_value) . "%</option>";
                                                                                }
                                                                            }
                                                                        }
                                                                        ?>
                                                                ...
                                                                <span id='item_tax_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= $key->purchase_debit_note_item_tax_amount ? precise_amount($key->purchase_debit_note_item_tax_amount) : 0 ?></span>
                                                            </td>
                                                            <td><input type='hidden' name='item_tax_cess_id' value='<?= ($key->purchase_debit_note_item_tax_cess_id ? $key->purchase_debit_note_item_tax_cess_id : 0); ?>'>
                                                                <input type='hidden' name='item_tax_cess_percentage' value='<?= $key->purchase_debit_note_item_tax_cess_percentage ? (float)($key->purchase_debit_note_item_tax_cess_percentage) : 0; ?>'>
                                                                <input type='hidden' name='item_tax_cess_amount' value='<?= $key->purchase_debit_note_item_tax_cess_amount ? precise_amount($key->purchase_debit_note_item_tax_cess_amount) : 0 ?>'>
                                                                <div class="form-group" style="margin-bottom:0px !important;">
                                                                    <select class="form-control open_tax form-fixer select2" name="item_tax_cess" <?= $key->purchase_debit_note_item_tax_cess_id; ?>>
                                                                        <option value="">Select</option>
                                                                        <?php
                                                                        foreach ($tax as $key3 => $value3) {
                                                                            if ($value3->tax_name == 'CESS') {
                                                                                if ($value3->tax_value <= $key->purchase_debit_note_item_tax_cess_percentage) {
                                                                                    echo "<option value='" . $value3->tax_id . "-" . ($value3->tax_value) . "' " . ($value3->tax_id == $key->purchase_debit_note_item_tax_cess_id ? 'selected' : '' ) . ">" . (float) ($value3->tax_value) . "%</option>";
                                                                                }
                                                                            }
                                                                        }
                                                                        ?>
                                                                ...
                                                                <span id='item_tax_cess_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= $key->purchase_debit_note_item_tax_cess_amount ? precise_amount($key->purchase_debit_note_item_tax_cess_amount) : 0 ?></span>
                                                            </td>
                                                        <?php } ?>
                                                        <td align="right">
                                                            <input type="text" class="float_number form-control form-fixer text-right" name="item_grand_total" value="<?php echo precise_amount($key->purchase_debit_note_item_grand_total); ?>" limit="<?php echo precise_amount($key->purchase_debit_note_item_grand_total); ?>">
                                                        </td>
                                                        <?php
                                                        $temp = array(
                                                            "item_id" => $key->item_id,
                                                            "item_type" => $key->item_type,
                                                            "item_igst" => $key->purchase_debit_note_item_igst_percentage,
                                                            "item_cgst" => $key->purchase_debit_note_item_cgst_percentage,
                                                            "item_sgst" => $key->purchase_debit_note_item_sgst_percentage
                                                        );
                                                    ...
                                                    $purchase_data[$i]['item_price'] = $key->purchase_debit_note_item_unit_price;
                                                    $purchase_data[$i]['item_key_value'] = $i;
                                                    $purchase_data[$i]['item_sub_total'] = $key->purchase_debit_note_item_sub_total;
                                                    $purchase_data[$i]['item_description'] = $key->purchase_debit_note_item_description;
                                                    $purchase_data[$i]['item_quantity'] = $key->purchase_debit_note_item_quantity;
                                                    $purchase_data[$i]['item_discount_amount'] = (@$key->purchase_debit_note_item_discount_amount ? $key->purchase_debit_note_item_discount_amount : 0);
                                                    $purchase_data[$i]['item_discount_value'] = (@$key->purchase_debit_note_item_discount_value ? $key->purchase_debit_note_item_discount_value : 0);
                                                    $purchase_data[$i]['item_discount'] = $key->purchase_debit_note_item_discount_id;
                                                    $purchase_data[$i]['item_discount_id'] = $key->purchase_debit_note_item_discount_id;
                                                    $purchase_data[$i]['item_igst'] = $key->purchase_debit_note_item_igst_percentage;
                                                    $purchase_data[$i]['item_igst_amount'] = $key->purchase_debit_note_item_igst_amount;
                                                    $purchase_data[$i]['item_cgst'] = $key->purchase_debit_note_item_cgst_percentage;
                                                    $purchase_data[$i]['item_cgst_amount'] = $key->purchase_debit_note_item_cgst_amount;
                                                    $purchase_data[$i]['item_sgst'] = $key->purchase_debit_note_item_sgst_percentage;
                                                    $purchase_data[$i]['item_sgst_amount'] = $key->purchase_debit_note_item_sgst_amount;
                                                    $purchase_data[$i]['item_tds_percentage'] = $key->purchase_debit_note_item_tds_percentage;
                                                    $purchase_data[$i]['item_tds_id'] = $key->purchase_debit_note_item_tds_id;
                                                    $purchase_data[$i]['item_tds_amount'] = $key->purchase_debit_note_item_tds_amount;
                                                    $purchase_data[$i]['item_tax_cess_percentage'] = $key->purchase_debit_note_item_tax_cess_percentage;
                                                    $purchase_data[$i]['item_tax_cess_amount'] = $key->purchase_debit_note_item_tax_cess_amount;
                                                    $purchase_data[$i]['item_tax_cess_id'] = $key->purchase_debit_note_item_tax_cess_id;
                                                    $purchase_data[$i]['item_tax_percentage'] = $key->purchase_debit_note_item_tax_percentage;
                                                    $purchase_data[$i]['item_tax_amount'] = $key->purchase_debit_note_item_tax_amount;
                                                    $purchase_data[$i]['item_tax_id'] = $key->purchase_debit_note_item_tax_id;
                                                    $purchase_data[$i]['item_taxable_value'] = $key->purchase_debit_note_item_taxable_value;
                                                    $purchase_data[$i]['item_grand_total'] = $key->purchase_debit_note_item_grand_total;
                                        ...
                                        <!-- Hidden Field -->
                                        <input type="hidden" class="form-control" id="section_area" name="section_area" value="edit_purchase_debit_note" readonly>
                                        ...
                                        <input type="hidden" class="form-control" id="invoice_number_old" name="invoice_number_old" value="<?= $data[0]->purchase_debit_note_invoice_number ?>" readonly>
                                        <input type="hidden" name="total_sub_total" id="total_sub_total" value="<?= $data[0]->purchase_debit_note_sub_total; ?>">
                                        <input type="hidden" name="total_taxable_amount" id="total_taxable_amount" value="<?= $data[0]->purchase_debit_note_taxable_value; ?>">
                                        <input type="hidden" name="total_discount_amount" id="total_discount_amount" value="<?= $data[0]->purchase_debit_note_discount_amount; ?>">
                                        <input type="hidden" name="total_tax_amount" id="total_tax_amount" value="<?= $data[0]->purchase_debit_note_tax_amount; ?>">
                                        <input type="hidden" name="total_igst_amount" id="total_igst_amount" value="<?= $data[0]->purchase_debit_note_igst_amount; ?>">
                                        <input type="hidden" name="total_cgst_amount" id="total_cgst_amount" value="<?= $data[0]->purchase_debit_note_cgst_amount; ?>">
                                        <input type="hidden" name="total_sgst_amount" id="total_sgst_amount" value="<?= $data[0]->purchase_debit_note_sgst_amount; ?>">
                                        <input type="hidden" name="total_tax_cess_amount" id="total_tax_cess_amount" value="<?= $data[0]->purchase_debit_note_tax_cess_amount; ?>">
                                        <input type="hidden" name="total_tds_amount" id="total_tds_amount" value="<?= $data[0]->purchase_debit_note_tds_amount; ?>">
                                        <input type="hidden" name="total_tcs_amount" id="total_tcs_amount" value="<?= $data[0]->purchase_debit_note_tcs_amount; ?>">
                                        <input type="hidden" name="without_reound_off_grand_total" id="without_reound_off_grand_total" value="<?= $data[0]->purchase_debit_note_grand_total + $data[0]->round_off_amount; ?>">
                                        <input type="hidden" name="total_grand_total" id="total_grand_total" value="<?= $data[0]->purchase_debit_note_grand_total; ?>">
                                        ...
                                        <table id="table-total" class="table table-striped table-bordered table-condensed table-hover table-responsive">
                                            <tr>
                                                ...
                                                <td align='right'><span id="totalSubTotal"><?php echo precise_amount($data[0]->purchase_debit_note_sub_total); ?></span></td>
                                            </tr>
                                            <tr <?= ($data[0]->purchase_debit_note_discount_amount <= 0 ? 'style="display: none;"' : '' ); ?> class='totalDiscountAmount_tr'>
                                                <td align="right">Total Discount (-)</td>
                                                <td align='right'><span id="totalDiscountAmount"><?php echo precise_amount($data[0]->purchase_debit_note_discount_amount); ?></span>
                                                </td>
                                            </tr>
                                            <tr <?= ($igst_exist <= 0 ? 'style="display: none;"' : ''); ?> class='totalIGSTAmount_tr'>
                                                <td align="right">IGST (+)</td>
                                                <td align='right'><span id="totalIGSTAmount"><?= ($igst_exist > 0 ? precise_amount($data[0]->purchase_debit_note_igst_amount) : ''); ?></span>
                                                </td>
                                            </tr>
                                            <tr <?= ($cgst_exist <= 0 ? 'style="display: none;"' : ''); ?> class='totalCGSTAmount_tr'>
                                                <td align="right">CGST (+)</td>
                                                <td align='right'><span id="totalCGSTAmount"><?= ($cgst_exist > 0 ? precise_amount($data[0]->purchase_debit_note_cgst_amount) : ''); ?></span>
                                                </td>
                                            </tr>
                                            <tr <?= ($sgst_exist <= 0 ? 'style="display: none;"' : ''); ?> class='totalSGSTAmount_tr'>
                                                <td align="right"><?= ($is_utgst == '1' ? 'UTGST' : 'SGST') ?> (+)</td>
                                                <td align='right'><span id="totalSGSTAmount"><?= ($sgst_exist > 0 ? precise_amount($data[0]->purchase_debit_note_sgst_amount) : ''); ?></span>
                                                </td>
                                            </tr>
                                            <tr <?= ($cess_exist <= 0 ? 'style="display: none;"' : ''); ?> class='totalCessAmount_tr'>
                                                <td align="right">Cess (+)</td>
                                                <td align='right'><span id="totalTaxCessAmount"><?= ($cess_exist > 0 ? precise_amount($data[0]->purchase_debit_note_tax_cess_amount) : ''); ?></span>
                                                </td>
                                            </tr>
                                            <tr <?= ($tds_exist != 1 || $data[0]->purchase_debit_note_tds_amount <= 0 ? 'style="display: none;"' : ''); ?> class='tds_amount_tr'>
                                                <td align="right"><?php echo 'TDS Amount'; ?></td>
                                                <td align='right'>
                                                    <span id="totalTdsAmount"><?= precise_amount($data[0]->purchase_debit_note_tds_amount); ?></span>
                                                </td>
                                            </tr>
                                            <tr <?= ($tds_exist != 1 || $data[0]->purchase_debit_note_tcs_amount <= 0 ? 'style="display: none;"' : ''); ?> class='tcs_amount_tr'>
                                                <td align="right"><?php echo 'TCS Amount'; ?> (+)</td>
                                                <td align='right'>
                                                    <span id="totalTcsAmount"><?= precise_amount($data[0]->purchase_debit_note_tcs_amount); ?></span>
                                                </td>
                                            </tr>                                        
                                            ...
                                            if ($data[0]->round_off_amount > 0 || $data[0]->round_off_amount < 0) {
                                                $checked = "checked";
                                                $grand_total = precise_amount($data[0]->purchase_debit_note_grand_total + $data[0]->round_off_amount);
                                            ...
                                            <tr>
                                                ...
                                                <td align='right'><span id="totalGrandTotal"><?php echo precise_amount($data[0]->purchase_debit_note_grand_total); ?></span></td>
                                            </tr>
                                        </table>
                                    </div> </div>
                                <div class="col-sm-12">
                                    <div class="box-footer">
                                        <button type="submit" id="purchase_debit_note_submit" name="purchase_submit" class="btn btn-info">Update</button>
                                        <span class="btn btn-default" id="sale_cancel" onclick="cancel('purchase_debit_note')">Cancel</span>
                                    </div>
                                </div>
                            </div>
                            <?php
