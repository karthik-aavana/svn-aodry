            ...
            <table width="100%" cellspacing="0" border-collapse="collapse" class="table header_table" style="margin-top:20px 0px;border:none!important">
                ...
                if ($pdf_results['theme'] == 'default')
                {
                    ...
                    <tr style="text-align: center;">
                        <td style="text-align: center;font-size: 20px">Purchase Order</td>
                    </tr>
                    <?php
                }
                ?>
                ...
                if ($pdf_results['theme'] == 'custom')
                {
                    ...
                    <tr style="text-align: center;background-color: <?= $pdf_results['background']; ?>;border:none!important">
                        <td style="text-align: center;font-size: 20px;" class="white-text">Purchase Order</td>
                    </tr>
                    <?php
                }
                ?>
        ...
        <table width="100%" cellspacing="0" border-collapse="collapse" class="table header_table" style="margin-top:20px">
            <tr>
                ...
                <!-- <td valign="top" width="22%">
                        Type of Supply<br>
                    <p style="font-weight:bold"><?php
                if (isset($data[0]->purchase_order_type_of_supply))
                {
                    $type_of_supply = ucfirst($data[0]->purchase_order_type_of_supply);
                ...
                foreach ($items as $value)
                {
                    ...
                    <tr>
                       <!--  <td align="center"><?php echo $i; ?></td> -->
                        ...
                        {
                            ?>
                            <td><?php echo $value->product_name; ?><br>HSN/SAC: <?php echo " " . $value->product_hsn_sac_code; ?><br><?php echo " " . $value->purchase_order_item_description; ?></td>
                        <?php
                        }
                        else
                        {
                            ?>
                            <td><?php echo $value->service_name; ?><br>HSN/SAC: <?php echo " " . $value->service_hsn_sac_code; ?><br><?php echo " " . $value->purchase_order_item_description; ?></td>
                            <?php } ?>
...
if ($dtcount > 0)
{
    ?>
                    ...
                    <?php if ($data[0]->purchase_order_igst_amount < 1 && $data[0]->purchase_order_cgst_amount > 1)
                    {
                        ?>
...
else if ($data[0]->purchase_order_igst_amount > 1 && $data[0]->purchase_order_cgst_amount < 1)
{
    ?>
