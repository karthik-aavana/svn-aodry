                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date">
                                                        <input type="text" class="form-control datepicker" id="invoice_date" name="invoice_date" value="<?php echo $data[0]->purchase_order_date; ?>">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="invoice_number" name="invoice_number" value="<?php echo $data[0]->purchase_order_invoice_number ?>" <?php
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <!-- <select class="form-control select2" id="nature_of_supply" name="nature_of_supply">
                                                        ...
                                                        <option value="service" <?php
                                                            if ($data[0]->purchase_order_nature_of_supply == "service")
                                                            {
                                                            echo 'selected="selected"';
                                                            }
                                                        ?>>Service</option>
                                                        <option value="both" <?php
                                                            if ($data[0]->purchase_order_nature_of_supply == "both")
                                                            {
                                                            echo 'selected="selected"';
                                                            }
                                                        ?>>Both</option>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" id="billing_state" name="billing_state">
                                                        ...
                                                        {
                                                        ?>
                                                        <option value="<?= $value->state_id ?>" <?php if ($value->state_id == $data[0]->purchase_order_billing_state_id) echo "selected='selected'"; ?> ><?= $value->state_name ?></option>
                                                        <?php } ?>
                                                        <?php
                                                        }
                                                        else
...
?>
            ...
            <input type='hidden' name='item_tds_id' value='<?= $key->purchase_order_item_tds_id ? $key->purchase_order_item_tds_id : 0 ?>'><input type='hidden' name='item_tds_type' value='<?= $key->tds_module_type ? $key->tds_module_type : '' ?>'><input type='<?= $input_type ?>' class='form-control form-fixer text-center float_number' name='item_tds_percentage' value='<?= $key->purchase_order_item_tds_percentage ? $key->purchase_order_item_tds_percentage : 0 ?>'><input type='hidden' name='item_tds_amount' value='<?= $key->purchase_order_item_tds_amount ? $key->purchase_order_item_tds_amount : 0 ?>'><span id='item_tds_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= $key->purchase_order_item_tds_amount ? $key->purchase_order_item_tds_amount : 0 ?></span></td>
                                        ...
                                        echo $data[0]->purchase_order_date;
                                        ?>" readonly>
                                        <input type="hidden" class="form-control" id="module_id" name="module_id" value="<?= $purchase_order_module_id ?>" readonly>
