...
<html>
    ...
    <body>
            ...
            <table width="100%" cellspacing="0" border-collapse="collapse" class="table header_table" style="margin-top:20px 0px;border:none!important">
                ...
                if ($pdf_results['theme'] == 'custom')
                {
                    ...
                    <tr style="text-align: center;background-color: <?= $pdf_results['background']; ?>;border:none!important">
                        <td style="text-align: center;font-size: 20px;" class="white-text">Quotation</td>
                    </tr>
                    <?php
                }
                ?>
        ...
        <table width="100%" class="table" style="border:none!important;margin-top: 20px">
            ...
            <tr style="border: 0px;">
                <td style="border: 0px;text-align: right;">(<?php echo "ORIGINAL FOR RECIPIENT"
                    ?>)</td>
            ...
            <tr>
                ...
                if ($pdf_results['l_r'] != 'yes' && $pdf_results['display_affliate'] == 'yes')
                {
                    ...
                    <td  width="50%" valign="top" style="text-align: center;border:<?php echo ($pdf_results['bordered'] == 'yes') ? '' : 'none'; ?>;">
                        <img width="200" style="margin-top: 50px" src="<?= base_url('assets/affiliate/' . $sid . '/' . $arr[0]) ?>">
                    </td>
                    <?php
                }
                ?>
        ...
        <table width="100%" cellspacing="0" border-collapse="collapse" class="table header_table" style="margin-top:20px">
            <tr>
                ...
                <!-- <td valign="top" width="22%">
                        Type of Supply<br>
                    <p style="font-weight:bold"><?php
                if (isset($data[0]->quotation_type_of_supply))
                {
                    $type_of_supply = ucfirst($data[0]->quotation_type_of_supply);
        ...
        <table width="100%" cellspacing="0" border-collapse="collapse" class="table"  style="margin-top: 20px;">
            <thead>
                        ...
                        <!--  <?php if ($dpcount > 0)
                {
                        ...
                        {
                            ?>
                            <th rowspan="2" class="white-text">Disc<br />Amt</th>
                        <?php } ?>
    ...
    {
        ?>
                            <th background-color: <?= $pdf_results['background']; ?> class="white-text">
                                Rate %
                            </th>
                            <th background-color: <?= $pdf_results['background']; ?> class="white-text">
                                Amt
    ...
    else if ($igst_tax > 1 && $cgst_tax < 1)
    {
        ?>
                            ...
                            <th style="background-color: <?= $pdf_results['background']; ?>" class="white-text">
                                Rate %
                            </th>
                            <th style="background-color: <?= $pdf_results['background']; ?>" class="white-text">
                                Amt
    ...
    else if ($data[0]->quotation_billing_state_id == $branch[0]->branch_state_id)
    {
        ?>
                            <th class="white-text"  style="background-color: <?= $pdf_results['background']; ?>">
                                Rate %
                            </th>
                            <th class="white-text"  style="background-color: <?= $pdf_results['background']; ?>" >
                                Amt
...
else
{
    ?>
                    <tr>
                        ...
                        <th class="white-text">Item  Description</th>
                        <!--  <?php if ($dpcount > 0)
                    {
        ?>
                                     <th>Description</th>
                        ...
                        <th class="white-text">Rate</th>
                        <th class="white-text">Sub <br/> Total</th>
    <?php if ($dtcount > 0)
    {
        ?>
                            <th class="white-text">Disc<br />Amt</th>
                    <?php } ?>
                ...
                foreach ($items as $value)
                {
                    ...
                    <tr>
                       <!--  <td align="center"><?php echo $i; ?></td> -->
                        ...
                        {
                            ?>
                            <td><?php echo $value->product_name; ?><br>HSN/SAC: <?php echo " " . $value->product_hsn_sac_code; ?><br><?php echo " " . $value->quotation_item_description; ?></td>
                        <?php
                        }
                        else
                        {
                            ?>
                            <td><?php echo $value->service_name; ?><br>HSN/SAC: <?php echo " " . $value->service_hsn_sac_code; ?><br><?php echo " " . $value->quotation_item_description; ?></td>
                            <?php } ?>

                        <!--  <?php if ($dpcount > 0)
                        {
                                ?>
                                     <td><?php echo $value->quotation_item_description; ?></td>
                        <?php } ?> -->
                        <?php
                        if ($pdf_results['quantity'] == 'yes')
                        {
                        ...
                        {
                            ?>
                            <td align="right"><?php echo $value->quotation_item_unit_price; ?></td>
                            <?php
                        }
                        if ($pdf_results['sub_total'] == 'yes')
                        {
                            ?>
                            <td align="right"><?php echo $value->quotation_item_sub_total; ?></td>
                            <?php
                        }
                        ?>
                        <?php if ($dtcount > 0)
                        {
                            ?>
                            <td align="right"><?php echo $value->quotation_item_discount_amount; ?></td>
    <?php } ?>
    ...
    <?php if ($igst_tax < 1 && $cgst_tax > 1)
    {
        ?>
                            ...
                            {
                                ?>
                                <td align="right"><?php echo $value->quotation_item_taxable_value; ?></td>
                                <?php
                            }
                            ?>
                            <td align="center"><?php echo $value->quotation_item_cgst_percentage; ?></td>
                            <td align="right"><?php echo $value->quotation_item_cgst_amount; ?></td>
                            <td align="center"><?php echo $value->quotation_item_sgst_percentage; ?></td>
                            <td align="right"><?php echo $value->quotation_item_sgst_amount; ?></td>
                        ...
                        ?>
                            <td align="center"><?php echo $value->quotation_item_igst_percentage; ?></td>
                            <td align="right"><?php echo $value->quotation_item_igst_amount; ?></td>
                    ...
                    ?>
                        <td align="right"><?php echo $value->quotation_item_grand_total ?></td>
                    </tr>
                        <?php
                        $i++;
                        $quantity = bcadd($quantity, $value->quotation_item_quantity, 2);
                        ...
                        // $igst = bcadd($igst, $value->quotation_item_igst_amount, 2);
                        // $cgst = bcadd($cgst, $value->quotation_item_cgst_amount, 2);
                        // $sgst = bcadd($sgst, $value->quotation_item_sgst_amount, 2);
...
if ($pdf_results['price'] == 'yes')
{
    ?>
                    ...
                    {
                        ?>
                        <th align="right"><?php echo $data[0]->quotation_sub_total; ?></th>
    <?php
}
if ($dtcount > 0)
{
    ?>
                        <th><?php echo $data[0]->quotation_discount_value; ?></th>

                        <?php
                    }
                    ?>

                    <?php if ($data[0]->quotation_igst_amount < 1 && $data[0]->quotation_cgst_amount > 1)
                    {
                        ?>
                        <th align="right"><?php echo $data[0]->quotation_taxable_value; ?></th>

                        <th align="right" colspan="2"><?php echo bcdiv($data[0]->quotation_tax_amount, 2, 2); ?></th>

                        <th align="right" colspan="2"><?php echo bcdiv($data[0]->quotation_tax_amount, 2, 2); ?></th>

<?php
}
else if ($data[0]->quotation_igst_amount > 1 && $data[0]->quotation_cgst_amount < 1)
{
    ?>
                ...
                ?>
                        <th align="right" colspan="2"><?php echo $data[0]->quotation_tax_amount; ?></th>
...
?>
        ...
        <table width="100%" cellspacing="0" border-collapse="collapse" class="table" style="margin-top: 30px;">
            ...
            <tr>
                ...
                <td align="right" class="footerpad fontH"><b><?php echo $data[0]->quotation_grand_total; ?> /-</td>
            </tr>
            <tr>
                <td style="" align="left" colspan="2" height="25">
                    Amount (in Words): <b><?php echo $data[0]->currency_text . " " . $this->numbertowords->convert_number($data[0]->quotation_grand_total) . " Only"; ?> </b><br/>
                </td>
            </tr>
        </table>
<!--        <table width="100%" cellspacing="0" border-collapse="collapse" class="table" style="margin-top: 30px;">
