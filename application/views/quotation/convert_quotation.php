                                            ...
                                            <tbody id="sales_table_body">
                                                ...
                                                foreach ($items as $key) {
                                                    ...
                                                    <tr id="<?= $i ?>">
                                                        ...
                                                        if ($description_exist == 1) {
                                                            ...
                                                            <td><input type='text' class='form-control form-fixer' name='item_description' value='<?php
                                                                echo $key->quotation_item_description;
                                                                ?>'></td>
                                                                <?php
                                                            }
                                                            ?>
                                                        ...
                                                        <?php if ($discount_exist == 1) { ?>
                                                            <td><input type='hidden' name='item_discount_id' value='<?php
                                                                ...
                                                                echo $key->item_discount_percentage ? (float)($key->item_discount_percentage) : 0;
                                                                ?>'>
                                                        ...
                                                        ?>
                                                        <!-- tax area -->
                                                        <td align='right'><input type='hidden' name='item_taxable_value' value='<?= $key->quotation_item_taxable_value ? $key->quotation_item_taxable_value : 0 ?>' >
                                                        ...
                                                        <?php } ?>
                                                        <?php if ($access_settings[0]->tax_type == 'gst' || $access_settings[0]->tax_type == 'single_tax') { ?>
                                                            <?php /* if ($tax_exist == 1 || ($igst_exist == 1 || $cgst_exist == 1 || $sgst_exist == 1)) { */ ?>
                                                                <?php if($access_settings[0]->gst_visible == 'yes') { ?>
                                                        ...
                                                        <?php } ?>
                                                            ...
                                                            <td><input type='hidden' name='item_tax_cess_id' value='<?= ($key->quotation_item_tax_cess_id ? $key->quotation_item_tax_cess_id : 0); ?>'>
                                                                ...
                                                                <div class="form-group" style="margin-bottom:0px !important;">
                                                                    <select class="form-control open_tax form-fixer select2" name="item_tax_cess" style="width: 100%;" <?= $key->quotation_item_tax_cess_id; ?>>
                                                                        <option value="">Select</option>
                                                                        <?php
                                                                        foreach ($tax as $key3 => $value3) {
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <td><input type='text' class='float_number form-control form-fixer text-right' name='item_grand_total' value='<?php
                                                            ...
                                                            ?>'></td>
                                                            <?php
                                                            $quotation_temp = array(
                                                                "item_key_value" => $i,
                                                                "item_id" => $key->item_id,
                                                                "item_type" => $key->item_type,
                                                                "item_quantity" => $key->quotation_item_quantity,
                                                                "item_price" => $key->quotation_item_unit_price ? precise_amount($key->quotation_item_unit_price) : 0,
                                                                "item_description" => $key->quotation_item_description,
                                                                "item_sub_total" => $key->quotation_item_sub_total ? precise_amount($key->quotation_item_sub_total) : 0,
                                                                "item_discount_amount" => $key->quotation_item_discount_amount ? precise_amount($key->quotation_item_discount_amount) : 0,
                                                                "item_discount_id" => $key->quotation_item_discount_id ? $key->quotation_item_discount_id : 0,
                                                                "item_discount_percentage" => $key->item_discount_percentage ? precise_amount($key->item_discount_percentage) : 0,
                                                                "item_tax_amount" => $key->quotation_item_tax_amount ? precise_amount($key->quotation_item_tax_amount) : 0,
                                                                "item_tax_id" => $key->quotation_item_tax_id ? $key->quotation_item_tax_id : 0,
                                                                "item_tax_cess_amount" => $key->quotation_item_tax_cess_amount ? precise_amount($key->quotation_item_tax_cess_amount) : 0,
                                                                "item_tax_cess_id" => $key->quotation_item_tax_cess_id ? $key->quotation_item_tax_cess_id : 0,
                                                                "item_tax_cess_percentage" => $key->quotation_item_tax_cess_percentage ? precise_amount($key->quotation_item_tax_cess_percentage) : 0,
                                                                "item_tax_percentage" => $key->quotation_item_tax_percentage ? precise_amount($key->quotation_item_tax_percentage) : 0,
                                                                "item_tds_amount" => $key->quotation_item_tds_amount ? precise_amount($key->quotation_item_tds_amount) : 0,
                                                                "item_tds_id" => $key->quotation_item_tds_id ? $key->quotation_item_tds_id : 0,
                                                                "item_tds_percentage" => $key->quotation_item_tds_percentage ? precise_amount($key->quotation_item_tds_percentage) : 0,
                                                                "item_taxable_value" => $key->quotation_item_taxable_value ? precise_amount($key->quotation_item_taxable_value) : 0,
                                                                "item_grand_total" => $key->quotation_item_grand_total ? precise_amount($key->quotation_item_grand_total) : 0
                                                            );
                                                ...
                                                <tr id="0">
                                                   <?php 
                                                    ...
                                                    <!-- <td>
                                                        <div class="form-group" style="margin-bottom:0px !important;">
                                                            <select class="form-control open_discount form-fixer select2 select2-hidden-accessible" name="item_scheme_discount" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                                <option value="">Select</option>
                                                            </select>
