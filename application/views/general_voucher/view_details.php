    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url('general_voucher'); ?>">General Voucher</li></a>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <a class="btn btn-sm btn-default pull-right back_button" id="cancel" onclick1="cancel('general_voucher')">Back</a>
                    </div>
                    <div class="box-body">
                        <div class="row">
