                    ...
                    <div id="plus_btn">
                        <div class="box-header with-border">
                            ...
                            if (in_array($subcategory_module_id, $active_add)) {
                                ?>
                                <a data-toggle="modal" data-target="#add_subcategory_modal" class="add_subcategory btn btn-sm btn-info pull-right" href="">Add Subcategory</a>
                            <?php }
                            ?>
                        </div>
                    </div>
...
$this->load->view('subcategory/add_subcategory_modal');
$this->load->view('subcategory/edit_subcategory_modal');
?>
<script>
    var dTable = '';
    $(document).ready(function () {
        ...
        <?php 
        $subcategory_success = $this->session->flashdata('subcategory_success');
        $subcategory_error = $this->session->flashdata('subcategory_error');
        ?>
        var alert_success = '<?= $subcategory_success; ?>';
        var alert_failure = '<?= $subcategory_error; ?>';
        if(alert_success != ''){
