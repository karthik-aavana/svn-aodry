...
<html>
    ...
    <body>
        ...
        <span style="float: right; margin-top: -25px"><h3><u><?= (@$title ? $title : 'Purchase Credit Note Bill'); ?></u></h3></span>
        <table class="table header_table mt-20" >
            <tr>
                ...
                <td width="30%" valign="top" class="bg-table">
                    ...
                    ?>
                    <?php
                    if (isset($data[0]->purchase_credit_note_date)) {
                        echo $date_for;
                    }
                    ?></span>
                    <br>
                    Invoice Number:<span  class="bold">
                    <?php
                    if (isset($data[0]->purchase_credit_note_invoice_number)) {
                ...
                foreach ($items as $value) {
                    ...
                    <tr>
                        ...
                        <td ><?php
                            ...
                            ?></td>
                        <td style="text-align: right;"><?php echo precise_amount($value->purchase_credit_note_item_unit_price, 2); ?></td>
                        <td style="text-align: right;"><?php echo precise_amount($value->purchase_credit_note_item_sub_total, 2); ?></td>
                        <?php
                        if ($discount_exist > 0) {
                            ?>
                            <td style="text-align: right;"><?php echo precise_amount($value->purchase_credit_note_item_discount_amount, 2); ?></td>
                        <?php } ?>
                        <?php
                        if ($discount_exist > 0 && ($tax_exist > 0 || $igst_exist > 0 || $cgst_exist > 0 || $sgst_exist > 0 )) {
                            ?>
                            <td style="text-align: right;"><?php echo precise_amount($value->purchase_credit_note_item_taxable_value, 2); ?></td>
                        <?php } ?>
                        <?php
                        if ($tds_exist > 0) {
                            ?>
                            <td style="text-align: right;">
                                ...
                                if ($value->purchase_credit_note_item_tds_amount < 1  || $value->item_type == 'service') {
                                    ...
                                    ?>
                                    <?php echo precise_amount($value->purchase_credit_note_item_tds_amount, 2); ?><br>(<?php echo round($value->purchase_credit_note_item_tds_percentage, 2); ?>%)
                                <?php } ?>
                            </td>
                        <?php }
                        ?>
                        ...
                        if ($tax_exist > 0) {
                            ...
                            <td style="text-align: right;">
                                ...
                                if ($value->purchase_credit_note_item_tax_amount < 1) {
                                    ...
                                    ?>
                                    <?php echo precise_amount($value->purchase_credit_note_item_tax_amount, 2); ?><br>(<?php echo round($value->purchase_credit_note_item_tax_percentage, 2); ?>%)
                                <?php } ?>
                            </td>
                            <?php
                        } elseif ($igst_exist > 0) {
                            ...
                            <td style="text-align: right;">
                                ...
                                if ($value->purchase_credit_note_item_igst_amount < 1) {
                                    ...
                                    ?>
                                    <?php echo precise_amount($value->purchase_credit_note_item_igst_amount, 2); ?><br>(<?php echo round($value->purchase_credit_note_item_igst_percentage, 2); ?>%)
                                <?php } ?>
                            </td>
                            <?php
                        } elseif ($cgst_exist > 0 || $sgst_exist > 0) {
                            ...
                            <td style="text-align: right;">
                                ...
                                if ($value->purchase_credit_note_item_cgst_amount < 1) {
                                    ...
                                    ?>
                                    <?php echo precise_amount($value->purchase_credit_note_item_cgst_amount, 2); ?><br>(<?php echo round($value->purchase_credit_note_item_cgst_percentage, 2); ?>%)
                                <?php } ?>
                            </td>
                            <td style="text-align: right;">
                                <?php
                                if ($value->purchase_credit_note_item_sgst_amount < 1) {
                                    ...
                                    ?>
                                    <?php echo precise_amount($value->purchase_credit_note_item_sgst_amount, 2); ?><br>(<?php echo round($value->purchase_credit_note_item_sgst_percentage, 2); ?>%)
                                <?php } ?>
                            </td>
                        <?php }
                        ?>
                        ...
                        if ($cess_exist > 0) {
                            ...
                            <td style="text-align: right;">
                                ...
                                if ($value->purchase_credit_note_item_tax_cess_amount < 1) {
                                    ...
                                    ?>
                                    <?php echo precise_amount($value->purchase_credit_note_item_tax_cess_amount, 2); ?><br>(<?php echo round($value->purchase_credit_note_item_tax_cess_percentage, 2); ?>%)
                                <?php } ?>
                            </td>
                            <?php
                        }
                        ?>
                        <td style="text-align: right;"><?php echo precise_amount($value->purchase_credit_note_item_grand_total, 2); ?></td>
                    </tr>
                    <?php
                    $i++;
                    //$quantity += $quantity;
                    $quantity = bcadd($quantity, $value->purchase_credit_note_item_quantity, 2);
                    $price = bcadd($price, $value->purchase_credit_note_item_unit_price, 2);
                    $grand_total = bcadd($grand_total, $value->purchase_credit_note_item_grand_total, 2);
                    if ($igst_exist > 0) $tot_igst += $value->purchase_credit_note_item_igst_amount;
                    if ($sgst_exist > 0) $tot_sgst += $value->purchase_credit_note_item_sgst_amount;
                    if ($cgst_exist > 0) $tot_cgst += $value->purchase_credit_note_item_cgst_amount;
                }
                ?>
                <tr>
                    <th colspan="2"></th>
                    ...
                    <th  style="text-align: right;"><?= precise_amount($data[0]->purchase_credit_note_sub_total, 2) ?></th>
                    <?php
                    if ($discount_exist > 0) {
                        ?>
                        <th  style="text-align: right;"><?= precise_amount($data[0]->purchase_credit_note_discount_amount, 2) ?></th>
                    <?php } ?>
                    <?php
                    if ($discount_exist > 0 && ($tax_exist > 0 || $igst_exist > 0 || $cgst_exist > 0 || $sgst_exist > 0 )) {
                        ?>
                        <th  style="text-align: right;"><?= precise_amount($data[0]->purchase_credit_note_taxable_value, 2) ?></th>
                    <?php } ?>
                    <?php
                    if ($tds_exist > 0) {
                        ?>
                        <th style="text-align: right;"><?= precise_amount($data[0]->purchase_credit_note_tcs_amount, 2); ?></th>
                    <?php }
                    ?>
                    <?php
                    if ($tax_exist > 0) {
                        ?>
                        <th style="text-align: right;"><?= precise_amount($data[0]->purchase_credit_note_tax_amount, 2) ?></th>
                        <?php
                    } elseif ($igst_exist > 0) {
                        ?>
                    ...
                    if ($cess_exist > 0) {
                        ?>
                        <th style="text-align: right;"><?= precise_amount($data[0]->purchase_credit_note_tax_cess_amount, 2) ?></th>
                        <?php
                    }
                    ?>
        ...
        <table class="mt-20">
            <tr>
                ...
                <td style="width:30%">
                    <table class="table total_sum">
                        <tr>
                            <td align="right"><b>Total Value</b></td>
                            <td align="right"><?php echo $this->numbertowords->formatInr($data[0]->purchase_credit_note_sub_total); ?></td>
                        </tr>
                        <?php
                        if ($discount_exist > 0) {
                            ?>
                            <tr>
                                ...
                                <td align="right"><?php echo $this->numbertowords->formatInr($data[0]->purchase_credit_note_discount_amount); ?></td>
                            </tr>
                            <?php
                        }
                        ?>
                        ...
                        if ($tds_exist > 0) {
                            if ($data[0]->purchase_credit_note_tcs_amount > 0) {
                                ...
                                <tr>
                                    ...
                                    <td align="right"><?php echo $this->numbertowords->formatInr($data[0]->purchase_credit_note_tcs_amount); ?></td>
                                </tr>
                                <?php
                            }
                            ?>
                        ...
                        if ($igst_exist > 0) {
                            ...
                            <tr>
                                ...
                                <td align="right"><?php echo $this->numbertowords->formatInr($data[0]->purchase_credit_note_igst_amount); ?></td>
                            </tr>
                            <?php
                        } elseif ($cgst_exist > 0 || $sgst_exist > 0) {
                            ?>
                            <tr>
                                ...
                                <td align="right"> <?php echo $this->numbertowords->formatInr($data[0]->purchase_credit_note_cgst_amount); ?></td>
                            </tr>
                            <tr>
                                <td align="right"><?= ($is_utgst == '1' ? 'UTGST' : 'SGST'); ?></td>
                                <td align="right"><?php echo $this->numbertowords->formatInr($data[0]->purchase_credit_note_sgst_amount); ?></td>
                            </tr>
                            <?php
                        } elseif ($tax_exist > 0) {
                            ?>
                            <tr>
                                ...
                                <td align="right"><?php echo $this->numbertowords->formatInr($data[0]->purchase_credit_note_tax_amount); ?></td>
                            </tr>
                            <?php
                        }
                        ?>
                        <?php if ($cess_exist > 0) { ?>
                            <tr>
                                ...
                                <td align="right"> <?= $this->numbertowords->formatInr($data[0]->purchase_credit_note_tax_cess_amount); ?></td>
                            </tr>
                        <?php } ?>
                        <?php if ($data[0]->total_freight_charge > 0) { ?>
                            <tr>
                        ...
                        <tr> 
                            ...
                            <td align="right"><?php echo $this->numbertowords->formatInr($data[0]->purchase_credit_note_grand_total); ?>/-</td>
                        </tr>       
                    </table>
                </td>
            </tr>
        ...
        <table class="table mt-50">
            <tr>
                <td class="amount_text">
                    Amount (in Words): <b><?php echo $currency_text . " " . $this->numbertowords->convert_number($data[0]->purchase_credit_note_grand_total,$data[0]->unit,$data[0]->decimal_unit) . " Only"; ?>
                </td>
            </tr>
        </table>        
        
        <?php
        if (isset($data[0]->purchase_credit_note_type_of_supply) && $data[0]->purchase_credit_note_type_of_supply == "import") {
            ?>
            <div id="notices mt-50">
                ...
                <div class="notice">
                    <?php if (isset($data[0]->purchase_credit_note_type_of_supply) && $data[0]->purchase_credit_note_type_of_supply == "import") { ?>
                        <p>SUPPLY MEANT FOR EXPORT ON PAYMENT OF INTEGRATED TAX</p>
                        <?php
                    } else if (isset($data[0]->purchase_credit_note_type_of_supply) && $data[0]->purchase_credit_note_type_of_supply == "export_without_payment") {
                        ?>
