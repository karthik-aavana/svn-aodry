...
<div class="content-wrapper">
    ...
    <div class="fixed-breadcrumb">
        <ol class="breadcrumb abs-ol">
            ...
            <li class="active">Add Purchase Credit Note</li>
        </ol>
    </div>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Purchase Credit Note</h3>
                        <a class="btn btn-sm btn-default pull-right back_button" href1="<?php echo base_url('purchase_credit_note'); ?>">Back </a>
                    </div>
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('purchase_credit_note/add_purchase_credit_note'); ?>">
                            <div class="row">
                                <div class="col-sm-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="supplier_credit_note_no" name="supplier_credit_note_no" value="">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            <input type="text" class="form-control datepicker" id="invoice_date" name="purchase_supplier_credit_note_date" value="">
                            ...
                            <div class="row mt-15">
                                ...
                                if ($access_settings[0]->item_access == 'product') {
                                    ?>
                                    <div class="col-sm-12 search_purchase_credit_note_code">
                                        <?php
                                        ...
                                        ?>
                                        <input id="input_purchase_credit_note_code" class="form-control" type="text" name="input_purchase_credit_note_code" placeholder="Enter Product Code/Name" >
                                    </div>
                                    <?php
                                    ...
                                    <div class="col-sm-12 search_purchase_credit_note_code">
                                        <div class="input-group">
                                            ...
                                            <input id="input_purchase_credit_note_code" class="form-control" type="text" name="input_purchase_credit_note_code" placeholder="Enter Product/Service Code/Name" >
                                        </div>
                                    </div>
                                <?php }
                                ?>
                                <div class="col-sm-12">
                                    <span class="validation-color" id="err_purchase_credit_note_code"></span>
                                </div>
                            </div>            
                            <div class="row">
                                <div class="col-sm-12">                                    
                                    <div class="box-header">
                                        ...
                                        <table class="table table-striped table-bordered table-condensed table-hover purchase_credit_note_table table-responsive" id="purchase_credit_note_data">
                                            <thead>
                                                <tr>
                                        ...
                                        <input type="hidden" class="form-control" id="module_id" name="module_id" value="<?= $purchase_credit_note_module_id ?>" >
                                        ...
                                        <input type="hidden" class="form-control" id="section_area" name="section_area" value="add_purchase_credit_note" >
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" id="purchase_credit_note_submit" name="submit" value="add" class="btn btn-info">Add</button>
                                        <span class="btn btn-default" id="purchase_credit_note_cancel" onclick="cancel('purchase_credit_note')">Cancel</span>
                                    </div>
                                </div>
                            </div>
                        </form>
