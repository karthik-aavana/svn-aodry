...
<div class="content-wrapper">
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Purchase Credit Note Email</li>
            </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            ...
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $purchase_credit_note_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Purchase Credit Note Email</h3>
                            <a class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('purchase_credit_note')">Back</a>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="box-header">
                                    ...
                                    {
                                        ?>
                                        <h4 class="box-title">Supplier : <?= $data[0]->supplier_name ?></h4>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="box-header">
                                    <h3 class="box-title" style="margin-left: 0px;">Company : <?= $branch[0]->firm_name ?></h3>
                                </div>
                            </div>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="hidden" name="redirect" value="purchase_order">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="to_email" name="to_email" value="<?= $data[0]->supplier_email ?>" data-role="tagsinput" placeholder="To"><br>
                            ...
                            <div class="form-group">
                                <textarea id="compose-textarea"  class="form-control" id="message" rows="12" name="message" style="height: 300px"></textarea>
                        ...
                        <div class="box-footer">
                            <div class="col-sm-12">
                                <div class="pull-right">
                                    <button type="submit" id="email_submit" name="sales_submit" class="btn btn-info" style="margin-right: 20px;">Send</button>
                                    <button type="button" class="btn btn-default pull-right" id="quotation_cancel" onclick="cancel('purchase')">Cancel</button>
                                </div>
                            </div>
                        </div>
                        <hr>
