...
<html>
    ...
    <body>
        ...
        <span style="float: right; margin-top: -25px"><h3><u><?= (@$title ? $title : 'Receipt Voucher'); ?></u></h3></span>
        <table class="table header_table mt-20" >
            <tr>
                ...
                <td valign="top" class="bg-table" width="30%">
                    Voucher Date :
                    <?php
                    ...
                    if (isset($data[0]->customer_address) && $data[0]->customer_address != "") {
                        ...
                        echo str_replace(array(
                            ...
                            "\\r\\n",
                            "\n",
                            "\\n"), "<br>", $data[0]->customer_address . ", " . $data[0]->city_name . ', ' . $data[0]->state_name . ' - ' . $data[0]->customer_postal_code);
                    } else {
                        echo "<br/>";
                        echo str_replace(array(
                            "\r\n",
      ...
      <!--  <table class="item-table table mt-20">
            ...
            <tbody>
                ...
                $received_arr = explode(",", $data[0]->invoice_paid_amount);
                ...
                foreach ($reference_arr as $key => $value) {
                    ...
                    <tr>
                        ...
                        <td align="center"><?= $bill_arr[$key] ?></td>
                        <td align="center"><?= $received_arr[$key] ?></td>
                        <td align="center"><?= $pending_arr[$key] ?></td>
                        <td align="center"><?= $receipt_arr[$key] ?></td>
                    </tr>
                    <?php
                    $i++;
                    $pending_amount = bcadd($pending_amount, $pending_arr[$key]);
                    $received_amount = bcadd($received_amount, $received_arr[$key]);
                ...
                <tr>
                    <th></th>
                    <th></th>
                    <th align="center"><?= '<span style="font-family: DejaVu Sans; sans-serif;">' . $currency_code . '</span>&nbsp;' ?><?= precise_amount($bill_amount) ?></th>
                    <th align="center"><?= '<span style="font-family: DejaVu Sans; sans-serif;">' . $currency_code . '</span>&nbsp;' ?><?= precise_amount($received_amount) ?></th>
                    <th align="center"><?= '<span style="font-family: DejaVu Sans; sans-serif;">' . $currency_code . '</span>&nbsp;' ?><?= precise_amount($pending_amount) ?></th>
                    <th align="center"><?= '<span style="font-family: DejaVu Sans; sans-serif;">' . $currency_code . '</span>&nbsp;' ?><?= precise_amount($receipt_amount) ?></th>
                </tr>
            </tbody>
        </table> -->
         ...
         <div class="mt-50">
            <p  style="line-height: 1.5">
                Received from <b><?php echo strtoupper(strtolower($data[0]->customer_name));?></b> <br>Amount (<img class="img" src="<?php echo FCPATH . '/assets/images/currency/'.$currency_symbol_pdf; ?>" style="height: 9px"/>) <b><?php echo formatinr($data[0]->receipt_amount); ?> /-</b>
                </p>
                <p class="amount_text">
