            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Todays's Target</h3>
                        <?php
                        ...
                        <a class="btn btn-sm btn-info pull-right" href="<?php echo base_url('leads/missed_targets'); ?>" title="Missed Targets">Missed Target</a>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="well">
    ...
    $(document).ready(function () {
        ...
        function generateOrderTable() {
            $('#list_datatable').DataTable({
                ...
                "responsive": true,
                "ajax": {
                    "url": base_url + "leads/todays_target",
                    "dataType": "json",
                    "type": "POST",
