        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form name="form" id="form" method="post" action="<?php echo base_url('deposit/add_deposit'); ?>"  encType="multipart/form-data">
                        <div class="box-body">                      
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="deposit_code" name="deposit_code" value="<?php echo $invoice_number; ?>" <?php
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group date">
                                        <input class="form-control datepicker" type="text" name="txt_date_of_deposit" id="txt_date_of_deposit" maxlength="30" />
                                ...
                                <div class="form-group col-md-3" style="display: none" id="name_div">
                                    ...
                                    <input class="form-control" type="text" name="txt_deposit_name" id="txt_deposit_name" maxlength="30" />
                            ...
                            <div class="box-footer">
                                <button type="submit" id="deposit_submit" class="btn btn-info add_deposit">Add</button>
    ...
    $(document).ready(function () {
        ...
        $('[name=txt_deposit_name]').on('blur', function () {
            ...
            xhr = $.ajax({
                ...
                type: 'post',
                data: {deposit_name: deposit_name, id: 0},
                dataType: 'json',
        ...
        $('#cmb_bank, #cmb_deposit_type').on('change', function () {
            ...
            xhr = $.ajax({
                ...
                type: 'post',
                data: {deposit_bank: deposit_bank, deposit_tye: deposit_tye, id: 0},
                dataType: 'json',
                success: function (json) {
                    if (json.rows > 0) {
