<div id="sac_modal" class="modal fade z_index_modal" role="dialog" data-backdrop="static">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
...

        {
            ...
            var s_code = +row.find('#accounting_sac_code').html();

            $('#service_hsn_sac_code').val(s_code)
