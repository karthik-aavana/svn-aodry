    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">HSN/SAC Lookup</h4>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="sac_table" width="100%" class="table table-bordered table-striped sac_table ">
                                <thead>
                                <!-- <th>Sl No</th> -->
                                <th style="width: 15% !important">HSN/SAC Codes</th>
                                <th>Description</th>
                                <th>Action</th>
                                </thead>
                                <tbody>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#sac_table").on("click", "span.apply", function (event){
            ...
            var id = s_code;
            $.ajax({
                url: base_url + 'service/get_hsn_code/' + id,
                dataType: 'JSON',
                method: 'POST',
                success: function (result) {
                    $('[name=service_hsn_sac_code]').val(result[0].hsn_code);
                }
            });
        });
    });
