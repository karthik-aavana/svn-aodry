            ...
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email_compose/'); ?>" encType="multipart/form-data">
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <input type="hidden" name="redirect" value="delivery_challan">
                ...
                <div class="modal-footer">
                    <button type="submit" id="email_submit" name="delivery_challan_submit" class="btn btn-info"> Send
                    </button>
...
<script type="text/javascript">
    $(document).on("click", ".composeMail", function () {
        var id = $(this).data('id');
        $.ajax({
            url: base_url + 'delivery_challan/email_popup/' + id,
            dataType: "JSON",
