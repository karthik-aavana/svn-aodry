...
<div class="content-wrapper">
    ...
    <div class="fixed-breadcrumb">
        <ol class="breadcrumb abs-ol">
            ...
            <li class="active">Edit Over Head</li>
        </ol>
    </div>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Over Head</h3>
                        <a class="btn btn-default pull-right" id="cancel" onclick="cancel('product')">Back</a>
                    </div>
                    <div class="well">
                        <div class="box-body">
                            <form role="form" id="form" method="post" action="<?php echo base_url('over_head/edit_over_head'); ?>" encType="multipart/form-data">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="raw_material_code">Name<span class="validation-color">*</span></label>
                                            <input type="hidden" name="over_head_id" id="over_head_id" value="<?= $over_head[0]->over_head_id ?> ">
                                            <input type="text" class="form-control" tabindex="1"  id="over_head_name" name="over_head_name" value="<?= $over_head[0]->over_head_name ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="over_head_unit" name="over_head_unit" style="width: 100%;" tabindex="4">
                                                ...
                                                <?php foreach ($uqc as $vuqc)
                                                {
                                                    ...
                                                    if ($vuqc->uom . " - " . $vuqc->description == $over_head[0]->over_head_unit)
                                                    {
                                                        echo "selected";
                                                    }
...
<?php } ?>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" tabindex="1"  id="cost_per_unit" name="cost_per_unit" value="<?= $over_head[0]->over_head_cost_per_unit ?>">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" tabindex="1"  id="over_head_quantity" name="over_head_quantity" value="<?= $over_head[0]->quantity ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="box-footer">
                                            <button type="submit" id="submit" name="submit" value="add" class="btn btn-info">Update</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
