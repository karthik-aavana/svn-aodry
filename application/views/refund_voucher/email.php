...
<div class="content-wrapper">
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Refund Voucher Email</li>
            </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            <?php
            $refund_id = $this->encryption_url->encode($data[0]->refund_id);
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $refund_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Refund Voucher Email</h3>
                            <a class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('refund_voucher')">Back</a>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
