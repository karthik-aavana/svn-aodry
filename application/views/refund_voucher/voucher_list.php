...
<div class="content-wrapper">
    ...
    <div class="fixed-breadcrumb">
        <ol class="breadcrumb abs-ol">
            ...
            <li class="active">Refund Ledger</li>
        </ol>
    </div>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Refund Ledger</h3>
                    </div>
...
<!--                    <div class="col-sm-2 pl-2 pr-2">
                    ...
                    <div class="box-body">
                        ...
                        <table id="voucher_list" class="custom_datatable table table-bordered table-striped table-hover table-responsive" >
                            <thead>
                               <tr>
                                    <th width="14%">Voucher Number</th>
                                    <th width="14%">Invoice Date</th>                                    
                                    <th width="14%">Invoice Total</th>
                                    <th width="8%">Expand</th>
                                    <th>Ledger</th>
                                    <th>Amount</th>
                                    <th width="8%">CR/DR</th>
                                </tr>
...
function GetAllVoucher(page = 1){
    ...
    $.ajax({
        url:'<?=base_url();?>refund_ledger/GetAllVoucher',
        type:'post',
        dataType:'json',
