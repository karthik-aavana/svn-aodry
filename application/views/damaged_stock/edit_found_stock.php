<div id="edit_found_stock" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Reported Fixed/Missing Stock</h4>
            </div>
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".edit_found_stock", function () {
            ...
            comp_table = $('#editable_damaged_product').DataTable({
                ...
                'ajax': {
                    url: base_url + 'damaged_stock/product_details',
                    type: 'post',
                    data: {'id': id}
                },
                'columns': [{
        ...
        $(document).on('click', '.save_damage_cell', function () {
            ...
            if (clas == 'dt-pkr-bdr') {
                ...
                $.ajax({
                    url: base_url + 'damaged_stock/update_damage_stock',
                    dataType: 'JSON',
                    method: 'POST',
                    data: {
