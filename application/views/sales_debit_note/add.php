...
<div class="content-wrapper">
    ...
    <div class="fixed-breadcrumb">
        <ol class="breadcrumb abs-ol">
            ...
            <li class="active">Add Sales debit Note</li>
        </ol>
    </div>
    <!-- Main content -->
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Sales debit Note</h3>
                        <a class="btn btn-sm btn-default pull-right back_button" href1="<?php echo base_url('sales_debit_note'); ?>">Back </a>
                    </div>
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('sales_debit_note/add_sales_debit_note'); ?>">
                                <div class="row">
                                    <div class="col-sm-3">
                                ...
                                <div class="row default_hide">
                                    ...
                                    <div class="col-sm-3 disable_div" id="shipping_address_div">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- <div class="input-group date">
                                                ...
                                                <select class="form-control select2 narrow wrap" name="shipping_address" id="shipping_address" style="width: 100%;">
                                                    <option value="">Select</option>
                                                </select>                        
                                            </div> -->
                            ...
                            <div class="row">
                                ...
                                if ($access_settings[0]->item_access == 'product') {
                                    ...
                                    ?>
                                      <input id="input_sales_debit_note_code" class="form-control" type="text" name="input_sales_debit_note_code" placeholder="Enter Product Code/Name" >
                                    </div> -->
                                ...
                                <?php } ?>
                                <!-- <div class="col-sm-12">
                                  <span class="validation-color" id="err_sales_debit_note_code"></span>
                                </div> -->
                            </div>
                            <div class="row default_hide">
                                <div class="col-sm-12">
                                    <div class="box-header">
                                        ...
                                        <table class="table table-striped table-bordered table-condensed table-hover sales_debit_note_table table-responsive" id="sales_debit_note_data">
                                            <thead>
                                                <tr>
                                                  <!-- <th width="2%"><img src="<?php echo base_url(); ?>assets/images/bin1.png" /></th> -->
                                                    ...
                                                    if ($access_settings[0]->description_visible == 'yes') {
                                                        ?>
                                                        <th class="span2" width="20%">Description</th>
                                                    <?php }
                                                    ?>
                                        ...
                                        <input type="hidden" class="form-control" id="module_id" name="module_id" value="<?= $sales_debit_note_module_id ?>" >
                                        ...
                                        <input type="hidden" class="form-control" id="section_area" name="section_area" value="add_sales_debit_note" >
                                        ...
                                        <table id="table-total" class="table table-striped table-bordered table-condensed table-hover table-responsive mt-15">
                                            ...
                                            <tr <?php if ($access_settings[0]->tds_visible == 'no') { ?>
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" id="sales_debit_note_submit" name="submit" value="add" class="btn btn-info">Add</button>
                                        <span class="btn btn-default" id="sales_debit_note_cancel" onclick="cancel('sales_debit_note')">Cancel</span>
                                    </div>
                                </div>
                            </div>
                            <div class="default_hide">
