            ...
            <div class="col-md-12">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edit Firm</h3>
                    </div>
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('superadmin/firm/edit_firm'); ?>" encType="multipart/form-data">
                            <div class="well">
                                <div class="row">
                                    <div class="col-md-3">
