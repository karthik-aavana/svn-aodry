                  ...
                  <?php 
                    ...
                    <tr id="row<?= $id?>">
                      ...
                      <td>
                          ...
                          <a href="<?php echo base_url('superadmin/users/edit/'); ?><?php echo $id; ?>" title="Edit" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-edit"></span></a>
                          ...
                          <a data-toggle="modal" data-target="#delete_modal" data-id="<?= $id ?>" data-path="superadmin/users/delete" title="Delete" class="delete_button btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
...
<script type="text/javascript">
    ...
    $(document).on("click", ".delete_record", function (){
        ...
        var del = confirm("are u sure to delete?");
      ...
      $.ajax({
        ...
        url: base_url + 'superadmin/users/delete/'+id,
