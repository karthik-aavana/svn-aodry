					...
					<div class="box-body">
							<div class="row">
								<div class="form-group col-md-4">
									...
									<input type="text" class="form-control" id="supplier_code_edit" name="supplier_code_edit" readonly="readonly" value="<?php echo $data[0]->supplier_code; ?>" >
...
?>
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-primary" id="vendor_submit_edit" data-dismiss="modal">
							Update
						</button>
