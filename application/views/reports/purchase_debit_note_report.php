...
<div class="content-wrapper">
    ...
    <div class="fixed-breadcrumb">
        <ol class="breadcrumb abs-ol">
            ...
            <li class="active">Purchase Debit Note Reports</li>
        </ol>
    </div>
    <section class="content mt-50">
        <div class="row">
            ...
            <?php if ($this->session->flashdata('email_send') == 'success') { ?>
                <div class="col-sm-12">
                    <div class="alert alert-success">
                        <button class="close" data-dismiss="alert" type="button">×</button>Email has been send with the attachment.
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Purchase Debit Note Reports</h3> 
                            ...
                            <table id="list_datatable" class="custom_datatable table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal" data-toggle="modal" data-target="#distinct-modal" style="text-decoration: none;color: inherit !important;" data-title="Please Select Debit Note Number" data-type="invoice">Debit Note Number<span class="fa fa-toggle-down mr-20"></span></a>
                                        </th>
                                        ...
                                        <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal" data-toggle="modal" data-target="#distinct-modal" style="text-decoration: none;color: inherit !important;" data-title="Please Select Supplier Credit Note Number" data-type="Credit_Note_Number">Supplier Credit Note Number<span class="fa fa-toggle-down mr-20"></span></a>
                                        </th>
                                        <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal" data-toggle="modal" data-target="#distinct-modal" style="text-decoration: none;color: inherit !important;" data-title="Please Select Supplier Credit Note Date" data-type="Credit_Note_Date">Supplier Credit Note Date<span class="fa fa-toggle-down mr-20"></span></a>
                                        </th>
                                       ...
                                       <!--  <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal" data-toggle="modal" data-target="#distinct-modal" style="text-decoration: none;color: inherit !important;" data-title="Please Select Invoice Amount" data-type="invoice_amount">Invoice Amount <span class="fa fa-toggle-down mr-20"></span></a>
                                        </th> -->
                                        <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal" data-toggle="modal" data-target="#distinct-modal" style="text-decoration: none;color: inherit !important;" data-title="Please Enter Purchase Debit Note Amount" data-type="debit_note_amount">Purchase Debit Note Amount<span class="fa fa-toggle-down mr-20"></span></a>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody></tbody>
            ...
            <form id="form-filter" class="">
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12 hide">
                            <div class="form-group">
                                <select id="modal-select_type" name="modal-select_type">
                                    ...
                                    <option value="purchase_reference">Received Amount</option>
                                    ...
                                    <option value="debit_note_amount">debit_note_amount</option>
                        ...
                        <div class="col-md-12" id="invoice_div">
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_invoice_number" name="filter_invoice_number">
                                    <option value="">Select Debit Note Number</option>
                                    <?php foreach ($invoices as $key => $value) { ?>
                                        <option value="<?= $value->purchase_debit_note_invoice_number ?>">
                                            <?= $value->purchase_debit_note_invoice_number ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12" id="reference_number_div">
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_reference_number" name="filter_reference_number">
                                    ...
                                    <?php foreach ($purchase_reference as $key => $value) { ?>
                        ...
                        <div class="col-md-12" id="nature_supply_div">
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_nature_supply" name="filter_nature_supply">
                                    ...
                                    <?php foreach ($nature_supply as $key => $value) { ?>
                                        <option value="<?= $value->purchase_debit_note_nature_of_supply ?>">
                                            <?= $value->purchase_debit_note_nature_of_supply ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_cgst" name="filter_cgst">
                                    ...
                                    <?php foreach ($cgst as $key => $value) { ?>
                                        <option value="<?= $value->purchase_debit_note_cgst_amount ?>">
                                            <?= precise_amount($value->purchase_debit_note_cgst_amount, 2) ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_sgst" name="filter_sgst">
                                    ...
                                    <?php foreach ($sgst as $key => $value) { ?>
                                        <option value="<?= $value->purchase_debit_note_sgst_amount ?>">
                                            <?= precise_amount($value->purchase_debit_note_sgst_amount, 2) ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple"  id="filter_utgst"  name="filter_utgst">
                                    ...
                                    foreach ($utgst as $key => $value) {
                                        ?>
                                        <option value="<?= $value->purchase_debit_note_sgst_amount ?>"><?= precise_amount($value->purchase_debit_note_sgst_amount, 2) ?></option>
                                        <?php
                                    }
                                    ?> 
                                </select>
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_igst" name="filter_igst">
                                    ...
                                    <?php foreach ($igst as $key => $value) { ?>
                                        <option value="<?= $value->purchase_debit_note_igst_amount ?>">
                                            <?= precise_amount($value->purchase_debit_note_igst_amount, 2) ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="select2" multiple="multiple"  id="filter_place_of_supply"  name="filter_place_of_supply">
                                    ...
                                    foreach ($place_of_supply as $key => $value) {
                                        if (!empty($value->state_name)) {
                                            ?>
                                            <option value="<?= $value->purchase_debit_note_billing_state_id ?>"><?= $value->state_name ?></option>
                                            <?php
                                        }
                                    }
                                    ?>                                 
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple"  id="filter_type_of_supply"  name="filter_type_of_supply">
                                    ...
                                    foreach ($type_of_supply as $key => $value) {
                                        ?>
                                        <option value="<?= $value->purchase_debit_note_type_of_supply ?>"><?= $value->purchase_debit_note_type_of_supply ?></option>
                                        <?php
                                    }
                                    ?>                                 
                                </select>
                        ...
                        <div class="col-md-12" id="supplier_cn_number_div">
                            <div class="form-group">
                                <select class="select2" multiple="multiple"  id="filter_supplier_cn_number"  name="filter_supplier_cn_number">
                                    ...
                                    foreach ($credit_note_number as $key => $value) {
                                        if (!empty($value->purchase_supplier_debit_note_number)) {
                                            ?>
                                            <option value="<?= $value->purchase_supplier_debit_note_number ?>"><?= $value->purchase_supplier_debit_note_number ?></option>
                                            <?php
                                        }
                                    }
                                    ?>                                 
                        ...
                        <div class="col-md-12" id="supplier_cn_from_div">
                            <div class="form-group">
                                <div class="input-group date">
                        ...
                        <div class="col-md-12" id="supplier_cn_to_div">
                            <div class="form-group">
                                <div class="input-group date">
                        ...
                        <!-- <div class="col-md-12" id="debit_note_amount_div">
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_debit_note_amount" name="filter_debit_note_amount">
                                    <option value="">Select Debit Note Amount</option>
                        <?php foreach ($debit_note_amount as $key => $value) { ?>
                                                                    <option value="<?= $value->purchase_debit_note_grand_total ?>">
                            <?= $value->purchase_debit_note_grand_total ?></option>
                        <?php } ?>
                                </select>
                            </div>
                        </div> -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
                                ...
                                <input type="checkbox" name="debit_note_number" id="debit_note_number"  value="1" checked> 
                                <label for="debit_note_number" >Debit Note Number</label><br>
                            ...
                            <div class="col-md-6">
                                <input type="checkbox" name="supplier_credit_note_number" id="supplier_invoice_date" value="8" checked>
                                <label for="supplier_invoice_date">Supplier Credit Note Number</label><br>

                                <input type="checkbox" name="supplier_credit_note_date" id="supplier_credit_note_date" value="9" checked>
                                <label for="supplier_credit_note_date">Supplier Credit Note Date</label><br>
                               ...
                               <input type="checkbox" name="sales_gst_payable" id="sales_gst_payable" value="10" checked>
                                ...
                                <label for="grand_total">Purchase Debit Note Amount</label><br>
<!-- 
...
<?php $this->load->view('layout/footer'); // $this->load->view('sales/pay_now_modal'); $this->load->view('sales/pdf_type_modal'); // $this->load->view('advance_voucher/advance_voucher_modal'); $this->load->view('general/delete_modal'); $this->load->view('recurrence/recurrence_invoice_modal');    ?>
    ...
    $(document).ready(function () {
        ...
        $("#modal-select_type").on("change", function (event) {
            ...
            if (type == "") {
                ...
                $("#supplier_cn_number_div").hide();
                $("#supplier_cn_from_div").hide();
                $("#supplier_cn_to_div").hide();
            ...
            if (type == "Credit_Note_Date") {
                $("#supplier_cn_from_div").show();
                $("#supplier_cn_to_div").show();
                $("#reset-dn-date").show();
            } else {
                $("#supplier_cn_from_div").hide();
                $("#supplier_cn_to_div").hide();
            ...
            if (type == "purchase_reference") {
                $("#purchase_reference_div").show();
                $("#reset-rec-amt").show();
            } else {
                $("#purchase_reference_div").hide();
                $("#reset-rec-amt").hide();
            ...
            list_datatable = $('#list_datatable').DataTable({
                ...
                "ajax": {
                    ...
                    "data": {
                        ...
                        'filter_debit_note_amount': $('#filter_debit_note_amount').val(),
                    ...
                    "dataSrc": function (result) {
                        var tfoot = parseFloat(result.total_list_record[0].tot_purchase_dn_taxable_value).toFixed(2);
                        $('#total_list_record1').html(tfoot);
                        // tfoot = "";
                        tfoot = parseFloat(result.total_list_record[0].tot_purchase_dn_cgst_amount).toFixed(2);
                        $('#total_list_record2').html(tfoot);
                        tfoot = parseFloat(result.total_list_record[0].tot_purchase_dn_sgst_amount).toFixed(2);
                        $('#total_list_record3').html(tfoot);
                        tfoot = parseFloat(result.total_list_record[0].tot_purchase_dn_utgst_amount).toFixed(2);
                        $('#total_list_record4').html(tfoot);
                        tfoot = parseFloat(result.total_list_record[0].tot_purchase_dn_igst_amount).toFixed(2);
                        $('#total_list_record5').html(tfoot);
                        //$('#total_list_record2').html(tfoot);
                        tfoot = parseFloat(result.total_list_record[0].tot_purchase_dn_total_amount).toFixed(2);
                ...
                "columns": [
                    ...
                    {"data": "nature_supply"},
                    {"data": "filter_billing_country"},
                    {"data": "place_of_supply"},
                    {"data": "type_of_supply"},
                    {"data": "supplier_credit_note_number"},
                    {"data": "supplier_debit_note_date"},
                    //{"data": "currency_name"},
                    {"data": "debit_note_gst_payable"},
                    {"data": "taxable"},
                    {"data": "cgst"},
                    {"data": "sgst"},
                    /*{"data": "utgst"},*/
                ...
                buttons: [
                    ...
                    {extend: 'pdfHtml5',
                        text: 'PDF',
                        filename: 'Purchase Debit Note Report',
                                ...
                                return {
                                    columns: [
                                        ...
                                        },
                                        {
                                            alignment: 'right',
                                            fontSize: 14,
                                            text: 'Purchase Debit Note Report'
                                        }
                                    ],
                                    margin: 20
                                }
                    ...
                    },
                    {
                        text: 'Select columns',
                        action: function (e, dt, node, config) {
                            $('#purchase_debit_report_select_columns').modal('show');
                        }
        ...
        function appendFilter() {
            ...
            if (filter_invoice_number != '') {
                label += "<label id='lbl_invoice_number' class='label-style'><b> Debit Note Number : </b> " + filter_invoice_number.slice(0, -2) + '<i class="fa fa-times"></i></label>' + " ";
            }
            ...
            if(filter_supplier_cn_number != '') {
                label +="<label id='lbl_supplier_cn_number' class='label-style'><b> Supplier Credit Note Number : </b> " + filter_supplier_cn_number.slice(0, -2) + '<i class="fa fa-times"></i></label>'+" ";
            }
            ...
            if (filter_supplier_cn_from != "" || filter_supplier_cn_to != "") {
                filter_supplier_cn = "<label id='lbl_supplier_cn_date' class='label-style'><b> Supplier Credit Note Date : </b> FROM " + filter_supplier_cn_from + " TO " + filter_supplier_cn_to + '<i class="fa fa-times"></i></label>';
            }
            ...
            if (filter_from_invoice != "" || filter_to_invoice != "") {
                filter_invoice_amount = "<label id='lbl_invoice_Amount' class='label-style'><b> Purchase Debit Note Amount : </b> FROM " + filter_from_invoice + " TO " + filter_to_invoice + '<i class="fa fa-times"></i></label>';
            }
            ...
            if(filter_order_number != '') {
                label +="<label id='lbl_order_number' class='label-style'><b> Purchase Order Number : </b> " + filter_order_number + '<i class="fa fa-times"></i></label>'+" ";
            }
            ...
            if(filter_dilevery_number != '') {
                label +="<label id='lbl_dilevery_number' class='label-style'><b> Delivery Challan Number : </b> " + filter_dilevery_number + '<i class="fa fa-times"></i></label>'+" ";
            }
            ...
            if(filter_e_way_billing != '') {
                label +="<label id='lbl_e_way_billing' class='label-style'><b> E-Way Billing : </b> " + filter_e_way_billing + '<i class="fa fa-times"></i></label>'+" ";
            }*/
...
$(document).ready(function(){
    $('#purchase_debit_report_select_columns #select_column').click(function(){
        var checked_arr = [];
        var unchecked_arr = [];

        $.each($('#purchase_debit_report_select_columns input[type="checkbox"]:checked'),function(key,value){
            checked_arr.push(this.value);
        });

        $.each($('#purchase_debit_report_select_columns input[type="checkbox"]:not(:checked)'),function(key,value){
        ...
        $('#purchase_debit_report_select_columns').modal('hide');
    });
});
</script>