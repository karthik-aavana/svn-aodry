                        ...
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <input type="text" name="customer_id" value="" class="form-control" id="filter-order-no" placeholder="Customer Name">
                                </div>
                            </div>
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <input type="text" name="invoice_id" value="" class="form-control" id="filter-name" placeholder="Invoice Number">
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="form-group">
...
// $this->load->view('advance_voucher/advance_voucher_modal');
                                                            ...
                                                            <script>
                                                                ...
                                                                //       "responsive": true,
                                                                //       "ajax":{
                                                                //    "url": base_url+"report/sales_demo ",
                                                                //    "dataType": "json",
                                                                //    "type": "POST",
