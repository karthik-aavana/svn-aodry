...
<div class="content-wrapper">   
    ...
    <div class="fixed-breadcrumb">
        <ol class="breadcrumb abs-ol">
            ...
            <li class="active">Sales Debit Note Reports</li>
        </ol>
    </div>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sales Debit Note Reports</h3>
                            ...
                            <table id="list_datatable" class="custom_datatable table table-bordered table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <!-- <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal" data-toggle="modal" data-target="#distinct-modal" style="text-decoration: none;color: inherit !important;" data-title="Please Select UTGST" data-type="utgst">UTGST<span class="fa fa-toggle-down mr-20"></span></a>
                                        </th> -->
                                        ...
                                        <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal" data-toggle="modal" data-target="#distinct-modal" style="text-decoration: none;color: inherit !important;" data-title="Please Enter Invoice Amount" data-type="invoice_amount">Sales debit note amount <span class="fa fa-toggle-down mr-20"></span></a>
                                        </th>
<!-- <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal" data-toggle="modal" data-target="#distinct-modal" style="text-decoration: none;color: inherit !important;" data-title="Please Select Payment Status" data-type="payment_status">Payment To <span class="fa fa-toggle-down mr-20"></span></a>
</th> -->
                                    </tr>
                                </thead>
                                <tbody></tbody>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_invoice_number" name="filter_invoice_number">
                                    ...
                                    <?php foreach ($invoices as $key => $value) { ?>
                                        <option value="<?= $value->sales_debit_note_invoice_number ?>">
                                            <?= $value->sales_debit_note_invoice_number ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple" id="filter_nature_of_supply" name="filter_nature_of_supply">
                                    ...
                                    <?php foreach ($nature_of_supply as $key => $value) { ?>
                                        <option value="<?= $value->sales_debit_note_nature_of_supply ?>">
                                            <?= $value->sales_debit_note_nature_of_supply ?></option>
                                    <?php } ?> 
                                </select>
                            </div>
                        </div>
                                ...
                                <select class="select2" multiple="multiple"  id="filter_place_of_supply"  name="filter_place_of_supply">
                                    ...
                                    foreach ($place_of_supply as $key => $value) {
                                        if (!empty($value->state_name)) {
                                            ?>
                                            <option value="<?= $value->sales_debit_note_billing_state_id ?>"><?= $value->state_name ?></option>
                                            <?php
                                        }
                                    }
                                    ?>                                 
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple"  id="filter_type_of_supply"  name="filter_type_of_supply">
                                    ...
                                    foreach ($type_of_supply as $key => $value) {
                                        ?>
                                        <option value="<?= $value->sales_debit_note_type_of_supply ?>"><?= $value->sales_debit_note_type_of_supply ?></option>
                                        <?php
                                    }
                                    ?> 
                                </select>
                       ...
                       <div class="col-md-12" id="to_date_div">
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple"  id="filter_cgst"  name="filter_cgst">
                                    ...
                                    foreach ($cgst as $key => $value) {
                                        ?>
                                        <option value="<?= $value->sales_debit_note_cgst_amount ?>"><?= precise_amount($value->sales_debit_note_cgst_amount, 2) ?></option>
                                        <?php
                                    }
                                    ?> 
                                </select>
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple"  id="filter_sgst"  name="filter_sgst">
                                    ...
                                    foreach ($sgst as $key => $value) {
                                        ?>
                                        <option value="<?= $value->sales_debit_note_sgst_amount ?>"><?= precise_amount($value->sales_debit_note_sgst_amount, 2) ?></option>
                                        <?php
                                    }
                                    ?>  
                                </select>
                            ...
                            <div class="form-group">
                                <select class="select2" multiple="multiple"  id="filter_igst"  name="filter_igst">
                                    ...
                                    foreach ($igst as $key => $value) {
                                        ?>
                                        <option value="<?= $value->sales_debit_note_igst_amount ?>"><?= precise_amount($value->sales_debit_note_igst_amount, 2) ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <?php foreach ($taxable as $key => $value) { ?>
                                            <option value="<?= $value->debit_note_taxable_value ?>">
                            <?= $value->debit_note_taxable_value ?></option>
                        <?php } ?>
                                </select>
                            </div>
                        </div> -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                               <input type="checkbox" name="place_of_supply" id="place_of_supply" value="10" checked>
                                ...
                                <label for="grand_total">Sales Debit note amount</label><br>
<!-- 
    ...
    $(document).ready(function () {
           ...
           list_datatable =  $('#list_datatable').DataTable({
                ...
                "ajax": {
                    ...
                    "data": {
                        ...
                        /*'filter_billing_country_div': $('#filter_billing_name').val(),*/
                    ...
                    "dataSrc": function (result) {
                        var tfoot = parseFloat(result.total_list_record[0].tot_sales_dn_taxable_value).toFixed(2);
                        $('#total_list_record1').html(tfoot);
                        // tfoot = "";
                        tfoot = parseFloat(result.total_list_record[0].tot_sales_dn_cgst_amount).toFixed(2);
                        $('#total_list_record2').html(tfoot);
                        tfoot = parseFloat(result.total_list_record[0].tot_sales_dn_sgst_amount).toFixed(2);
                        $('#total_list_record3').html(tfoot);
                        tfoot = parseFloat(result.total_list_record[0].tot_sales_dn_utgst_amount).toFixed(2);
                        $('#total_list_record4').html(tfoot);
                        tfoot = parseFloat(result.total_list_record[0].tot_sales_dn_igst_amount).toFixed(2);
                        $('#total_list_record5').html(tfoot);
                        //$('#total_list_record2').html(tfoot);
                        tfoot = parseFloat(result.total_list_record[0].tot_sales_dn_total_amount).toFixed(2);
                ...
                buttons: [
                    ...
                    {extend: 'pdfHtml5',
                        text: 'PDF',
                        filename: 'Sales Debit Note Report',
                    ...
                    },
                    {
                        text: 'Select columns',
                        action: function (e, dt, node, config) {
                            $('#debit_report_select_columns').modal('show');
                        }
        ...
        function appendFilter() { //button filter event click
            ...
            if (filter_from_invoice != "" || filter_to_invoice != "") {
                filter_invoice_amount = "<label id='lbl_invoice_Amount' class='label-style'><b> Sales Credit Note Amount : </b> FROM " + filter_from_invoice + " TO " + filter_to_invoice + '<i class="fa fa-times"></i></label>';
            }
...
$(document).ready(function(){
    $('#debit_report_select_columns #select_column').click(function(){
        var checked_arr = [];
        var unchecked_arr = [];

        $.each($('#debit_report_select_columns input[type="checkbox"]:checked'),function(key,value){
            checked_arr.push(this.value);
        });

        $.each($('#debit_report_select_columns input[type="checkbox"]:not(:checked)'),function(key,value){
        ...
        $('#debit_report_select_columns').modal('hide');
    });
});
</script>