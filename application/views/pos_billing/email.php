...
<div class="content-wrapper">
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">POS Billing Email</li>
            </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            ...
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $pos_billing_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-">

                            <h3 class="box-title">POS Billing Email</h3>

                            <span class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('pos_billing')">Back</span>
                        </div>
                        <div class="box-body">
                            <div class="well well-sm">
                                <div class="row">
                                    <div class="col-sm-12" style="margin-left: 15%;">
                                        ...
                                        <?php
                                        if ($data[0]->pos_billing_party_type)
                                        {
                                            ?>
                                            <div class="col-sm-8">
                                                <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="form-group col-sm-9">
                                                <input type="hidden" name="redirect" value="pos_billing">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="col-sm-9" >
                                                <input type="text" class="form-control" id="to_email" name="to_email" value="<?= $data[0]->pos_billing_email ?>" data-role="tagsinput"><br>
                                    ...
                                    <div class="col-sm-12" style="margin-left: 15%;">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="col-sm-9" >
                                                <textarea class="form-control" id="message" rows="12" name="message"></textarea>
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="col-sm-9">
                                                ...
                                                <span class="btn btn-default pull-right" id="quotation_cancel" style="margin-right: 2%" onclick="cancel('pos_billing')">Cancel</span>
                                            </div>
                                        </div>
                                        <br/>
                                    </div>
