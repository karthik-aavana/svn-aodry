                        ...
                        <div class="box-body">                      
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3" id="div_partner_capt_roi">
                                    ...
                                    <input class="form-control text-right number" type="text" name="txt_roi_capital_intrest" id="txt_roi_capital_intrest" maxlength="2" />
                                ...
                                <div class="form-group col-md-3" id="div_partner_profit">
                                    ...
                                    <input class="form-control text-right number" type="text" name="txt_share_profit" id="txt_share_profit" maxlength="2" />
