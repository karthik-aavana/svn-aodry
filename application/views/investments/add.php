        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    ...
                    <form name="form" id="form" method="post" action="<?php echo base_url('investments/add_investments'); ?>"  encType="multipart/form-data">
                        <div class="box-body">                      
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="investment_code" name="investment_code" value="<?php echo $invoice_number; ?>" <?php if ($access_settings[0]->invoice_readonly == 'yes') { echo "readonly"; }?>>
                            ...
                            <div class="box-footer">
                                <button type="submit" id="investment_submit" class="btn btn-info">Add</button>
