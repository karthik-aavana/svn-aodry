    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo base_url('superadmin/firm'); ?>">Firm</a></li>
                <li class="active">Add Firm</li>
            </ol>
        </h5>    
    </section>
    <!-- Main content -->
        ...
        <div class="row">            
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('superadmin/firm/add_firm'); ?>" encType="multipart/form-data">
                            <div class="well">
                                <div class="row">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="company_code" name="company_code" value="<?=$company_code;?>" autocomplite="off" readonly>
                                            ...
                                            <select class="form-control select2" id="financial_year_id" name="financial_year_id" style="width: 100%;">
                                                <?php
                                                    foreach ($financial_year as $key => $value) 
                                                    {
                                                            ...
                                                            echo "<option value='".$value->financial_year_title."'>".$value->financial_year_title."</option>";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="sa_country" name="sa_country" style="width: 100%;">
                                                <option value="">Select</option>
                                                <?php
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="sa_state" name="sa_state" style="width: 100%;">
                                                <option value="">Select</option>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select2" id="sa_city" name="sa_city" style="width: 100%;">
                                                <option value="">Select</option>
                                                <?php
                                                foreach ($city as $key) {
                                                    ?>
                            ...
                            <div class="well">
                             ...
                             <div class="well">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group disable_in tax_per">
                                            <label for="tax_split_percentage">Tax Split Percentage <span class="validation-color"> *</span></label>
                                            <input type="number" class="form-control" id="tax_split_percentage" name="tax_split_percentage" value="50" placeholder="CGST %" readonly max="100">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="default_notification_date">Default Notification Date<span class="validation-color"> *</span></label>
                                            ...
                                            <span class="validation-color" id="err_default_notification_date"><?php echo form_error('default_notification_date'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="box-footer">
                                    ...
                                    <span class="btn btn-default btn-flat" id="cancel" onclick="cancel('superadmin/firm')">Cancel</span>
                                </div>
                            </div>
                        </form>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#email").on("blur", function (event) {
            ...
            if (!email.match(email_regex)) {
             ...
             $.ajax({
                url: base_url + 'superadmin/firm/get_check_email',
                dataType: 'JSON',
                method: 'POST',
                data: {
                    'email': email,
        ...
        $("#sa_state").change(function () {
            ...
            if (state == "" || state == null) {
                ...
                $('#err_state').text("");
            $.ajax({
            url: base_url + 'superadmin/general/get_state_code/'+ state,
            method: "GET",
            dataType: "JSON",
    ...
    var xhr;
    $('#branch_code').on('keyup blur',function(){
        ...
        if(branch_code.length > 3){
            ...
            xhr = $.ajax({
                url:'<?=base_url();?>general/validateBranchCode',
                type:'post',
                dataType:'json',
                ...
                success:function(resp){
                    flag = resp.flag;
                    if(!flag){
                        $("#err_branch_code").text("Login code already used!");
                    }
                }
            });
        }
