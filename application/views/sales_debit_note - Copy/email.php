    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Sales Debit Note Email</li>
            </ol>
        </h5>
    </section>
...
?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $sales_debit_note_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sales Debit Note Email</h3>
                            <a class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('sales_debit_note')">Back</a>
                        </div>
