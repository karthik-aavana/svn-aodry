...
function add_row(data) {
    ...
    cols += "<td style='text-align:center'><input type='text' class='form-control form-fixer text-center float_number' value='0' data-rule='free_quantity' name='free_item_quantity'></td>";
