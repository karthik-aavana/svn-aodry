...

            {
...

                {
...

                    {
                        ...
                        <th rowspan="1" class="white-text"><?=($is_utgst == '1' ? 'UTGST' : 'SGST');?></th>
                    ...
                    if ($cess_tax > 0){?>
                        ...
                        <th rowspan="1" class="white-text">Cess</th>
                ...
                foreach ($items as $value) { ?>
                    ...
                    <tr>
                        ...
                        <?php if ($value->item_type == 'product' || $value->item_type == 'product_inventory'){?>
                            ...
                            <td  align="center"><?php echo $value->product_name; ?><br>HSN/SAC: <?php echo $value->product_hsn_sac_code; ?><br><?php echo $value->sales_item_description; ?></td>
                        ...
                        <?php if($cess_tax > 0){?>
                            ...
                            <td align="right"><?php echo $value->sales_item_tax_cess_amount; ?></td>
                ...
                <tr>
...

                    {
...

                        {
                            ...
                            <th><?php echo $data[0]->sales_discount_amount; ?></th>
                    ...
                    if ($data[0]->sales_igst_amount < 1 && $data[0]->sales_cgst_amount > 1){
                        ...
                        if ($pdf_results['cgst'] == 'yes') {?>
                            ...
                            <th align="right"><?php echo bcdiv($data[0]->sales_tax_amount, 2, 2); ?></th>
                        ...
                        <th align="right"><?php echo $data[0]->sales_tax_amount; ?></th>

                    <?php } ?>

                    <?php if($cess_tax > 0){?>

                        <th align="right"><?php echo $data[0]->sales_tax_cess_amount; ?></th>
