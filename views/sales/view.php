                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            if ($discount_exist > 0) {
                                                ?>
                                                <th  style="text-align: right;"><?= precise_amount(($data[0]->sales_discount_amount )) ?></th>
                                            <?php } ?>
                                            <?php
                                            if ($discount_exist > 0 && ($tax_exist > 0 || $igst_exist > 0 || $cgst_exist > 0 || $sgst_exist > 0 )) {
                                                ?>
                                            ...
                                            <?php } ?>
                                            <th  style="text-align: right;"><?= bcadd($data[0]->sales_grand_total, $data[0]->round_off_amount, 2); ?></th>
                                        </tr>
                                    </tbody>
                                </table>
