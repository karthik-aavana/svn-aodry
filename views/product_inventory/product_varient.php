                ...
                <div class="box">
                    ...
                    <div class="box-body">
                       ...
                       <!--  <div class="table-scroll">
                        ...
                        <form method="post" action="<?= base_url('product_inventory/update_product_varients') ?>">
            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        ...
                        <a class="btn btn-sm btn-info pull-right btn-flat" href="<?php echo base_url('product_inventory/add'); ?>">Add Product</a>
                    ...
                    <div class="box-body">
                        ...
                        <table id="list_datatable" class="custom_datatable table table-bordered table-striped table-hover table-responsive" style="width: 100%">
