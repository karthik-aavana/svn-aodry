            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <a class="btn btn-sm btn-default pull-right back_button" href1="<?php echo base_url('sales_debit_note'); ?>">Back </a>
                    </div>
                    <div class="box-body">
                        <form role="form" id="form" method="post" action="<?php echo base_url('sales_debit_note/edit_sales_debit_note'); ?>">
                            <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <div class="form-group">
                                        <label for="date">Debit Note Date<span class="validation-color">*</span></label>
                                        <div class="input-group date">             
                                            <input type="text" style="background: #fff;" class="form-control datepicker" id="invoice_date" name="invoice_date" value="<?php echo date('d-m-Y',strtotime($data[0]->sales_debit_note_date)); ?>" readonly>
                                ...
                                <div class="col-sm-3 disable_div">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2"  id="nature_of_supply" name="nature_of_supply">
                                            <option value="product" <?= ($data[0]->sales_debit_note_nature_of_supply == "product" ? 'selected' : '') ?>>Product</option>
                                            <option value="service" <?= ($data[0]->sales_debit_note_nature_of_supply == "service" ? 'selected' : '') ?>>Service</option>
                                            <option value="both" <?= ($data[0]->sales_debit_note_nature_of_supply != "product" && $data[0]->sales_debit_note_nature_of_supply != "service" ? 'selected' : '') ?>>Both</option>
                                        </select>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group disable_div">
                                        ...
                                        <select class="form-control select2" id="billing_state" name="billing_state">
                                            ...
                                            <option value="0" <?= ($data[0]->sales_debit_note_billing_country_id != $branch[0]->branch_country_id ? 'selected' : ''); ?>>Out of Country</option>
                                    ...
                                    <div class="form-group disable_div">
                                        ...
                                        <select class="form-control select2" id="type_of_supply" name="type_of_supply">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <option value="export_with_payment" <?= ($data[0]->sales_debit_note_type_of_supply == 'export_with_payment' ? "selected" : ''); ?>>Export (With Tax Payment)</option>

                                                <option value="export_without_payment" <?= ($data[0]->sales_debit_note_type_of_supply == 'export_without_payment' ? "selected" : ''); ?>>Export (Without Tax Payment)</option>
                            ...
                            <div class="row">
                                <div class="col-sm-3 gst_payable_div disable_div" style="<?= ($data[0]->sales_debit_note_type_of_supply != 'regular' ? "display: none;" : ''); ?>">
                                    <div class="form-group">
                                        ...
                                        <label class="radio-inline p_l_20">
                                            ...
                                            <input class="" type="radio" name="gst_payable" value="yes" <?= ($data[0]->sales_debit_note_gst_payable == "yes" ? 'checked="checked"' : ''); ?> /> Yes

                                        </label>

                                        <label class="radio-inline p_l_20">

                                            <input class="" type="radio" name="gst_payable" value="no" <?= ($data[0]->sales_debit_note_gst_payable == "no" ? 'checked="checked"' : ''); ?> /> No
                            ...
                            <div class="row">
                                ...
                                <?php } elseif ($access_settings[0]->item_access == 'service') { ?>
                                    ...
                                    <!-- <div class="col-sm-12 search_sales_debit_note_code">
                                    ...
                                    if (isset($other_modules_present['product_module_id']) && isset($other_modules_present['service_module_id']) && $other_modules_present['product_module_id'] != "" && $other_modules_present['service_module_id'] != "") {
                                        ?>                                                                 <div class="input-group">                                          
                                        <div class="input-group-addon">                                            <a href="" data-toggle="modal" data-target="#item_modal" class="pull-left">+</a>  </div>
                                                                
                                    <?php }
                                    ?> <input id="input_sales_debit_note_code" class="form-control" type="text" name="input_sales_debit_note_code" placeholder="Enter Product/Service Code/Name" >
                                        </div>
                                    </div> -->
                                ...
                                <div class="col-sm-12">
                                    <div class="box-header ">
                                        ...
                                        <table class="table table-striped table-bordered table-condensed table-hover sales_table table-responsive" name="sales_data" id="sales_debit_note_data">
                                            <thead>
                                                <tr>
                                            ...
                                            <tbody id="sales_debit_note_table_body">
                                                <?php
                                                $i = 0;
                                                $tot = 0;
                                                foreach ($items as $key) {
                                                    ?>
                                                    <tr id="<?= $i ?>">                               <!-- <td> -->                                     <!-- <a class='deleteRow'> <img src='<?php echo base_url(); ?>assets/images/bin_close.png' /></a> -->
                                                ...
                                                <td><input type="text" class="float_number form-control form-fixer text-center" value="<?= $key->sales_debit_note_item_quantity ?>" data-rule="quantity" name='item_quantity' limit="<?= $key->sales_debit_note_item_quantity ?>">

                                                </td>
                                                <td align='right'>

                                                    <input type='hidden' name='item_discount_id' value='<?php
                                                    echo $key->sales_debit_note_item_discount_id ? $key->sales_debit_note_item_discount_id : 0;
                                                    ?>'>

                                                    <input type='hidden' name='item_discount_percentage' value='0'>

                                                    <input type='hidden' name='item_discount_amount' value='<?php
                                                    echo $key->sales_debit_note_item_discount_amount ? $key->sales_debit_note_item_discount_amount : 0;
                                                    ?>'>

                                                    <input type='hidden' class='float_number form-control form-fixer text-right' name='item_price' value='<?php echo precise_amount($key->sales_debit_note_item_unit_price); ?>' limit='<?php echo precise_amount($key->sales_debit_note_item_unit_price); ?>'>
                                                    ...
                                                    <input type='text' name='item_taxable_value' value='<?= precise_amount($key->sales_debit_note_item_taxable_value ? $key->sales_debit_note_item_taxable_value : 0); ?>' limit='<?= precise_amount($key->sales_debit_note_item_taxable_value ? $key->sales_debit_note_item_taxable_value : 0); ?>' class="float_number form-control form-fixer text-right"> 
                                                </td>
                                                <?php if ($access_settings[0]->tds_visible == 'yes') { ?>
                                                    ...
                                                    <td style='text-align:center'>
                                                        ...
                                                        if ($key->tds_module_type == "" || $key->tds_module_type == null) {
                                                            ...
                                                            $input_type = "hidden";
                                                            ?> <!-- <span id='item_tds_percentage_hide_lbl_<?= $i ?>' class='text-center' ><?= $key->sales_debit_note_item_tds_percentage ? precise_amount($key->sales_debit_note_item_tds_percentage) : 0 ?></span> -->
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach ($tax as $key3 => $value3) {
                                                                        ...
                                                                        if (($key->item_type == 'service' && $value3->tax_name == 'TDS') || ($value3->tax_name == 'TCS' && $key->item_type == 'product')) {
                                                                            ...
                                                                            if ($value3->tax_value >= $key->sales_debit_note_item_tds_percentage) {
                                                                                if ($value3->tax_id == $key->sales_debit_note_item_tds_id) {
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td><div class="radio">
                                                                                            ...
                                                                                            <label><input type="radio" name="tds_tax" value="<?= (float)($value3->tax_value); ?> "<?= ($value3->tax_id == $key->sales_debit_note_item_tds_id ? 'selected' : '' ) ?> tds_id='<?= $value3->tax_id ?>' typ='<?= $value3->tax_name ?>'></label>
                                                        ...
                                                        <input type='hidden' name='item_tds_id' value='<?= $key->sales_debit_note_item_tds_id ? $key->sales_debit_note_item_tds_id : 0 ?>'><input type='hidden' name='item_tds_type' value='<?= $key->tds_module_type ? $key->tds_module_type : '' ?>'>

                                                        <input type='hidden' name='item_tds_amount' value='<?= $key->sales_debit_note_item_tds_amount ? precise_amount($key->sales_debit_note_item_tds_amount) : 0 ?>'><span id='item_tds_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= $key->sales_debit_note_item_tds_amount ? precise_amount($key->sales_debit_note_item_tds_amount) : 0 ?></span>
                                                ...
                                                <?php if ($access_settings[0]->tax_type == 'gst' || $access_settings[0]->tax_type == 'single_tax') { ?>
                                                    ...
                                                    <td><input type='hidden' name='item_tax_id' value='<?= $key->sales_debit_note_item_tax_id ? $key->sales_debit_note_item_tax_id : 0 ?>'>

                                                        <input type='hidden' name='item_tax_percentage' value='<?= $key->sales_debit_note_item_tax_percentage ? (float)($key->sales_debit_note_item_tax_percentage) : 0 ?>'>
                                                        ...
                                                        <input type='hidden' name='item_tax_amount' value='<?= $key->sales_debit_note_item_tax_amount ? precise_amount($key->sales_debit_note_item_tax_amount) : 0 ?>'>
                                                            ...
                                                            <select class="form-control open_tax form-fixer select2" name="item_tax">
                                                                ...
                                                                foreach ($tax as $key3 => $value3) {
                                                                    ...
                                                                    if ($value3->tax_name == 'GST') {
                                                                        ...
                                                                        if ($value3->tax_value <= $key->sales_debit_note_item_tax_percentage) {

                                                                            echo "<option value='" . $value3->tax_id . "-" . ($value3->tax_value) . "' " . ($value3->tax_id == $key->sales_debit_note_item_tax_id ? 'selected' : '' ) . " " . $key->sales_debit_note_item_tax_id . ">" . (float) ($value3->tax_value) . "%</option>";
                                                                        }
                                                                    }
                                                                }
                                                                ?>
                                                        ...
                                                        <span id='item_tax_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= $key->sales_debit_note_item_tax_amount ? precise_amount($key->sales_debit_note_item_tax_amount) : 0 ?></span>

                                                    </td>

                                                    <td><input type='hidden' name='item_tax_cess_id' value='<?= ($key->sales_debit_note_item_tax_cess_id ? $key->sales_debit_note_item_tax_cess_id : 0); ?>'>

                                                        <input type='hidden' name='item_tax_cess_percentage' value='<?= $key->sales_debit_note_item_tax_cess_percentage ? (float)($key->sales_debit_note_item_tax_cess_percentage) : 0; ?>'>

                                                        <input type='hidden' name='item_tax_cess_amount' value='<?= $key->sales_debit_note_item_tax_cess_amount ? precise_amount($key->sales_debit_note_item_tax_cess_amount) : 0 ?>'>

                                                        <div class="form-group" style="margin-bottom:0px !important;">

                                                            <select class="form-control open_tax form-fixer select2" name="item_tax_cess" <?= $key->sales_debit_note_item_tax_cess_id; ?>>
                                                                ...
                                                                foreach ($tax as $key3 => $value3) {
                                                                    ...
                                                                    if ($value3->tax_name == 'CESS') {
                                                                        ...
                                                                        if ($value3->tax_value <= $key->sales_debit_note_item_tax_cess_percentage) {

                                                                            echo "<option value='" . $value3->tax_id . "-" . ($value3->tax_value) . "' " . ($value3->tax_id == $key->sales_debit_note_item_tax_cess_id ? 'selected' : '' ) . ">" . (float) ($value3->tax_value) . "%</option>";
                                                                        }
                                                                    }
                                                                }
                                                                ?>
                                                        ...
                                                        <span id='item_tax_cess_lbl_<?= $i ?>' class='pull-right' style='color:red;'><?= $key->sales_debit_note_item_tax_cess_amount ? precise_amount($key->sales_debit_note_item_tax_cess_amount) : 0 ?></span>
                                                ...
                                                <td align="right">
                                                    ...
                                                    <input type="text" class="float_number form-control form-fixer text-right" name="item_grand_total" value="<?php echo precise_amount($key->sales_debit_note_item_grand_total); ?>" limit="<?php echo precise_amount($key->sales_debit_note_item_grand_total); ?>">
                                                ...
                                                $sales_data[$i]['item_discount_amount'] = (@$key->sales_debit_note_item_discount_amount ? $key->sales_debit_note_item_discount_amount : 0);

                                                $sales_data[$i]['item_discount_value'] = (@$key->sales_debit_note_item_discount_value ? $key->sales_debit_note_item_discount_value : 0);
                                                ...
                                                $sales_data[$i]['item_discount_id'] = $key->sales_debit_note_item_discount_id;
                                                ...
                                                $sales_data[$i]['item_tds_percentage'] = $key->sales_debit_note_item_tds_percentage;

                                                $sales_data[$i]['item_tds_id'] = $key->sales_debit_note_item_tds_id;

                                                $sales_data[$i]['item_tds_amount'] = $key->sales_debit_note_item_tds_amount;

                                                $sales_data[$i]['item_tax_cess_percentage'] = $key->sales_debit_note_item_tax_cess_percentage;

                                                $sales_data[$i]['item_tax_cess_amount'] = $key->sales_debit_note_item_tax_cess_amount;

                                                $sales_data[$i]['item_tax_cess_id'] = $key->sales_debit_note_item_tax_cess_id;

                                                $sales_data[$i]['item_tax_percentage'] = $key->sales_debit_note_item_tax_percentage;

                                                $sales_data[$i]['item_tax_amount'] = $key->sales_debit_note_item_tax_amount;

                                                $sales_data[$i]['item_tax_id'] = $key->sales_debit_note_item_tax_id;
                                        ...
                                        <input type="hidden" class="form-control" id="invoice_date_old" name="invoice_date_old" value="<?php echo date('d-m-Y',strtotime($data[0]->sales_debit_note_date)); ?>" readonly>
                                        ...
                                        <input type="hidden" name="total_discount_amount" id="total_discount_amount" value="<?= $data[0]->sales_debit_note_discount_amount; ?>">
                                        ...
                                        <input type="hidden" name="total_tax_cess_amount" id="total_tax_cess_amount" value="<?= $data[0]->sales_debit_note_tax_cess_amount; ?>">

                                        <input type="hidden" name="total_tds_amount" id="total_tds_amount" value="<?= $data[0]->sales_debit_note_tds_amount; ?>">

                                        <input type="hidden" name="total_tcs_amount" id="total_tcs_amount" value="<?= $data[0]->sales_debit_note_tcs_amount ?>">

                                        <input type="hidden" name="total_grand_total" id="total_grand_total" value="<?= $data[0]->sales_debit_note_grand_total; ?>">

                                        <input type="hidden" name="without_reound_off_grand_total" id="without_reound_off_grand_total" value="<?= $data[0]->sales_debit_note_grand_total + $data[0]->round_off_amount; ?>">
                                        ...
                                        <table id="table-total" class="table table-striped table-bordered table-condensed table-hover table-responsive mt-15">
                                            ...
                                            <tr>
                                                ...
                                                <td align='right'><span id="totalSubTotal"><?php echo precise_amount($data[0]->sales_debit_note_sub_total); ?></span></td>

                                            </tr>

                                            <tr <?= ($data[0]->sales_debit_note_discount_amount <= 0 ? 'style="display: none;"' : '' ); ?> class='totalDiscountAmount_tr'>

                                                <td align="right">Total Discount (-)</td>

                                                <td align='right'><span id="totalDiscountAmount"><?php echo precise_amount($data[0]->sales_debit_note_discount_amount); ?></span>
                                            ...
                                            <tr <?= ($igst_exist <= 0 ? 'style="display: none;"' : ''); ?> class='totalIGSTAmount_tr'>
                                                ...
                                                <td align='right'><span id="totalIGSTAmount"><?= ($igst_exist > 0 ? precise_amount($data[0]->sales_debit_note_igst_amount) : ''); ?></span>
                                            ...
                                            <tr <?= ($cgst_exist <= 0 ? 'style="display: none;"' : ''); ?> class='totalCGSTAmount_tr'>
                                                ...
                                                <td align='right'><span id="totalCGSTAmount"><?= ($cgst_exist > 0 ? precise_amount($data[0]->sales_debit_note_cgst_amount) : ''); ?></span>
                                            ...
                                            <tr <?= ($sgst_exist <= 0 ? 'style="display: none;"' : ''); ?> class='totalSGSTAmount_tr'>
                                                ...
                                                <td align='right'><span id="totalSGSTAmount"><?= ($sgst_exist > 0 ? precise_amount($data[0]->sales_debit_note_sgst_amount) : ''); ?></span>
                                            ...
                                            <tr <?= ($cess_exist <= 0 ? 'style="display: none;"' : ''); ?> class='totalCessAmount_tr'>
                                                ...
                                                <td align='right'><span id="totalTaxCessAmount"><?= ($cess_exist > 0 ? precise_amount($data[0]->sales_debit_note_tax_cess_amount) : ''); ?></span>

                                                </td>

                                            </tr>

                                            <tr <?= ($tds_exist != 1 || $data[0]->sales_debit_note_tds_amount <= 0 ? 'style="display: none;"' : ''); ?> class='tds_amount_tr'>

                                                <td align="right"><?php echo 'TDS Amount'; ?> </td>

                                                <td align='right'>

                                                    <span id="totalTdsAmount"><?= precise_amount($data[0]->sales_debit_note_tds_amount); ?></span>

                                                </td>

                                            </tr>

                                            <tr <?= ($tds_exist != 1 || $data[0]->sales_debit_note_tcs_amount <= 0 ? 'style="display: none;"' : ''); ?> class='tcs_amount_tr'>

                                                <td align="right"><?php echo 'TCS Amount'; ?> (+)</td>

                                                <td align='right'>

                                                    <span id="totalTcsAmount"><?= precise_amount($data[0]->sales_debit_note_tcs_amount); ?></span>
                                            ...
                                            if ($data[0]->round_off_amount > 0 || $data[0]->round_off_amount < 0) {
                                                ...
                                                $grand_total = precise_amount($data[0]->sales_debit_note_grand_total + $data[0]->round_off_amount);
                                            ...
                                            <tr>
                                                ...
                                                <td align='right'><span id="totalGrandTotal"><?php echo precise_amount($data[0]->sales_debit_note_grand_total); ?></span></td>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <button type="submit" id="sales_debit_note_submit" name="submit" class="btn btn-info">Update</button>
...
<script type="text/javascript">
    var sales_debit_note_data = new Array();
...
<script src="<?php echo base_url('assets/js/sales_debit_note/'); ?>sales_debit_note_basic_common.js"></script>