...
<div class="content-wrapper">
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Receipt Voucher Email</li>
            </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            <?php
            $receipt_id = $this->encryption_url->encode($data[0]->receipt_id);
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $receipt_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                       <div class="box-header with-border">
                            <h3 class="box-title">Receipt Voucher Email</h3>
                            <a class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('receipt_voucher')">Back</a>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <span class="btn btn-default pull-right" id="quotation_cancel" style="margin-right: 2%" onclick="cancel('receipt_voucher')">Cancel</span>
                                    </div>
                                </div>
                            </div>
                        </div>
