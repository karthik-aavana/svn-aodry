                                            ...
                                            foreach ($data as $row) {
                                                ...
                                                <tr>
                                                    ...
                                                    /* if ($row->from_name != "Discount" && $row->from_name != "DISCOUNT")
                                                      ...
                                                      if ($row->dr_amount != 0)
                                                      {
                                                      $debit = bcadd($debit, $row->converted_voucher_amount);
                                                      }
                                                      }
                                                      else
                                                      {
                                                      ...
                                                      {
                                                      $debit = bcsub($debit, $row->converted_voucher_amount);
                                                      }
                                                      }
                                                      if ($row->from_name != "Discount" && $row->from_name != "DISCOUNT")
                                                      {
                                                      ...
                                                      {
                                                      $credit = bcadd($credit, $row->converted_voucher_amount);
                                                      }
                                                      }
                                                      else
                                                      {
                                                      if ($row->cr_amount != 0.00)
                                                      {
                                                      $credit = bcsub($credit, $row->converted_voucher_amount);
                                                      }
                                                      } */
                                                }
                                                ?>
