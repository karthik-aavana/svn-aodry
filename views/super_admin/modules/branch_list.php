    ...
    <section class="content-header">
      <h5>
         <ol class="breadcrumb">
          ...
          <li class="active">Modules to Branch</li>
        </ol>
      </h5> 
    </section>
    <!-- Main content -->
      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Assign Modules to Branch</h3>
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?php echo base_url('superadmin/modules/assign_modules_to_branch/'); ?><?php echo $id; ?>" title="Assign modules" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-edit"></span></a>

                          <a href="<?php echo base_url('superadmin/modules/assign_submodules_to_branch/'); ?><?php echo $id; ?>" title="Assign submodule" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-edit"></span></a>
