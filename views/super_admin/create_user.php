            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                            ...
                            <form role="form" id="form" method="post" action="<?php echo base_url('superadmin/admin/add_user'); ?>">
                                 <div class="row">
                                        <div class="col-md-6">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="form-group">
                                                <label for="customer_name">
                                                 ...
                                                 <input type="text" class="form-control" id="password_confirm" name="password_confirm" value="">
                                        ...
                                        <input type="checkbox" <?php if ($group->name=="members") {echo "checked";} ?> value="<?= $group->id?>" id="group<?= $i ?>" name="group" readonly> <?= $group->name?></label> 
                                        </div>
                                        <?php
                                        $i++; }
                                        ?>
...
<script>
   ...
   $('input[name="group"]').not(this).prop('checked', false);
     ...
     $('#firm_id').change(function () {
        ...
        $.ajax({
            url: base_url +'superadmin/branch/get_branch',
            method: "POST",
            dataType: "JSON",
