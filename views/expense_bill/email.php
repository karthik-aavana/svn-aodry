...
<div class="content-wrapper">
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Expense Bill Email</li>
            </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            ...
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $expense_bill_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-">
                            <h3 class="box-title">Expense Bill Email</h3>
                            <a class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('expense_bill')">Back</a>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
