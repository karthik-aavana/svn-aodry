...
{
// var day=inv_date.split('-');
// var date=parseInt(day[2]);
// date += parseInt(interval_days);
// var finaldate=day[0]+'-'+day[1]+'-'+date;
// var today_date=new Date().toISOString().slice(0,10);
// if(finaldate<=today_date)
// {
//     $('#err_date').text('Given time Interval date has been passed.');
//     return false;
// }
// else
// {
