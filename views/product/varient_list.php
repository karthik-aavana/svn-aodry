...
<script>
    $(document).ready(function () {
        $('#list_datatable').DataTable({
            ...
            "responsive": true,
            "ajax": {
                "url": base_url + "product/varient_list",
                "dataType": "json",
                "type": "POST",
    ...
    function get_product(id) {
        ...
        $.ajax({
            type: "GET",
            url: base_url + "product/get_product_id/" + productId,
            success: function (data) {
               console.log(data); 
                ...
                $("#product_tds_code").val(products.product_tds_value);
                $("#tds_id").val(products.product_tds_id);
                ...
                $("#varient_unit").append('<option selected value="' + products.tax + '">' + products.varient_unit + '</option>');
            }
        })
    }
    $("#post_products").click(function () {
        ...
        var product_tds_code = $("#product_tds_code").val();
        ...
        $.ajax({
            ...
            data: {
                ...
                'product_tds_id':tds_id,
                'product_tds_value':product_tds_code,
