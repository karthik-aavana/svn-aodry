                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="radio-inline">
                                                        ...
                                                        <input type="radio" class="minimal" name="product_type" value="asset" /> Yes

                                                    </label>

                                                    <label class="radio-inline">

                                                        <input type="radio" class="minimal" name="product_type" value="product" checked="checked" /> No
                                ...
                                <div id="menu1" class="tab-pane fade">
                                    ...
                                    <div class="box-body get_num">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <a class="add-more btn btn-info btn-rounded" id="add_more">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="product_tax">Does this Product Has Varients?</label>

                                            <input type="checkbox" class="minimal" id="hasVarients" name="hasVarients">
