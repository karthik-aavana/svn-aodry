...
<div class="content-wrapper">
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Purchase Order Email</li>
            </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            ...
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $purchase_order_id; ?>" encType="multipart/form-data">
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Purchase Order Email</h3>
                            <a class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('purchase_order')">Back</a>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="box-header">
                                    ...
                                    {
                                        ?>
                                        <h4 class="box-title" style="text-transform: capitalize;">Supplier : <?= $data[0]->supplier_name ?></h4>
                                        <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <div class="box-footer">
                            <div class="col-sm-12">
                                <div class="pull-right">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" id="quotation_cancel" onclick="cancel('purchase_order')">Cancel</button>
                                </div>
                            </div>
                        </div>
                        <hr>
