...
<!-- <img width="250" src="<?= base_url('assets/img/Street-view-trusted-logo-new-grey.png') ?>"> -->
        ...
        <table width="100%" cellspacing="0" border-collapse="collapse" class="table"  style="margin-top: 20px;">
                ...
                <!--   <?php if ($dpcount > 0)
            {
                ...
                {
                    ?>
                    <th rowspan="1" class="white-text">Disc<br />Amt</th>
                <?php }
                ?>
            ...
            <tbody>
                ...
                foreach ($items as $value)
                {
                    ...
                    <tr>
                        ...
                        {
                            ?>
                            <td  align="center"><?php echo $value->product_name; ?><br>HSN:<?php echo $value->product_hsn_sac_code; ?><br><?php echo $value->purchase_order_item_description; ?></td>
                        <?php
                        }
                        else
                        {
    ...
    if ($dtcount > 0)
    {
        ...
        ?>
                ...
                <tr>
                    ...
                    <?php
                    if ($data[0]->purchase_order_igst_amount < 1 && $data[0]->purchase_order_cgst_amount > 1)
                    {
                        if ($pdf_results['taxable_value'] == 'yes')
                        {
                            ?>
                        ...
                        {
                            ?>
                            <th align="right"><?php echo bcdiv($data[0]->purchase_order_tax_amount, 2, 2); ?></th>
                            <?php
                        }
                        if ($pdf_results['sgst'] == 'yes')
                        {
                    ...
                    else if ($data[0]->purchase_order_igst_amount > 1 && $data[0]->purchase_order_cgst_amount < 1)
                    {
                        ?>
                        <th align="right"><?php echo $data[0]->purchase_order_taxable_value; ?></th>
                        <th align="right"><?php echo $data[0]->purchase_order_tax_amount; ?></th>
        ...
        <table width="100%" cellspacing="0" border-collapse="collapse" class="table" style="margin-top: 30px;">
            ...
            <tr>
                <td style="" align="left" colspan="2" height="25">
                    ...
                    <?php
                    if (isset($data[0]->purchase_order_type_of_supply) && $data[0]->purchase_order_type_of_supply != "regular")
                    {
                        ?>
            <table width="100%" cellspacing="0" border-collapse="collapse" class="table" style="margin-top: 30px;">
                <tr>
                    <td style="" valign="top">
                        <?php
                        if (isset($data[0]->purchase_order_type_of_supply) && $data[0]->purchase_order_type_of_supply == "export_with_payment")
                        {
                            ?>
