...
<html>
    ...
    <body>      
        ...
        <span style="float: right; margin-top: -25px"><h3><u><?= (@$title ? $title : 'Purchase Order Invoice'); ?></u></h3></span>
        ...
        <table class="item-table table mt-20">
            ...
            <tbody>
                ...
                foreach ($items as $value) {
                    ...
                    if ($igst_exist > 0) $tot_igst += $value->purchase_order_item_igst_amount;
                    if ($sgst_exist > 0) $tot_sgst += $value->purchase_order_item_sgst_amount;
                    if ($cgst_exist > 0) $tot_cgst += $value->purchase_order_item_cgst_amount;
                }
                ?>
                <tr>
                    <th colspan="2"></th>
                ...
                <td style="width:30%">
                    <table class="total_sum">
                        <tr>
                            ...
                            <td align="right"><?= $this->numbertowords->formatInr($data[0]->purchase_order_sub_total); ?></td>
                        </tr>
                        <?php if ($discount_exist > 0) { ?>
                            <tr>
                                <td align="right">Discount (-)</td>
                                <td align="right"><?= $this->numbertowords->formatInr($data[0]->purchase_order_discount_amount); ?></td>
                            </tr>
                        <?php } ?>
                        <?php if ($tds_exist > 0) { ?>
                            <!-- <?php if ($data[0]->purchase_order_tds_amount > 0) { ?>  
                                <tr>
                                    <td>TDS/TCS (-)</td>
                                    <td align="right"> <?= $this->numbertowords->formatInr($data[0]->purchase_order_tds_amount); ?></td>
                                </tr>
                            <?php } ?> -->
                            <?php if ($data[0]->purchase_order_tcs_amount > 0) { ?>
                                <tr>
                                    <td align="right">TCS</td>
                                    <td align="right"><?= $this->numbertowords->formatInr($data[0]->purchase_order_tcs_amount); ?></td>
                                </tr>
                            <?php } ?>
                        <?php } ?>
                        <?php if ($igst_exist > 0) { ?>
                            <tr>
                                ...
                                <td align="right"> <?= $this->numbertowords->formatInr($data[0]->purchase_order_igst_amount); ?></td>
                            </tr>
                        <?php } elseif ($cgst_exist > 0 || $sgst_exist > 0) { ?>
                            <tr>
                                <td align="right">CGST</td>
                                <td align="right"><?= $this->numbertowords->formatInr($data[0]->purchase_order_cgst_amount); ?>
                                </td>
                            </tr>
                            <tr>
                                <td align="right"><?= ($is_utgst == '1' ? 'UTGST' : 'SGST'); ?></td>
                                <td align="right"> <?= $this->numbertowords->formatInr($data[0]->purchase_order_sgst_amount); ?></td>
                            </tr>
                        <?php } elseif ($tax_exist > 0) { ?>
                            <tr>
                                <td align="right">TAX</td>
                                <td align="right"><?= $this->numbertowords->formatInr($data[0]->purchase_order_tax_amount); ?></td>
                            </tr>
                        <?php } ?>
                        <?php if ($cess_exist > 0) { ?>
                            <tr>
                                <td align="right">CESS</td>
                                <td align="right"><?= $this->numbertowords->formatInr($data[0]->purchase_order_tax_cess_amount); ?></td>
                            </tr>
                        <?php } ?>
                        <?php if ($data[0]->total_freight_charge > 0) { ?>
                            <tr>
                        ...
                        <tr>
                            ...
                            <td align="right"> <?= $this->numbertowords->formatInr($data[0]->purchase_order_grand_total); ?></td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table class="table mt-50">
            <tr>
                <td class="amount_text">
                    Amount (in Words): <b><?php echo $currency_text . " " . $this->numbertowords->convert_number(precise_amount($data[0]->purchase_order_grand_total),$data[0]->unit,$data[0]->decimal_unit) . " Only"; ?>
                </td>
            </tr>
        </table>             
        <?php
        if (isset($data[0]->purchase_order_type_of_supply) && $data[0]->purchase_order_type_of_supply == "import") {
            ?>        
            <div id="notices mt-50">
                ...
                <div class="notice">
                    ...
                    if (isset($data[0]->purchase_order_type_of_supply) && $data[0]->purchase_order_type_of_supply == "import") {
                        ...
                        <?php
                    } else if (isset($data[0]->purchase_order_type_of_supply) && $data[0]->purchase_order_type_of_supply == "export_without_payment") {
                        ?>
