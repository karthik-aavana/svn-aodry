        ...
        <div class="modal-content">
            ...
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email_compose/'); ?>" encType="multipart/form-data">
                ...
                <div class="modal-footer">                
                    <button type="submit" id="email_submit" name="sales_submit" class="btn btn-info">
                        Send
                    </button>
...
<script type="text/javascript">
    $(document).on("click", ".composeMail", function () {
        var id = $(this).data('id');
        $.ajax({
            url: base_url + 'purchase_order/email_popup/' + id,
            dataType: "JSON",
            success: function (data) {
                console.log(data[0].supplier_email);
                ...
                $('#id').val(data[0].advance_voucher_id);
                var email_template = data[0].email_template;
                var firm_name = data[0].firm_name;
                var customer_email = data[0].supplier_email;
                ...
                $('#from_email').append('<option value="' + firm_name + '<noreply@aodry.com>" selected>' + firm_name + '[noreply@aodry.com]</option>');
