...
<?php } ?>
            ...
            <tbody>
                ...
                foreach ($items as $value)
                {
                    ...
                    <tr>
                        ...
                        {
                            ?>
                            <td  align="center"><?php echo $value->product_name; ?><br>HSN/SAC: <?php echo $value->product_hsn_sac_code; ?><br><?php echo $value->purchase_debit_note_item_description; ?></td>
                        <?php
                        }
                        else
                        {
                            ?>
                            <td ><?php echo $value->service_name; ?><br>HSN/SAC: <?php echo $value->service_hsn_sac_code; ?><br><?php echo $value->purchase_debit_note_item_description; ?></td>
        <?php
    }
    if ($pdf_results['quantity'] == 'yes')
    {
        ?>
                        ...
                        {
                            ?>
                            <td align="right"><?php echo $value->purchase_debit_note_item_unit_price; ?></td>
        <?php
    }
    if ($pdf_results['sub_total'] == 'yes')
    {
        ?>
                            <td align="right"><?php echo $value->purchase_debit_note_item_sub_total; ?></td>
    ...
    {
        ?>
                            <td align="right"><?php echo $value->purchase_debit_note_item_discount_amount; ?></td>
                        ...
                        <?php if ($igst_tax < 1 && $cgst_tax > 1)
                        {
                            ...
                            {
                                ?>
                                <td align="right"><?php echo $value->purchase_debit_note_item_taxable_value; ?></td>
                                <?php
                            }
                            ?>
                             <!-- <td align="center"><?php echo $value->purchase_debit_note_item_cgst_percentage; ?></td> -->
                            <?php
                            if ($pdf_results['cgst'] == 'yes')
                            {
                                ?>
                                <td align="right"><?php echo $value->purchase_debit_note_item_cgst_amount; ?></td>
                                <?php
                            }
                            ?>
                         <!-- <td align="center"><?php echo $value->purchase_debit_note_item_sgst_percentage; ?></td> -->
                            <?php
                            if ($pdf_results['sgst'] == 'yes')
                            {
                                ?>
                                <td align="right"><?php echo $value->purchase_debit_note_item_sgst_amount; ?></td>
            <?php
        }
        ?>
                        <?php
                        ...
                        else if ($igst_tax > 1 && $cgst_tax < 1)
                        {
                            ?>
                            <td align="right"><?php echo $value->purchase_debit_note_item_taxable_value; ?></td>
                                <!-- <td align="center"><?php echo $value->purchase_debit_note_item_igst_percentage; ?></td> -->
                            <td align="right"><?php echo $value->purchase_debit_note_item_igst_amount; ?></td>
                    ...
                    ?>
                        <td align="right"><?php echo $value->purchase_debit_note_item_grand_total ?></td>
                    </tr>
                    <?php
                    $i++;
                    ...
                    // $igst = bcadd($igst, $value->purchase_debit_note_item_igst_amount, 2);
                    // $cgst = bcadd($cgst, $value->purchase_debit_note_item_cgst_amount, 2);
                    // $sgst = bcadd($sgst, $value->purchase_debit_note_item_sgst_amount, 2);
                ...
                <tr>
                    ...
                    {
                        ?>
                        <th align="right"><?php echo $data[0]->purchase_debit_note_sub_total; ?></th>

                        <?php
                        if ($dtcount > 0)
                        {
                            ?>
                            <th><?php echo $data[0]->purchase_debit_note_discount_value; ?></th>
                    ...
                    <?php
                    if ($data[0]->purchase_debit_note_igst_amount < 1 && $data[0]->purchase_debit_note_cgst_amount > 1)
                    {
                        if ($pdf_results['taxable_value'] == 'yes')
                        {
                            ?>
                            <th align="right"><?php echo $data[0]->purchase_debit_note_taxable_value; ?></th>
                            <?php
                        }
                        if ($pdf_results['cgst'] == 'yes')
                        {
                            ?>
                            <th align="right"><?php echo bcdiv($data[0]->purchase_debit_note_tax_amount, 2, 2); ?></th>
                            <?php
                        }
                        if ($pdf_results['sgst'] == 'yes')
                        {
                    ...
                    else if ($data[0]->purchase_debit_note_igst_amount > 1 && $data[0]->purchase_debit_note_cgst_amount < 1)
                    {
                        ?>
                        <th align="right"><?php echo $data[0]->purchase_debit_note_taxable_value; ?></th>
                        <th align="right"><?php echo $data[0]->purchase_debit_note_tax_amount; ?></th>
...
?>
        ...
        <table width="100%" cellspacing="0" border-collapse="collapse" class="table" style="margin-top: 30px;">
            ...
            <tr>
                ...
                <td align="right" class="footerpad fontH"><b><?php echo $data[0]->purchase_debit_note_grand_total; ?> /-</td>
            </tr>
            <tr>
                <td style="" align="left" colspan="2" height="25">
                    Amount (in Words): <b><?php echo $data[0]->currency_text . " " . $this->numbertowords->convert_number($data[0]->purchase_debit_note_grand_total) . " Only"; ?> </b><br/>
                </td>
            </tr>
        </table>
            ...
            <table width="100%" cellspacing="0" border-collapse="collapse" class="table" style="margin-top: 30px;">
                <tr>
                    <td style="" valign="top">
                        <?php
                        if (isset($data[0]->purchase_debit_note_type_of_supply) && $data[0]->purchase_debit_note_type_of_supply == "export_with_payment")
                        {
                            ?>
