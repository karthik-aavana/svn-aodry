        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form role="form" id="form" method="post" action="<?php echo base_url('customer/edit_customer'); ?>">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="customer_name" name="customer_name" value="<?php echo $data[0]->customer_name; ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-4">
                                        ...
                                        <select class="form-control select2" id="gstregtype" name="gstregtype" style="width: 100%;">
                                            ...
                                            if ($data[0]->customer_gst_registration_type == "Registered")
                                            {
                                                echo "selected";
                                            }
                                            ?> >Registered</option>
                                            <option value="Unregistered" <?php
                                            if ($data[0]->customer_gst_registration_type == "Unregistered")
                                            {
                                                echo "selected";
                                            }
                                            ?> >Unregistered</option>
                                    ...
                                    <div class="form-group col-md-4" id="gstn_selected" <?php
                                        ...
                                        <input type="text" class="form-control" id="gstin" name="gstin" value="<?php echo $data[0]->customer_gstin_number; ?>">
...
?>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-4">
                                        <label for="postal_code"><!-- Postal Code -->
                                            Postal Code</label>
                                        <input type="text" class="form-control" id="postal_code" name="postal_code" value="<?php echo $data[0]->customer_postal_code; ?>">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="website" name="website" value="<?php echo $data[0]->customer_website; ?>">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="email" name="email" value="<?php echo $data[0]->customer_email; ?>">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo $data[0]->customer_mobile; ?>">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="telephone" name="telephone" value="<?php echo $data[0]->customer_telephone; ?>">
                                        <span class="validation-color" id="err_telephone"><?php echo form_error('telephone'); ?></span>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group col-md-4">
                                        <label for="pan_no">PAN No<span class="validation-color"></span>
                                        </label>
                                        <input type="text" class="form-control" id="panno" name="panno" value="<?php echo $data[0]->customer_pan_number; ?>">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="tanno" name="tanno" value="<?php echo $data[0]->customer_tan_number; ?>">
