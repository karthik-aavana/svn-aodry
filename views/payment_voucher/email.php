...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Payment Voucher Email</li>
        </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            <?php
            $payment_id = $this->encryption_url->encode($data[0]->payment_id);
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $payment_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Payment Voucher Email</h3>
                            <a class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('payment_voucher')">Back</a>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="hidden" name="redirect" value="payment_voucher">
