            ...
            <table width="100%" cellspacing="0" border-collapse="collapse" class="table header_table" style="margin-top:20px 0px;border:none!important">
...

                {
                    ...
                    <tr style="text-align: center;">
                        ...
                        <td style="text-align: center;font-size: 20px">Delivery Challan </td>
...

                {
                    ...
                    <tr style="text-align: center;background-color: <?= $pdf_results['background']; ?>;border:none!important">
                        ...
                        <td style="text-align: center;font-size: 20px;" class="white-text">Delivery Challan </td>
                ...
                <tr>
                    ...
                    <td valign="top" width="50%">
                        ...
                        <p style="font-weight:bold"><?php
                            ...
                            if (isset($data[0]->delivery_challan_date))
                    ...
                    <td valign="top" width="50%">
                        ...
                        Delivery Challan Number<br>

                        <p style="font-weight:bold"><?php

                            if (isset($data[0]->delivery_challan_invoice_number))

                            {

                                echo $data[0]->delivery_challan_invoice_number;
                ...
                <tr style="border:<?php echo ($pdf_results['bordered'] == 'yes') ? '' : 'none'; ?>;">
                    ...
                    <!-- <td colspan="2">
                         ...
                         <br/><br/>
                           ...
                           <b style="text-transform: capitalize;"></b><?php
            ...
            <tr>
                ...
                <td valign="top" width="28%">
                    ...
                    <p style="font-weight:bold"><?php
                        ...
                        if (isset($data[0]->delivery_challan_gst_payable))

                        {

                            echo ucfirst($data[0]->delivery_challan_gst_payable);
...

{
                    ...
                    <tr>
                      ...
                      <!--   <td align="center"><?php echo $i; ?></td> -->
...

                        {
                            ...
                            <td ><?php echo $value->product_name; ?><br>HSN/SAC: <?php echo $value->product_hsn_sac_code; ?><br><?php echo $value->delivery_challan_item_description; ?></td>
...

    {
        ...
        ?>
                            ...
                            <td ><?php echo $value->service_name; ?><br>HSN/SAC: <?php echo $value->service_hsn_sac_code; ?><br><?php echo $value->delivery_challan_item_description; ?></td>
    ...
    <?php } ?> -->
                        ...
                        echo $value->delivery_challan_item_quantity;
...

    {
        ...
        <table width="100%" cellspacing="0" border-collapse="collapse" class="table" style="margin-top: 30px;">
            ...
            <tr>
                ...
                <td align="right" class="footerpad fontH"><b><?php echo $data[0]->delivery_challan_grand_total; ?> /-</td>
            ...
            <tr>
                ...
                <td style="" align="left" colspan="2" height="25">
                    ...
                    Amount (in Words): <b><?php echo $data[0]->currency_text . " " . $this->numbertowords->convert_number($data[0]->delivery_challan_grand_total) . " Only"; ?> </b><br/>
...
if (isset($data[0]->delivery_challan_type_of_supply) && $data[0]->delivery_challan_type_of_supply != "regular")

{
    ...
    ?>
            ...
            if (isset($data[0]->delivery_challan_type_of_supply) && $data[0]->delivery_challan_type_of_supply == "export_with_payment")
            ...
            else if (isset($data[0]->delivery_challan_type_of_supply) && $data[0]->delivery_challan_type_of_supply == "export_without_payment")
