...
<div class="content-wrapper">
    ...
    <input type="voucher_type" name="<?= $voucher_type; ?>">
                ...
                <div class="box">
                    <div id="plus_btn">
                        <div class="box-header with-border">
                            <h3 class="box-title"><?= ucfirst(str_replace('_', ' ', $voucher_type)); ?> Voucher</h3>
                        </div>
                    </div>
                    <div id="filter">
                        <div class="box-header with-border box-body filter_body">
                            <div class="btn-group">
                                ...
                                <span class="delete_button" data-backdrop="static" data-keyboard="false" href="#" data-toggle="modal" data-target="#delete_modal" data-id="" data-path="<?= $voucher_type ?>/delete" data-return="<?= $voucher_type ?>_voucher" data-delete_message="If you delete this record then its assiociated records also will be delete!! Do you want to continue?">
                                    <a class="btn btn-app" data-placement="bottom" data-toggle="tooltip" title="Delete <?= ucwords(str_replace("_", ' ', $voucher_type));?> Voucher"><i class="fa fa-trash-o"></i></a>
                                </span>
                            </div>
                        </div>
                    </div> 
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('click', 'input[name="check_purchase"]', function () {
            if ($(this).is(":checked")) {

                $(document).find('[name=check_purchase]').prop('checked', false);
