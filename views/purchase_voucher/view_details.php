    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url('purchase_voucher'); ?>">Purchase Voucher</li></a>
                <li class="active"><?= ucfirst(str_replace('_', ' ', $data[0]->reference_type)); ?> Voucher Details</li>
            </ol>
        </h5>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?= ucfirst(str_replace('_', ' ', $data[0]->reference_type)); ?> Voucher Details</h3>
                        <span class="btn btn-sm btn-default pull-right back_button" id="cancel" style="margin: 1%" onclick1='cancel("<?= $data[0]->reference_type; ?>_voucher")'>Back</span>
                    </div>
                    <div class="box-body">
                        <div class="row">
