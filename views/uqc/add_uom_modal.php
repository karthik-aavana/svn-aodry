<div id="add_uom_modal" class="modal fade z_index_modal" role="dialog" data-backdrop="static">
             ...
             $.ajax(
                {
                    ...
                    success: function (result) {
                        if(result.resl == 'duplicate'){
                            $("#loader").hide();
                            $('#err_uom').text("UQC already exist in "+result.type);
                            return !1
                            ...
                            if(result.flag){
                                ...
                                $('#uom').val('');
                                $('#uom_type_a').prop('selectedIndex',0);
                                $('#description_uom').val('');
                                $('#uom_type_a').select2();
                            }else{
                                alert_d.text = result.msg;
