    ...
    <div class="col-sm-12">
        <div class="box">
            <div class="box-header with-border">
                <h3 class="box-title"><!-- Add Supplier -->
                Add Supplier
                </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                    ...
                    <form role="form" id="form" method="post" action="<?php echo base_url('supplier/add_supplier'); ?>">
                        <div class="row">
...
<div class="row" id="contact_person" style="display: none;">
    <div class="form-group col-md-4">
...
<script>var state_url =     '<?php echo base_url('common/getState/') ?>
	';
	var city_url = '
<?php echo base_url('common/getCity/') ?>
	';
	var state_code_url = '
<?php echo base_url('common/getStateCode/') ?>
	';
	var supplier_add_url = '
<?php echo base_url('supplier/add_supplier_ajax') ?>
	';
	var ledger_check_url = '
<?php echo base_url('common/get_check_ledger/') ?>
	';
