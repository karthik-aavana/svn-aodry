            ...
            <tbody>
                ...
                foreach ($items as $value)
                {
                    ...
                    <tr>
                        ...
                        {
                            ?>
                            <td  align="center"><?php echo $value->product_name; ?><br>HSN/SAC: <?php echo $value->product_hsn_sac_code; ?><br><?php echo $value->sales_credit_note_item_description; ?></td>
                        <?php
                        }
                        else
                        {
                            ?>
                            <td ><?php echo $value->service_name; ?><br>HSN/SAC: <?php echo $value->service_hsn_sac_code; ?><br><?php echo $value->sales_credit_note_item_description; ?></td>
        <?php
    }
    if ($pdf_results['quantity'] == 'yes')
    {
