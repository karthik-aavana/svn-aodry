...
<div class="content-wrapper">
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active">Sales Credit Note Email</li>
            </ol>
        </h5>
    </section>
    <section class="content">
        <div class="row">
            ...
            ?>
            <form role="form" id="form" method="post" action="<?php echo base_url('email_template/send_email/') . $sales_credit_note_id; ?>" encType="multipart/form-data">
                <!-- right column -->
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Sales Credit Note Email</h3>
                            <a class="btn btn-default pull-right" id="sale_cancel" onclick="cancel('sales_credit_note')">Back</a>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="hidden" name="redirect" value="sales_order">
                        ...
                        <div class="box-footer">
                            <div class="col-sm-12">
                                <div class="pull-right">
                                    ...
                                    <button type="button" class="btn btn-default pull-right" id="quotation_cancel" onclick="cancel('sales')">Cancel</button>
                                </div>
                            </div>
                        </div>
                        <hr>
