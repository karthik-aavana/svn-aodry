                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="product_batch" id="product_batch" value="<?php echo $data[0]->product_batch;?>" readonly >
                                    ...
                                    <div class="col-md-3 product_discount" style="display: none;">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control select2" id="product_discount" name="product_discount"  tabindex="4">
                                                    ...
                                                    foreach ($discount as $value) {
                                                        if ($value->discount_id == $data[0]->product_discount_id) {
                                    ...
                                    <div class="col-sm-6 " style="margin-top: 20px;">
                                        <div class="form-group change_uom disabled" >
                                            <span class="col-sm-3 fright">1 <span id="uom_text"><?=$uom_text;?></span> = </span>
                                            <div class="col-sm-3 p_0"><input type="text" name="equal_uom" class="form-control" value="<?=$data[0]->equal_unit_number;?>"></div>
                                            <div class="col-sm-6 p_0">
                                                <select class="form-control select2 " id="product_equal_unit" name="product_equal_unit" style="width: 100%;" tabindex="4">
                                                    <option value="">Select UOM</option>
                                                    <?php
                                                    foreach ($uqc as $value) {
                                                        $selected = '';
                                                        if($value->id == $data[0]->equal_uom_id) $selected = 'selected';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="profit_margin" name="profit_margin" value="<?php echo (float)($data[0]->product_profit_margin); ?>" pattern="\d*" maxlength="5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="product_opening_stock" name="product_opening_stock" value="<?=$data[0]->product_opening_quantity;?>">
