    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title"> Printing Option </h4>
            ...
            <form role="form" id="sales_pdf_form" method="post" action="" target="_blank">
                ...
                <div class="modal-body" >
                    ...
                    <input type="hidden" name="sales_id" id="pdf_type_sales_id" value="">

                    <input type="hidden" name="document_type" id="pdf_type_sales_name" value="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <label class="checkbox"><input type="checkbox" name="pdf_type_check" value="original" checked="checked">ORIGINAL FOR RECIPIENT </label><br>

                                <label class="checkbox"><input type="checkbox" name="pdf_type_check" value="duplicate">DUPLICATE FOR SUPPLIER </label><br>

                                <label class="checkbox"><input type="checkbox" name="pdf_type_check" value="triplicate">TRIPLICATE FOR TRANSPORTER </label>
                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                               ...
                               Orientation<br><select id="cmb_orient" name="cmb_orient" class="form-control select2">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                               ...
                               Paper size <br>
                               <select id="cmb_size" name="cmb_size" class="form-control select2">
...
<script type="text/javascript">
    ...
    $(document).on("click", '.pdf_button', function (e) {
        ...
        $("#pdf_type_sales_id").val(id);

        $("#pdf_type_sales_name").val(name);
