    ...
    <section class="content-header">
        <h5>
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="<?php echo base_url('balance_sheet'); ?>">Trial Sheet</a></li>
            </ol>
        </h5>
    </section>
            ...
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                       ...
                       <!--  <a class="btn btn-sm btn-info pull-right btn-flat" href="<?php echo base_url()?>/trial_balance">Back</a> -->
                    </div>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <form method="post" action="<?php echo base_url() ?>Trial_balance/downloadReportSheet" id="download_form">
                       	...
                       	<div class="table-responsive ledger_row">
                             <div id="loader">
...
<script type="text/javascript">
    ...
    function GetLedgersList() {
        ...
        $.ajax({
            url: '<?= base_url(); ?>Trial_balance/GetLedgersList',
            type: 'post',
            dataType: 'json',
            ...
            success: function (j) {
                ...
                $('.ledger_row').show();
                $('#ledger_table tbody').html(j.html);
                $('.company_name').text(j.company_name);
                $('.company_address').text(j.primary_address);
                  $("#loader").hide();
            }, error: function () {
                 $('.loader').addClass('.hide-loader').hide();
                 $('.search_reports').attr('disabled', false);
