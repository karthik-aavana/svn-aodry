            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Leads Report</h3>
                        ...
                        <table id="list_datatable" class="custom_datatable table table-bordered table-striped table-hover table-responsive">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal"  data-toggle="modal" data-target="#distinct-modal" data-title="Please Select Lead Date" data-type="lead_date">Lead Date <span class="fa fa-toggle-down mr-20"></span></a></th>



                                    <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal"  data-toggle="modal" data-target="#distinct-modal" data-title="Please Select Lead No." data-type="asr_no">Lead No<span class="fa fa-toggle-down mr-20"></span></a></th>
                                    ...
                                    <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal"  data-toggle="modal" data-target="#distinct-modal" data-title="Please Select Group" data-type="group">Group<span class="fa fa-toggle-down mr-20"></span></a></th>



                                    <th style="min-width: 100px;text-align: center;"><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal"  data-toggle="modal" data-target="#distinct-modal" data-title="Please Select Stages" data-type="stages">Stages<span class="fa fa-toggle-down mr-20"></span></a></th>



                                    <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal"  data-toggle="modal" data-target="#distinct-modal" data-title="Please Select Source" data-type="source">Source<span class="fa fa-toggle-down mr-20"></span></a></th>



                                    <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal"  data-toggle="modal" data-target="#distinct-modal" data-title="Please Select Business Type" data-type="business_type">Business Type<span class="fa fa-toggle-down mr-20"></span></a></th>



                                    <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal"  data-toggle="modal" data-target="#distinct-modal" data-title="Please Select Next Action Date" data-type="next_action_date">Next Action Date <span class="fa fa-toggle-down mr-20"></span></a></th>



                                    <th><a href="#" data-backdrop="static" data-keyboard="false" class="open_distinct_modal"  data-toggle="modal" data-target="#distinct-modal" data-title="Please Select Priority" data-type="priority">Priority<span class="fa fa-toggle-down mr-20"></span></a></th>
        ...
        function generateOrderTable() {
            ...
            $('#list_datatable').DataTable({
                ...
                "ajax": {
                    ...
                    "url": base_url + "report/leads_report",
