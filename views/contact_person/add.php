        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form role="form" id="form" method="post" action="<?php echo base_url('contact_person/add_contact_person'); ?>">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="industry" name="industry" value="<?php echo set_value('industry'); ?>">
