...
$(document).ready(function () {
    ...
    $('#input_purchase_credit_note_code').change(function () {
    ...
    $("#type_of_supply").change(function (event) {
        ...
        $("#purchase_credit_note_table_body").find('input[name^="item_tax_id"]').each(function () {
    ...
    // changes in rows
    $("#purchase_credit_note_table_body").on("change blur", 'input[name^="item_price"],input[name^="item_tds_percentage"],input[name^="item_description"],input[name^="item_quantity"],select[name^="item_discount"],select[name^="item_tax"]', function (event) {
        var newRow = $(this).closest("tr");
...
function add_row(data, loop = "") {
    ...
    if (quantity_type == "hidden") {
        cols += "<td style='text-align:center'><input type='" + quantity_type + "' class='form-control form-fixer text-center float_number' value='" + quantity + "' data-rule='quantity' name='item_quantity'><span id='item_quantity_hide_lbl_" + table_index + "'  >" + quantity + "</span></td>";

    } else {
        cols += "<td><input type='text' class='form-control form-fixer text-center float_number' value='" + quantity + "' data-rule='quantity' name='item_quantity'></td>";
    ...
    cols += "<input type='" + grand_total_type + "' class='float_number form-control form-fixer text-right' name='item_grand_total'></td>";
    cols += "</tr>";
    ...
    if (loop == "loop") {
        newRow.find('input[name^="item_grand_total"]').val(0);
        newRow.find('input[name^="item_grand_total"]').change();
    }
    $('#type_of_supply').change();
