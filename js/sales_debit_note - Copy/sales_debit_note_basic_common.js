...
$(document).ready(function () {
    ...
    $('#input_sales_debit_note_code').change(function () {
    ...
    $("#type_of_supply").change(function (event) {
        ...
        $("#sales_debit_note_table_body").find('input[name^="item_tax_id"]').each(function () {
    ...
    // changes in rows
    $("#sales_debit_note_table_body").on("change blur", 'input[name^="item_price"],input[name^="item_tds_percentage"],input[name^="item_description"],input[name^="item_quantity"],select[name^="item_discount"],select[name^="item_tax"]', function (event) {
        var newRow = $(this).closest("tr");
